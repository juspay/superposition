...
2. **Tree-shakeable** — Consumers import only the pages they need: `import { ConfigManager } from 'superposition-embeddable-ui'`.
...
```
superposition-embeddable-ui (npm package)
├── packages/
│   ├── api-client/          # TypeScript REST client (generated from Smithy IDL or OpenAPI)
│   ├── embeddable-ui/       # React component library
│   │   ├── src/
│   │   │   ├── providers/
...
```tsx
import { SuperpositionProvider, ConfigManager, OverrideManager } from 'superposition-embeddable-ui';
