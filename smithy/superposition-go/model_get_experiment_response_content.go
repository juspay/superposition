...
// checks if the GetExperimentResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetExperimentResponseContent{}

// GetExperimentResponseContent struct for GetExperimentResponseContent
...
type _GetExperimentResponseContent GetExperimentResponseContent
...
func NewGetExperimentResponseContent(id string, createdAt time.Time, createdBy string, lastModified time.Time, name string, overrideKeys []string, status ExperimentStatusType, trafficPercentage float32, context map[string]interface{}, variants []Variant, lastModifiedBy string, chosenVariant string, description string, changeReason string) *GetExperimentResponseContent {
	this := GetExperimentResponseContent{}
	this.Id = id
...
func (o GetExperimentResponseContent) MarshalJSON() ([]byte, error) {
...
func (o GetExperimentResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *GetExperimentResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varGetExperimentResponseContent := _GetExperimentResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetExperimentResponseContent)

	if err != nil {
		return err
	}

	*o = GetExperimentResponseContent(varGetExperimentResponseContent)

	return err
}

type NullableGetExperimentResponseContent struct {
	value *GetExperimentResponseContent
	isSet bool
}

func (v NullableGetExperimentResponseContent) Get() *GetExperimentResponseContent {
	return v.value
}

func (v *NullableGetExperimentResponseContent) Set(val *GetExperimentResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExperimentResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExperimentResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExperimentResponseContent(val *GetExperimentResponseContent) *NullableGetExperimentResponseContent {
	return &NullableGetExperimentResponseContent{value: val, isSet: true}
}

func (v NullableGetExperimentResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExperimentResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
