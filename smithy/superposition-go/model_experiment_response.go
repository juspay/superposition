...
// checks if the ExperimentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentResponse{}

// ExperimentResponse struct for ExperimentResponse
...
type _ExperimentResponse ExperimentResponse
...
func (o ExperimentResponse) MarshalJSON() ([]byte, error) {
...
func (o ExperimentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentResponse := _ExperimentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExperimentResponse)

	if err != nil {
		return err
	}

	*o = ExperimentResponse(varExperimentResponse)

	return err
}

type NullableExperimentResponse struct {
	value *ExperimentResponse
	isSet bool
}

func (v NullableExperimentResponse) Get() *ExperimentResponse {
	return v.value
}

func (v *NullableExperimentResponse) Set(val *ExperimentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExperimentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExperimentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExperimentResponse(val *ExperimentResponse) *NullableExperimentResponse {
	return &NullableExperimentResponse{value: val, isSet: true}
}

func (v NullableExperimentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExperimentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
