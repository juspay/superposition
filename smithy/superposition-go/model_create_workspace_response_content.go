...
// checks if the CreateWorkspaceResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWorkspaceResponseContent{}

// CreateWorkspaceResponseContent struct for CreateWorkspaceResponseContent
type CreateWorkspaceResponseContent struct {
...
type _CreateWorkspaceResponseContent CreateWorkspaceResponseContent
...
func NewCreateWorkspaceResponseContent(workspaceName string, organisationId string, organisationName string, workspaceSchemaName string, workspaceStatus string, workspaceAdminEmail string, createdBy string, lastModifiedBy string, lastModifiedAt time.Time, createdAt time.Time) *CreateWorkspaceResponseContent {
	this := CreateWorkspaceResponseContent{}
...
func (o CreateWorkspaceResponseContent) MarshalJSON() ([]byte, error) {
...
func (o CreateWorkspaceResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *CreateWorkspaceResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateWorkspaceResponseContent := _CreateWorkspaceResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateWorkspaceResponseContent)

	if err != nil {
		return err
	}

	*o = CreateWorkspaceResponseContent(varCreateWorkspaceResponseContent)

	return err
}

type NullableCreateWorkspaceResponseContent struct {
	value *CreateWorkspaceResponseContent
	isSet bool
}

func (v NullableCreateWorkspaceResponseContent) Get() *CreateWorkspaceResponseContent {
	return v.value
}

func (v *NullableCreateWorkspaceResponseContent) Set(val *CreateWorkspaceResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWorkspaceResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWorkspaceResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWorkspaceResponseContent(val *CreateWorkspaceResponseContent) *NullableCreateWorkspaceResponseContent {
	return &NullableCreateWorkspaceResponseContent{value: val, isSet: true}
}

func (v NullableCreateWorkspaceResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateWorkspaceResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
