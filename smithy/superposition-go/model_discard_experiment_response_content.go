...
// checks if the DiscardExperimentResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscardExperimentResponseContent{}

// DiscardExperimentResponseContent struct for DiscardExperimentResponseContent
type DiscardExperimentResponseContent struct {
	Id string `json:"id"`
...
type _DiscardExperimentResponseContent DiscardExperimentResponseContent
...
func NewDiscardExperimentResponseContent(id string, createdAt time.Time, createdBy string, lastModified time.Time, name string, overrideKeys []string, status ExperimentStatusType, trafficPercentage float32, context map[string]interface{}, variants []Variant, lastModifiedBy string, chosenVariant string, description string, changeReason string) *DiscardExperimentResponseContent {
	this := DiscardExperimentResponseContent{}
	this.Id = id
...
func (o DiscardExperimentResponseContent) MarshalJSON() ([]byte, error) {
...
func (o DiscardExperimentResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *DiscardExperimentResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscardExperimentResponseContent := _DiscardExperimentResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDiscardExperimentResponseContent)

	if err != nil {
		return err
	}

	*o = DiscardExperimentResponseContent(varDiscardExperimentResponseContent)

	return err
}

type NullableDiscardExperimentResponseContent struct {
	value *DiscardExperimentResponseContent
	isSet bool
}

func (v NullableDiscardExperimentResponseContent) Get() *DiscardExperimentResponseContent {
	return v.value
}

func (v *NullableDiscardExperimentResponseContent) Set(val *DiscardExperimentResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscardExperimentResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscardExperimentResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscardExperimentResponseContent(val *DiscardExperimentResponseContent) *NullableDiscardExperimentResponseContent {
	return &NullableDiscardExperimentResponseContent{value: val, isSet: true}
}

func (v NullableDiscardExperimentResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscardExperimentResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
