...
// checks if the CreateFunctionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFunctionResponseContent{}

// CreateFunctionResponseContent struct for CreateFunctionResponseContent
type CreateFunctionResponseContent struct {
...
type _CreateFunctionResponseContent CreateFunctionResponseContent
...
func NewCreateFunctionResponseContent(functionName string, draftCode string, draftRuntimeVersion string, draftEditedAt time.Time, draftEditedBy string, lastModifiedAt time.Time, lastModifiedBy string, changeReason string, description string) *CreateFunctionResponseContent {
	this := CreateFunctionResponseContent{}
...
func (o CreateFunctionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o CreateFunctionResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *CreateFunctionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateFunctionResponseContent := _CreateFunctionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateFunctionResponseContent)

	if err != nil {
		return err
	}

	*o = CreateFunctionResponseContent(varCreateFunctionResponseContent)

	return err
}

type NullableCreateFunctionResponseContent struct {
	value *CreateFunctionResponseContent
	isSet bool
}

func (v NullableCreateFunctionResponseContent) Get() *CreateFunctionResponseContent {
	return v.value
}

func (v *NullableCreateFunctionResponseContent) Set(val *CreateFunctionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFunctionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFunctionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFunctionResponseContent(val *CreateFunctionResponseContent) *NullableCreateFunctionResponseContent {
	return &NullableCreateFunctionResponseContent{value: val, isSet: true}
}

func (v NullableCreateFunctionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFunctionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
