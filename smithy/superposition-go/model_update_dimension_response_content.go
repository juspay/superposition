...
// checks if the UpdateDimensionResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDimensionResponseContent{}

// UpdateDimensionResponseContent struct for UpdateDimensionResponseContent
type UpdateDimensionResponseContent struct {
...
type _UpdateDimensionResponseContent UpdateDimensionResponseContent
...
func NewUpdateDimensionResponseContent(dimension string, position float32, schema interface{}, description string, changeReason string, lastModifiedAt time.Time, lastModifiedBy string, createdAt time.Time, createdBy string) *UpdateDimensionResponseContent {
	this := UpdateDimensionResponseContent{}
...
func (o UpdateDimensionResponseContent) MarshalJSON() ([]byte, error) {
...
func (o UpdateDimensionResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateDimensionResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDimensionResponseContent := _UpdateDimensionResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDimensionResponseContent)

	if err != nil {
		return err
	}

	*o = UpdateDimensionResponseContent(varUpdateDimensionResponseContent)

	return err
}

type NullableUpdateDimensionResponseContent struct {
	value *UpdateDimensionResponseContent
	isSet bool
}

func (v NullableUpdateDimensionResponseContent) Get() *UpdateDimensionResponseContent {
	return v.value
}

func (v *NullableUpdateDimensionResponseContent) Set(val *UpdateDimensionResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDimensionResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDimensionResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDimensionResponseContent(val *UpdateDimensionResponseContent) *NullableUpdateDimensionResponseContent {
	return &NullableUpdateDimensionResponseContent{value: val, isSet: true}
}

func (v NullableUpdateDimensionResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDimensionResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
