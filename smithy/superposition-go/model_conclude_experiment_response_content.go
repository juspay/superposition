...
// checks if the ConcludeExperimentResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConcludeExperimentResponseContent{}

// ConcludeExperimentResponseContent struct for ConcludeExperimentResponseContent
type ConcludeExperimentResponseContent struct {
	Id string `json:"id"`
...
type _ConcludeExperimentResponseContent ConcludeExperimentResponseContent
...
func NewConcludeExperimentResponseContent(id string, createdAt time.Time, createdBy string, lastModified time.Time, name string, overrideKeys []string, status ExperimentStatusType, trafficPercentage float32, context map[string]interface{}, variants []Variant, lastModifiedBy string, chosenVariant string, description string, changeReason string) *ConcludeExperimentResponseContent {
	this := ConcludeExperimentResponseContent{}
	this.Id = id
...
func (o ConcludeExperimentResponseContent) MarshalJSON() ([]byte, error) {
...
func (o ConcludeExperimentResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *ConcludeExperimentResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varConcludeExperimentResponseContent := _ConcludeExperimentResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConcludeExperimentResponseContent)

	if err != nil {
		return err
	}

	*o = ConcludeExperimentResponseContent(varConcludeExperimentResponseContent)

	return err
}

type NullableConcludeExperimentResponseContent struct {
	value *ConcludeExperimentResponseContent
	isSet bool
}

func (v NullableConcludeExperimentResponseContent) Get() *ConcludeExperimentResponseContent {
	return v.value
}

func (v *NullableConcludeExperimentResponseContent) Set(val *ConcludeExperimentResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableConcludeExperimentResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableConcludeExperimentResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConcludeExperimentResponseContent(val *ConcludeExperimentResponseContent) *NullableConcludeExperimentResponseContent {
	return &NullableConcludeExperimentResponseContent{value: val, isSet: true}
}

func (v NullableConcludeExperimentResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConcludeExperimentResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
