...
// checks if the GetOrganisationResponseContent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganisationResponseContent{}

// GetOrganisationResponseContent struct for GetOrganisationResponseContent
type GetOrganisationResponseContent struct {
	Id string `json:"id"`
...
type _GetOrganisationResponseContent GetOrganisationResponseContent
...
func NewGetOrganisationResponseContent(id string, name string, createdBy string, adminEmail string, status string, createdAt time.Time, updatedAt time.Time, updatedBy string) *GetOrganisationResponseContent {
	this := GetOrganisationResponseContent{}
	this.Id = id
	this.Name = name
...
func (o GetOrganisationResponseContent) MarshalJSON() ([]byte, error) {
...
func (o GetOrganisationResponseContent) ToMap() (map[string]interface{}, error) {
...
func (o *GetOrganisationResponseContent) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrganisationResponseContent := _GetOrganisationResponseContent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrganisationResponseContent)

	if err != nil {
		return err
	}

	*o = GetOrganisationResponseContent(varGetOrganisationResponseContent)

	return err
}

type NullableGetOrganisationResponseContent struct {
	value *GetOrganisationResponseContent
	isSet bool
}

func (v NullableGetOrganisationResponseContent) Get() *GetOrganisationResponseContent {
	return v.value
}

func (v *NullableGetOrganisationResponseContent) Set(val *GetOrganisationResponseContent) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganisationResponseContent) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganisationResponseContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganisationResponseContent(val *GetOrganisationResponseContent) *NullableGetOrganisationResponseContent {
	return &NullableGetOrganisationResponseContent{value: val, isSet: true}
}

func (v NullableGetOrganisationResponseContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganisationResponseContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
