...
pub async fn list_organisation(configuration: &configuration::Configuration, page: Option<f64>, count: Option<f64>, all: Option<bool>) -> Result<models::ListOrganisationResponseContent, Error<ListOrganisationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page = page;
    let p_count = count;
    let p_all = all;
...
pub async fn list_workspace(configuration: &configuration::Configuration, x_org_id: &str, page: Option<f64>, count: Option<f64>, all: Option<bool>) -> Result<models::ListWorkspaceResponseContent, Error<ListWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_x_org_id = x_org_id;
    let p_page = page;
    let p_count = count;
...
pub async fn test(configuration: &configuration::Configuration, function_name: &str, stage: models::Stage, x_org_id: &str, x_tenant: &str) -> Result<(), Error<TestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_function_name = function_name;
    let p_stage = stage;
    let p_x_org_id = x_org_id;
...
pub async fn weight_recompute(configuration: &configuration::Configuration, x_org_id: &str, x_tenant: &str, x_config_tags: Option<&str>) -> Result<models::WeightRecomputeResponseContent, Error<WeightRecomputeError>> {
    ...
    let uri_str = format!("{}/weight/recompute", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
