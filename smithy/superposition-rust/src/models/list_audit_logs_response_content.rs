...
pub struct ListAuditLogsResponseContent {
    ...
    pub data: Option<Vec<models::AuditLogFull>>,
}

impl ListAuditLogsResponseContent {
    pub fn new() -> ListAuditLogsResponseContent {
