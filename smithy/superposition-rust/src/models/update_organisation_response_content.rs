...
impl UpdateOrganisationResponseContent {
    pub fn new(id: String, name: String, created_by: String, admin_email: String, status: String, created_at: String, updated_at: String, updated_by: String) -> UpdateOrganisationResponseContent {
