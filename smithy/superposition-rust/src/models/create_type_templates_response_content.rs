...
impl CreateTypeTemplatesResponseContent {
    pub fn new(type_name: String, type_schema: Option<serde_json::Value>, description: String, change_reason: String, created_by: String, created_at: String, last_modified_at: String, last_modified_by: String) -> CreateTypeTemplatesResponseContent {
