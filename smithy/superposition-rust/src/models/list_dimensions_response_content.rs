...
pub struct ListDimensionsResponseContent {
    ...
    pub data: Option<Vec<models::DimensionExt>>,
}

impl ListDimensionsResponseContent {
    pub fn new() -> ListDimensionsResponseContent {
