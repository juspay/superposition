...
impl DefaultConfigFull {
    pub fn new(key: String, value: Option<serde_json::Value>, schema: Option<serde_json::Value>, description: String, change_reason: String, created_at: String, created_by: String, last_modified_at: String, last_modified_by: String) -> DefaultConfigFull {
        DefaultConfigFull {
            key,
            value,
            schema,
