...
// Operations
@documentation("Creates a new custom function for value_validation, value_compute or context_validation with specified code, runtime version, and function type.")
...
@documentation("Publishes the draft version of a function, making it the active version used for value_validation, value_compute or context_validation in the system.")
@idempotent
