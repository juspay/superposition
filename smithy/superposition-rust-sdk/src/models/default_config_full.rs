...
impl DefaultConfigFull {
    pub fn new(key: String, value: Option<serde_json::Value>, schema: Option<serde_json::Value>, description: String, change_reason: String, created_at: f64, created_by: String, last_modified_at: f64, last_modified_by: String) -> DefaultConfigFull {
        DefaultConfigFull {
            key,
            value,
            schema,
