...
impl PublishResponseContent {
    pub fn new(function_name: String, draft_code: String, draft_runtime_version: String, draft_edited_at: f64, draft_edited_by: String, last_modified_at: f64, last_modified_by: String, change_reason: String, description: String) -> PublishResponseContent {
