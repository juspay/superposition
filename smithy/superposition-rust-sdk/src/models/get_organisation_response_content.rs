...
impl GetOrganisationResponseContent {
    pub fn new(id: String, name: String, created_by: String, admin_email: String, status: String, created_at: f64, updated_at: f64, updated_by: String) -> GetOrganisationResponseContent {
