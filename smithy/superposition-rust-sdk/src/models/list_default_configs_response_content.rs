...
pub struct ListDefaultConfigsResponseContent {
    ...
    pub data: Option<Vec<models::DefaultConfigFull>>,
}

impl ListDefaultConfigsResponseContent {
    pub fn new() -> ListDefaultConfigsResponseContent {
