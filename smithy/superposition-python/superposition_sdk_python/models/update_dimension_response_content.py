...
class UpdateDimensionResponseContent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dimension", "position", "schema", "function_name", "description", "change_reason", "last_modified_at", "last_modified_by", "created_at", "created_by", "mandatory"]
