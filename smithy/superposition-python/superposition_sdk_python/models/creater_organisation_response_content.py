...
class CreaterOrganisationResponseContent(BaseModel):
    """
    ...
    admin_email: StrictStr
    status: StrictStr
    sector: Optional[StrictStr] = None
    created_at: datetime
    updated_at: datetime
    updated_by: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "country_code", "contact_email", "contact_phone", "created_by", "admin_email", "status", "sector", "created_at", "updated_at", "updated_by"]
