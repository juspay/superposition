...
class UpdateDefaultConfigResponseContent(BaseModel):
    """
    ...
    function_name: Optional[StrictStr] = Field(default=None, description="Optional")
    created_at: datetime
    created_by: StrictStr
    last_modified_at: datetime
    last_modified_by: StrictStr
    __properties: ClassVar[List[str]] = ["key", "value", "schema", "description", "change_reason", "function_name", "created_at", "created_by", "last_modified_at", "last_modified_by"]
