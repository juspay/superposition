...
class GetTypeTemplatesListResponseContent(BaseModel):
    """
    GetTypeTemplatesListResponseContent
    """ # noqa: E501
    total_pages: Union[StrictFloat, StrictInt]
    total_items: Union[StrictFloat, StrictInt]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [TypeTemplatesResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
