...
CREATE INDEX IF NOT EXISTS variables_created_at_index ON localorg_dev.variables(created_at);
CREATE INDEX IF NOT EXISTS variables_last_modified_at_index ON localorg_dev.variables(last_modified_at);
...
CREATE INDEX IF NOT EXISTS variables_created_at_index ON localorg_test.variables(created_at);
CREATE INDEX IF NOT EXISTS variables_last_modified_at_index ON localorg_test.variables(last_modified_at);
