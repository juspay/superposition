...
CREATE TYPE dev.workspace_status AS ENUM (
    'ENABLED',
    'DISABLED'
);
...
CREATE TYPE test.workspace_status AS ENUM (
    'ENABLED',
    'DISABLED'
);
...
CREATE FUNCTION dev.event_logger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
...
CREATE FUNCTION test.event_logger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE old_data json;
new_data json;
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2023m08 FOR VALUES FROM ('2023-08-01 00:00:00') TO ('2023-09-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2023m09 FOR VALUES FROM ('2023-09-01 00:00:00') TO ('2023-10-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2023m10 FOR VALUES FROM ('2023-10-01 00:00:00') TO ('2023-11-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2023m11 FOR VALUES FROM ('2023-11-01 00:00:00') TO ('2023-12-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2023m12 FOR VALUES FROM ('2023-12-01 00:00:00') TO ('2024-01-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m01 FOR VALUES FROM ('2024-01-01 00:00:00') TO ('2024-02-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m02 FOR VALUES FROM ('2024-02-01 00:00:00') TO ('2024-03-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m03 FOR VALUES FROM ('2024-03-01 00:00:00') TO ('2024-04-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m04 FOR VALUES FROM ('2024-04-01 00:00:00') TO ('2024-05-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m05 FOR VALUES FROM ('2024-05-01 00:00:00') TO ('2024-06-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m06 FOR VALUES FROM ('2024-06-01 00:00:00') TO ('2024-07-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m07 FOR VALUES FROM ('2024-07-01 00:00:00') TO ('2024-08-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m08 FOR VALUES FROM ('2024-08-01 00:00:00') TO ('2024-09-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m09 FOR VALUES FROM ('2024-09-01 00:00:00') TO ('2024-10-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m10 FOR VALUES FROM ('2024-10-01 00:00:00') TO ('2024-11-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m11 FOR VALUES FROM ('2024-11-01 00:00:00') TO ('2024-12-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2024m12 FOR VALUES FROM ('2024-12-01 00:00:00') TO ('2025-01-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m01 FOR VALUES FROM ('2025-01-01 00:00:00') TO ('2025-02-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m02 FOR VALUES FROM ('2025-02-01 00:00:00') TO ('2025-03-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m03 FOR VALUES FROM ('2025-03-01 00:00:00') TO ('2025-04-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m04 FOR VALUES FROM ('2025-04-01 00:00:00') TO ('2025-05-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m05 FOR VALUES FROM ('2025-05-01 00:00:00') TO ('2025-06-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m06 FOR VALUES FROM ('2025-06-01 00:00:00') TO ('2025-07-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m07 FOR VALUES FROM ('2025-07-01 00:00:00') TO ('2025-08-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m08 FOR VALUES FROM ('2025-08-01 00:00:00') TO ('2025-09-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m09 FOR VALUES FROM ('2025-09-01 00:00:00') TO ('2025-10-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m10 FOR VALUES FROM ('2025-10-01 00:00:00') TO ('2025-11-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m11 FOR VALUES FROM ('2025-11-01 00:00:00') TO ('2025-12-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2025m12 FOR VALUES FROM ('2025-12-01 00:00:00') TO ('2026-01-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m01 FOR VALUES FROM ('2026-01-01 00:00:00') TO ('2026-02-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m02 FOR VALUES FROM ('2026-02-01 00:00:00') TO ('2026-03-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m03 FOR VALUES FROM ('2026-03-01 00:00:00') TO ('2026-04-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m04 FOR VALUES FROM ('2026-04-01 00:00:00') TO ('2026-05-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m05 FOR VALUES FROM ('2026-05-01 00:00:00') TO ('2026-06-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m06 FOR VALUES FROM ('2026-06-01 00:00:00') TO ('2026-07-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m07 FOR VALUES FROM ('2026-07-01 00:00:00') TO ('2026-08-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m08 FOR VALUES FROM ('2026-08-01 00:00:00') TO ('2026-09-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m09 FOR VALUES FROM ('2026-09-01 00:00:00') TO ('2026-10-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m10 FOR VALUES FROM ('2026-10-01 00:00:00') TO ('2026-11-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m11 FOR VALUES FROM ('2026-11-01 00:00:00') TO ('2026-12-01 00:00:00');
...
ALTER TABLE ONLY dev.event_log ATTACH PARTITION dev.event_log_y2026m12 FOR VALUES FROM ('2026-12-01 00:00:00') TO ('2027-01-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2023m08 FOR VALUES FROM ('2023-08-01 00:00:00') TO ('2023-09-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2023m09 FOR VALUES FROM ('2023-09-01 00:00:00') TO ('2023-10-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2023m10 FOR VALUES FROM ('2023-10-01 00:00:00') TO ('2023-11-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2023m11 FOR VALUES FROM ('2023-11-01 00:00:00') TO ('2023-12-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2023m12 FOR VALUES FROM ('2023-12-01 00:00:00') TO ('2024-01-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m01 FOR VALUES FROM ('2024-01-01 00:00:00') TO ('2024-02-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m02 FOR VALUES FROM ('2024-02-01 00:00:00') TO ('2024-03-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m03 FOR VALUES FROM ('2024-03-01 00:00:00') TO ('2024-04-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m04 FOR VALUES FROM ('2024-04-01 00:00:00') TO ('2024-05-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m05 FOR VALUES FROM ('2024-05-01 00:00:00') TO ('2024-06-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m06 FOR VALUES FROM ('2024-06-01 00:00:00') TO ('2024-07-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m07 FOR VALUES FROM ('2024-07-01 00:00:00') TO ('2024-08-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m08 FOR VALUES FROM ('2024-08-01 00:00:00') TO ('2024-09-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m09 FOR VALUES FROM ('2024-09-01 00:00:00') TO ('2024-10-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m10 FOR VALUES FROM ('2024-10-01 00:00:00') TO ('2024-11-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m11 FOR VALUES FROM ('2024-11-01 00:00:00') TO ('2024-12-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2024m12 FOR VALUES FROM ('2024-12-01 00:00:00') TO ('2025-01-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m01 FOR VALUES FROM ('2025-01-01 00:00:00') TO ('2025-02-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m02 FOR VALUES FROM ('2025-02-01 00:00:00') TO ('2025-03-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m03 FOR VALUES FROM ('2025-03-01 00:00:00') TO ('2025-04-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m04 FOR VALUES FROM ('2025-04-01 00:00:00') TO ('2025-05-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m05 FOR VALUES FROM ('2025-05-01 00:00:00') TO ('2025-06-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m06 FOR VALUES FROM ('2025-06-01 00:00:00') TO ('2025-07-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m07 FOR VALUES FROM ('2025-07-01 00:00:00') TO ('2025-08-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m08 FOR VALUES FROM ('2025-08-01 00:00:00') TO ('2025-09-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m09 FOR VALUES FROM ('2025-09-01 00:00:00') TO ('2025-10-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m10 FOR VALUES FROM ('2025-10-01 00:00:00') TO ('2025-11-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m11 FOR VALUES FROM ('2025-11-01 00:00:00') TO ('2025-12-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2025m12 FOR VALUES FROM ('2025-12-01 00:00:00') TO ('2026-01-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m01 FOR VALUES FROM ('2026-01-01 00:00:00') TO ('2026-02-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m02 FOR VALUES FROM ('2026-02-01 00:00:00') TO ('2026-03-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m03 FOR VALUES FROM ('2026-03-01 00:00:00') TO ('2026-04-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m04 FOR VALUES FROM ('2026-04-01 00:00:00') TO ('2026-05-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m05 FOR VALUES FROM ('2026-05-01 00:00:00') TO ('2026-06-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m06 FOR VALUES FROM ('2026-06-01 00:00:00') TO ('2026-07-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m07 FOR VALUES FROM ('2026-07-01 00:00:00') TO ('2026-08-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m08 FOR VALUES FROM ('2026-08-01 00:00:00') TO ('2026-09-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m09 FOR VALUES FROM ('2026-09-01 00:00:00') TO ('2026-10-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m10 FOR VALUES FROM ('2026-10-01 00:00:00') TO ('2026-11-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m11 FOR VALUES FROM ('2026-11-01 00:00:00') TO ('2026-12-01 00:00:00');
...
ALTER TABLE ONLY test.event_log ATTACH PARTITION test.event_log_y2026m12 FOR VALUES FROM ('2026-12-01 00:00:00') TO ('2027-01-01 00:00:00');
...
COPY dev.default_configs (key, value, created_at, created_by, schema, function_name, last_modified_at, last_modified_by) FROM stdin;
...
COPY dev.dimensions (dimension, priority, created_at, created_by, schema, function_name, last_modified_at, last_modified_by, "position") FROM stdin;
variantIds	1	2024-12-18 11:04:37.258074+00	user@example.com	{"type": "string","pattern": ".*"}	\N	2024-12-18 11:04:37.258074	null	0
city	1	2024-12-18 11:05:14.166214+00	user@superposition.io	{"pattern":".*","type":"string"}	\N	2024-12-18 11:05:14.166262	user@superposition.io	1
vehicle_type	1	2024-12-18 11:05:34.056043+00	user@superposition.io	{"enum":["auto","cab"],"type":"string"}	\N	2024-12-18 11:05:34.056048	user@superposition.io	2
hour_of_day	1	2024-12-18 11:05:44.634258+00	user@superposition.io	{"type":"integer"}	\N	2024-12-18 11:05:44.634265	user@superposition.io	3
\.
...
COPY dev.event_log_y2023m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2023m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2023m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2023m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2023m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2024m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2025m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.event_log_y2026m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY dev.experiments (id, created_at, created_by, last_modified, name, override_keys, status, traffic_percentage, context, variants, last_modified_by, chosen_variant) FROM stdin;
\.
...
COPY dev.functions (function_name, published_code, draft_code, function_description, published_runtime_version, draft_runtime_version, published_at, draft_edited_at, published_by, draft_edited_by, last_modified_at, last_modified_by) FROM stdin;
...
COPY dev.type_templates (type_name, type_schema, created_by, created_at, last_modified_at, last_modified_by) FROM stdin;
Number	{"type": "integer"}	user@superposition.io	2024-10-18 10:34:00.376562	2024-10-18 10:34:00.376562	null
Decimal	{"type": "number"}	user@superposition.io	2024-10-18 10:35:00.376562	2024-10-18 10:35:00.376562	null
Boolean	{"type": "boolean"}	user@superposition.io	2024-10-18 10:36:00.376562	2024-10-18 10:36:00.376562	null
Enum	{"type": "string", "enum": ["android", "ios"]}	user@superposition.io	2024-10-18 10:37:00.376562	2024-10-18 10:37:00.376562	null
Pattern	{"type": "string", "pattern": ".*"}	user@superposition.io	2024-10-18 10:38:00.376562	2024-10-18 10:38:00.376562	null
\.
...
COPY dev.workspaces (organization_id, organization_name, workspace_name, workspace_schema_name, workspace_status, workspace_admin_email, created_by, last_modified_by, last_modified_at, created_at) FROM stdin;
\.
...
COPY test.config_versions (id, config, config_hash, tags, created_at) FROM stdin;
\.
...
COPY test.contexts (id, value, override_id, created_at, created_by, priority, override, last_modified_at, last_modified_by, weight) FROM stdin;
\.
...
COPY test.default_configs (key, value, created_at, created_by, schema, function_name, last_modified_at, last_modified_by) FROM stdin;
\.
...
COPY test.dimensions (dimension, priority, created_at, created_by, schema, function_name, last_modified_at, last_modified_by, "position") FROM stdin;
variantIds	1	2024-12-18 11:04:43.661677+00	user@example.com	{"type": "string","pattern": ".*"}	\N	2024-12-18 11:04:43.661677	null	0
\.
...
COPY test.event_log_y2023m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2023m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2023m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2023m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2023m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2024m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
d56f8e2d-a323-4385-9d2a-730b41e62234	dimensions	postgres	2024-12-18 11:04:43.661677	INSERT	\N	{"dimension":"variantIds","priority":1,"created_at":"2024-12-18T11:04:43.661677+00:00","created_by":"user@example.com","schema":{"type": "string","pattern": ".*"},"function_name":null,"last_modified_at":"2024-12-18T11:04:43.661677","last_modified_by":"null","position":0}	INSERT INTO test.dimensions (dimension, priority, created_at, created_by, schema, function_name) VALUES ('variantIds', 1, CURRENT_TIMESTAMP, 'user@example.com', '{"type": "string","pattern": ".*"}'::json, null);
\.
...
COPY test.event_log_y2025m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2025m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m01 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m02 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m03 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m04 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m05 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m06 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m07 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m08 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m09 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m10 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m11 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.event_log_y2026m12 (id, table_name, user_name, "timestamp", action, original_data, new_data, query) FROM stdin;
\.
...
COPY test.experiments (id, created_at, created_by, last_modified, name, override_keys, status, traffic_percentage, context, variants, last_modified_by, chosen_variant) FROM stdin;
\.
...
COPY test.functions (function_name, published_code, draft_code, function_description, published_runtime_version, draft_runtime_version, published_at, draft_edited_at, published_by, draft_edited_by, last_modified_at, last_modified_by) FROM stdin;
\.
...
COPY test.type_templates (type_name, type_schema, created_by, created_at, last_modified_at, last_modified_by) FROM stdin;
Number	{"type": "integer"}	user@superposition.io	2024-10-18 10:34:00.376562	2024-10-18 10:34:00.376562	null
Decimal	{"type": "number"}	user@superposition.io	2024-10-18 10:35:00.376562	2024-10-18 10:35:00.376562	null
Boolean	{"type": "boolean"}	user@superposition.io	2024-10-18 10:36:00.376562	2024-10-18 10:36:00.376562	null
Enum	{"type": "string", "enum": ["android", "ios"]}	user@superposition.io	2024-10-18 10:37:00.376562	2024-10-18 10:37:00.376562	null
...
COPY test.workspaces (organization_id, organization_name, workspace_name, workspace_schema_name, workspace_status, workspace_admin_email, created_by, last_modified_by, last_modified_at, created_at) FROM stdin;
\.
...
--
-- Name: workspaces organization_workspace_pkey; Type: CONSTRAINT; Schema: dev; Owner: postgres
--

ALTER TABLE ONLY dev.workspaces
    ADD CONSTRAINT organization_workspace_pkey PRIMARY KEY (organization_id, workspace_name);
...
--
-- Name: workspaces organization_workspace_pkey; Type: CONSTRAINT; Schema: test; Owner: postgres
--
...
CREATE TRIGGER contexts_audit AFTER INSERT OR DELETE OR UPDATE ON dev.contexts FOR EACH ROW EXECUTE FUNCTION dev.event_logger();
...
CREATE TRIGGER default_configs_audit AFTER INSERT OR DELETE OR UPDATE ON dev.default_configs FOR EACH ROW EXECUTE FUNCTION dev.event_logger();
...
CREATE TRIGGER dimensions_audit AFTER INSERT OR DELETE OR UPDATE ON dev.dimensions FOR EACH ROW EXECUTE FUNCTION dev.event_logger();
...
CREATE TRIGGER experiments_audit AFTER INSERT OR DELETE OR UPDATE ON dev.experiments FOR EACH ROW EXECUTE FUNCTION dev.event_logger();
...
CREATE TRIGGER functions_audit AFTER INSERT OR DELETE OR UPDATE ON dev.functions FOR EACH ROW EXECUTE FUNCTION dev.event_logger();
...
CREATE TRIGGER contexts_audit AFTER INSERT OR DELETE OR UPDATE ON test.contexts FOR EACH ROW EXECUTE FUNCTION test.event_logger();
...
CREATE TRIGGER default_configs_audit AFTER INSERT OR DELETE OR UPDATE ON test.default_configs FOR EACH ROW EXECUTE FUNCTION test.event_logger();
...
CREATE TRIGGER dimensions_audit AFTER INSERT OR DELETE OR UPDATE ON test.dimensions FOR EACH ROW EXECUTE FUNCTION test.event_logger();
...
CREATE TRIGGER experiments_audit AFTER INSERT OR DELETE OR UPDATE ON test.experiments FOR EACH ROW EXECUTE FUNCTION test.event_logger();
...
CREATE TRIGGER functions_audit AFTER INSERT OR DELETE OR UPDATE ON test.functions FOR EACH ROW EXECUTE FUNCTION test.event_logger();
