...
CREATE OR REPLACE VIEW localorg_dev.job_manager AS
SELECT
    id,
    kronos_job_id,
    description,
...
WHERE workspace_schema = 'localorg_dev';

CREATE OR REPLACE VIEW localorg_test.job_manager AS
SELECT
    id,
    kronos_job_id,
    description,
    ...
    logs
FROM superposition.job_manager
WHERE workspace_schema = 'localorg_test';
