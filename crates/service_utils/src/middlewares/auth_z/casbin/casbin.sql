...
VALUES
    ...
    -- context
    ('g3', 'context:get', 'read', '', '', '', ''),
    ('g3', 'context:get_from_context', 'read', '', '', '', ''), 
    ('g3', 'context:list', 'read', '', '', '', ''),
    ('g3', 'context:validate', 'read', '', '', '', ''),
    ('p', 'context_reader', '*', 'context', 'read', '*', ''),

    -- dimension
    ('g3', 'dimension:get', 'read', '', '', '', ''),
    ('g3', 'dimension:list', 'read', '', '', '', ''),
    ('p', 'dimension_reader', '*', 'dimension', 'read', '*', ''),

    -- default_config
    ('g3', 'default_config:get', 'read', '', '', '', ''),
    ('g3', 'default_config:list', 'read', '', '', '', ''),
    ('p', 'default_config_reader', '*', 'default_config', 'read', '*', ''),

    -- config
    ('g3', 'config:get', 'read', '', '', '', ''),
    ('g3', 'config:get_toml', 'read', '', '', '', ''),
    ('g3', 'config:resolve', 'read', '', '', '', ''),
    ('g3', 'config:resolve_with_exp', 'read', '', '', '', ''),
    ('g3', 'config:list_version', 'read', '', '', '', ''),
    ('g3', 'config:get_version', 'read', '', '', '', ''),
    ('p', 'config_reader', '*', 'config', 'read', '*', ''),

    -- audit_log
    ('g3', 'audit_log:list', 'read', '', '', '', ''),
    ('p', 'audit_log_reader', '*', 'audit_log', 'read', '*', ''),

    -- function
    ('g3', 'function:get', 'read', '', '', '', ''),
    ('g3', 'function:list', 'read', '', '', '', ''),
    ('p', 'function_reader', '*', 'function', 'read', '*', ''),

    -- type_template
    ('g3', 'type_template:get', 'read', '', '', '', ''),
    ('g3', 'type_template:list', 'read', '', '', '', ''),
    ('p', 'type_template_reader', '*', 'type_template', 'read', '*', ''),

    -- experiment
    ('g3', 'experiment:get', 'read', '', '', '', ''),
    ('g3', 'experiment:list', 'read', '', '', '', ''),
    ('g3', 'experiment:get_applicable_variants', 'read', '', '', '', ''),
    ('p', 'experiment_reader', '*', 'experiment', 'read', '*', ''),

    -- experiment_group
    ('g3', 'experiment_group:get', 'read', '', '', '', ''),
    ('g3', 'experiment_group:list', 'read', '', '', '', ''),
    ('p', 'experiment_group_reader', '*', 'experiment_group', 'read', '*', ''),

    -- variable
    ('g3', 'variable:get', 'read', '', '', '', ''),
    ('g3', 'variable:list', 'read', '', '', '', ''),
    ...
    -- webhook
    ('g3', 'webhook:get', 'read', '', '', '', ''),
    ('g3', 'webhook:list', 'read', '', '', '', ''),
    ('g3', 'webhook:get_by_event', 'read', '', '', '', ''),
