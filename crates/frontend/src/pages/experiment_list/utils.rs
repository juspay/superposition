...
pub fn experiment_table_columns(
    ...
    vec![
        ...
        Column::default_with_sort(
            ...
            ColumnSortable::Yes {
                sort_on: ExperimentSortOn::CreatedAt.to_string(),
                ...
                current: current_sort_on == ExperimentSortOn::CreatedAt,
            },
        ),
        ...
        Column::default_with_sort(
            ...
            ColumnSortable::Yes {
                sort_on: ExperimentSortOn::LastModifiedAt.to_string(),
                sort_fn: Callback::new(move |_| {
                    let filters = filters_rs.get();
                ...
                current: current_sort_on == ExperimentSortOn::LastModifiedAt,
            },
        ),
    ]
}
