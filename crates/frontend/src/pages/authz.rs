...
pub fn OrganisationAuthz() -> impl IntoView {
    ...
    view! {
        <AuthzEditor
            ...
            description="Manage organization-level permissions, role assignments, and action-groups that apply across all workspaces. Access provided here will be inherited by all workspaces within the organization."
