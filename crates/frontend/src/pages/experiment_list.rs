...
use crate::types::{
    ExperimentListFilters, ExperimentResponse, ExperimentStatusType, PaginatedResponse,
    StatusTypes,
};
...
fn experiment_table_filter_widget(
    ...
    combined_resource: Resource<(String, ExperimentListFilters), CombinedResource>,
) -> impl IntoView {
    ...
    view! {
        ...
        >
            <div class="card-body">
                <div class="my-4">
                    <ContextForm
                        ...
                        handle_change=move |context| {
                            ...
                            filters_buffer_rws.set(ExperimentListFilters {
                ...
                <div class="w-[30vw] flex flex-row justify-start gap-10">
                    <div class="form-control">
                        ...
                        <DateInput
                            ...
                            class="flex-auto mt-3 mr-3".into()
                            ...
                            on_change=Callback::new(move |new_date: DateTime<Utc>| {
                                let old_filters = filters_rws.get();
                    ...
                    <i class="mt-5 mr-3 ri-arrow-right-line"></i>
                    <div class="form-control">
                        <label class="label">
                ...
                <div class="form-control w-full">
                    ...
                    <div class="flex flex-row justify-start gap-7">
                        <input
                            type="checkbox"
                            id="created-checkbox"
...
pub fn experiment_list() -> impl IntoView {
    ...
    let combined_resource: Resource<(String, ExperimentListFilters), CombinedResource> =
        create_blocking_resource(
            move || (tenant_rs.get(), filters_rws.get()),
            |(current_tenant, filters)| async move {
                // Perform all fetch operations concurrently
                let experiments_future =
                    fetch_experiments(filters.clone(), current_tenant.to_string());
                                    ...
                                    view! {
                                        <ConditionCollapseProvider>
                                            <div class="flex justify-start m-1">
                                                <ExperimentTableFilterWidget filters_rws combined_resource />
                                            </div>
                                            <Table
