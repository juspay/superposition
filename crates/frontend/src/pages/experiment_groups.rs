...
use crate::{
    api::{
        experiment_group::{fetch_experiment_group, remove_members_from_group},
        fetch_experiments,
    },
    components::{
        alert::AlertType,
        ...
        <div class="card bg-base-100 max-w-screen shadow">
            <div class="card-body flex flex-row gap-2 flex-wrap">
                <div class="h-fit w-[300px]">
                    <ConditionComponent conditions id="experiment-group-context" />
                </div>
                <div class="h-fit w-[300px]">
...
pub fn experiment_groups() -> impl IntoView {
    ...
    > = create_blocking_resource(source, |(group_id, tenant, org_id)| async move {
        let group = fetch_experiment_group(&group_id, &tenant, &org_id)
            .await
            .ok()?;
    ...
    let confirm_delete = Callback::new(move |change_reason: String| {
        ...
        spawn_local(async move {
            ...
            if let Err(e) = remove_members_from_group(
                    ...
                    view! {
                        <div class="flex flex-col gap-10 overflow-x-auto p-7 bg-transparent">
                            <ConditionCollapseProvider>
                                ...
                                <div class="card rounded-xl w-full bg-base-100 shadow">
                                    <div class="card-body">
                                        <div class="flex justify-between">
                                            ...
                                            <DrawerBtn drawer_id="add_member_group_drawer"
                                                .to_string()>
                                                Add Member <i class="ri-add-large-fill ml-2"></i>
                                            </DrawerBtn>
                                        </div>
                                ...
                                <Drawer
                                    id="add_member_group_drawer".to_string()
                                    header="Add a member to the group"
                                    handle_close=move || { close_drawer("add_member_group_drawer") }
                                >
                                    <AddExperimentToGroupForm
                                        experiment_group=resource_group
                                        handle_submit=Callback::new(move |_| {
                                            close_drawer("add_member_group_drawer");
                                            experiment_group_resource.refetch();
                                        })
                                    />
