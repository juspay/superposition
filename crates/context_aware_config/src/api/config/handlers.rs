...
fn get_config_version_from_params(
...
async fn get_config(
    ...
    let mut version = get_config_version_from_params(
        &mut query_params_map,
        &workspace_context,
        &mut conn,
    )?;
...
async fn get_resolved_config(
    ...
    let mut config_version = get_config_version_from_params(
        &mut query_params_map,
        &workspace_context,
        &mut conn,
    )?;
