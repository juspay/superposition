...
fn rotate_workspace_encryption_key_internal(
    ...
    workspace: &Workspace,
    schema_name: &str,
    new_master_key: &secrecy::SecretString,
    old_master_key: &secrecy::SecretString,
    user_email: &str,
    ...
    let previous_key_secret = previous_key
        .as_ref()
...
pub async fn rotate_master_key_handler(
    ...
    let previous_master_key = &app_state.previous_master_key;
