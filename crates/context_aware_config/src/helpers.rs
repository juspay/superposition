...
pub fn generate_cac(
    ...
    let cohort_dimensions: Map<String, Value> = dimensions::dsl::dimensions
        .filter(dimensions::dsl::dimension_type.eq(DimensionType::Cohort))
        .select((dimensions::dsl::dimension, dimensions::dsl::schema))
