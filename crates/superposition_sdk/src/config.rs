...
impl Config {
    ...
    pub fn retry_config(
        &self,
    ) -> ::std::option::Option<&::aws_smithy_types::retry::RetryConfig> {
...
impl ::std::default::Default for Builder {
    fn default() -> Self {
        Self {
            ...
            runtime_components: crate::config::RuntimeComponentsBuilder::new(
                "service config",
            ),
...
impl Builder {
    ...
    pub fn http_client(
        mut self,
        http_client: impl crate::config::HttpClient + 'static,
    ) -> Self {
    ...
    pub fn basic_auth_login_resolver(
        mut self,
        basic_auth_resolver: impl crate::config::ResolveIdentity + 'static,
    ) -> Self {
        self.runtime_components.set_identity_resolver(
            ::aws_smithy_runtime_api::client::auth::http::HTTP_BASIC_AUTH_SCHEME_ID,
            ::aws_smithy_runtime_api::shared::IntoShared::<
                ::aws_smithy_runtime_api::client::identity::SharedIdentityResolver,
            >::into_shared(basic_auth_resolver),
        );
        self
    }
    ...
    pub fn sleep_impl(
        mut self,
        sleep_impl: impl crate::config::AsyncSleep + 'static,
    ) -> Self {
    ...
    pub fn interceptor(
        mut self,
        interceptor: impl crate::config::Intercept + 'static,
    ) -> Self {
    ...
    pub fn push_interceptor(
        &mut self,
        interceptor: crate::config::SharedInterceptor,
    ) -> &mut Self {
        ...
        self.set_time_source(::std::option::Option::Some(
            ::aws_smithy_async::time::SharedTimeSource::new(
                ::aws_smithy_async::time::StaticTimeSource::new(
                    ::std::time::UNIX_EPOCH
                        + ::std::time::Duration::from_secs(1234567890),
                ),
            ),
        ));
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("superposition_sdk::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub fn new(_service_config: crate::config::Config) -> Self {
        ...
        runtime_components.push_auth_scheme(
            ::aws_smithy_runtime_api::client::auth::SharedAuthScheme::new(
                ::aws_smithy_runtime::client::auth::http::BasicAuthScheme::new(),
            ),
        );
        runtime_components.push_auth_scheme(
            ::aws_smithy_runtime_api::client::auth::SharedAuthScheme::new(
...
impl ConfigOverrideRuntimePlugin {
    ...
    pub(crate) fn new(
        ...
        #[allow(unused_mut)]
        let mut resolver =
            ::aws_smithy_runtime::client::config_override::Resolver::overrid(
                initial_config,
                initial_components,
                &mut layer,
                &mut components,
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("superposition_sdk::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
