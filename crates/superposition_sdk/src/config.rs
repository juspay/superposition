...
impl Builder {
    ...
    /// Adds an auth scheme to the builder
                            ...
                            /// impl superposition_sdk::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
                            ///     fn resolve_auth_scheme<'a>(
                            ///         &'a self,
                            ///         _params: &'a superposition_sdk::config::auth::Params,
                            ///         _cfg: &'a ConfigBag,
                            ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// Set the partition for retry-related state. When clients share a retry partition, they will
                            ...
                            /// # Default Behavior
                            ///
                            /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `superposition`
                            /// (or `superposition-<region>` if a region is configured).
                            /// All Superposition clients without an explicit retry partition will share this default partition.
                            ///
                            /// # Notes
                            ///
                            ...
                            /// ```no_run
                            /// use superposition_sdk::config::Config;
                            /// use superposition_sdk::config::retry::{RetryPartition, TokenBucket};
                            ///
                            ...
                            /// ```no_run
                            /// use superposition_sdk::config::Config;
                            /// use superposition_sdk::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
                            ///
    ...
    /// Add type implementing [`ClassifyRetry`](::aws_smithy_runtime_api::client::retries::classifiers::ClassifyRetry) that will be used by the
                            ...
                            /// #    fn meta(&self) -> &superposition_sdk::error::ErrorMetadata { todo!() }
                            /// # }
                            ///
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    let config = { let mut cfg = ::aws_smithy_types::config_bag::Layer::new("Superposition");
