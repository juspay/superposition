...
pub trait ResolveEndpoint:
    ::std::marker::Send + ::std::marker::Sync + ::std::fmt::Debug
{
    ...
    where
        Self: Sized + 'static,
    {
        ::aws_smithy_runtime_api::client::endpoint::SharedEndpointResolver::new(
            DowncastParams(self),
        )
    }
}
    ...
    T: ResolveEndpoint,
{
    fn resolve_endpoint<'a>(
        ...
        let ep = match params.get::<crate::config::endpoint::Params>() {
            ...
            None => ::aws_smithy_runtime_api::client::endpoint::EndpointFuture::ready(
                Err("params of expected type was not present".into()),
            ),
        };
        ep
    }
