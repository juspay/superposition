...
impl ::std::convert::From<&str> for DimensionType {
                    fn from(s: &str) -> Self {
                        match s {
                            "LOCALCOHORT" => DimensionType::LocalCohort,
"REGULAR" => DimensionType::Regular,
"REMOTECOHORT" => DimensionType::RemoteCohort,
...
impl DimensionType {
                ...
                pub fn as_str(&self) -> &str {
                    match self {
    DimensionType::LocalCohort => "LOCALCOHORT",
    DimensionType::Regular => "REGULAR",
    DimensionType::RemoteCohort => "REMOTECOHORT",
    DimensionType::Unknown(value) => value.as_str()
}
                }
                /// Returns all the `&str` representations of the enum members.
                pub const fn values() -> &'static [&'static str] {
                    &["LOCALCOHORT", "REGULAR", "REMOTECOHORT"]
                }
            }
...
impl ::std::fmt::Display for DimensionType {
                        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                            match self {
                                DimensionType::LocalCohort => write!(f, "LOCALCOHORT"),
DimensionType::Regular => write!(f, "REGULAR"),
DimensionType::RemoteCohort => write!(f, "REMOTECOHORT"),
