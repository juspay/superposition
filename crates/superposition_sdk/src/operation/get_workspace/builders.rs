...
impl GetWorkspaceFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_workspace::builders::GetWorkspaceInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_workspace::GetWorkspace::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_workspace::GetWorkspace::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
