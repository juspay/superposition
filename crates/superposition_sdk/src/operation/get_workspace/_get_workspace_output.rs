...
impl GetWorkspaceOutputBuilder {
    ...
    /// - [`strict_mode`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::strict_mode)
        ...
        ::std::result::Result::Ok(
            crate::operation::get_workspace::GetWorkspaceOutput {
                ...
                strict_mode: self.strict_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("strict_mode", "strict_mode was not specified but it is required when building GetWorkspaceOutput")
                    )?
                ,
