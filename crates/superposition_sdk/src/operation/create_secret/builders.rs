...
impl CreateSecretFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::create_secret::builders::CreateSecretInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::create_secret::CreateSecret::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::create_secret::CreateSecret::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
