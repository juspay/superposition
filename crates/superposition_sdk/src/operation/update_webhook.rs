...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for UpdateWebhookResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for UpdateWebhookRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_webhook::ser_update_webhook_input(
                &input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdateWebhookEndpointParamsInterceptor
{
...
impl UpdateWebhookError {
    ...
    /// Returns `true` if the error kind is `UpdateWebhookError::WorkspaceLockConflict`.
