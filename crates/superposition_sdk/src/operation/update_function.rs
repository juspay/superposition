...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for UpdateFunctionResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for UpdateFunctionRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_function::ser_update_function_input(
                &input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdateFunctionEndpointParamsInterceptor
{
...
impl UpdateFunctionError {
    ...
    /// Returns `true` if the error kind is `UpdateFunctionError::WorkspaceLockConflict`.
