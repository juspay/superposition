...
.with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(TestEndpointParamsInterceptor))
...
fn uri_base(_input: &crate::operation::test::TestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let stage = ::aws_smithy_http::label::fmt_string(input_2.as_str(), ::aws_smithy_http::label::EncodingStrategy::Default);
    if stage.is_empty() {
