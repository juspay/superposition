...
impl ListVersionsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_versions::builders::ListVersionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_versions::ListVersions::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::list_versions::ListVersions::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
