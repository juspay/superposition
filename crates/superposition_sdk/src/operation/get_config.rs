...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetConfigResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_config::de_get_config_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetConfigRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_config::GetConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_get_config::ser_get_config_headers(
                        input, builder,
                    )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_config::ser_get_config_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetConfigEndpointParamsInterceptor
{
