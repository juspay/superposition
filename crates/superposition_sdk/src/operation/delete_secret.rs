...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DeleteSecretResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DeleteSecretRequestSerializer
{
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteSecretEndpointParamsInterceptor
{
...
impl DeleteSecretError {
    ...
    /// Returns `true` if the error kind is `DeleteSecretError::WorkspaceLockConflict`.
