...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListSecretsResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListSecretsRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let mut request_builder = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_list_secrets::ser_list_secrets_headers(
                        input, builder,
                    )?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListSecretsEndpointParamsInterceptor
{
