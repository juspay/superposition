    ...
    fn config(
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
                GetTypeTemplatesListRequestSerializer,
            ),
        );
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetTypeTemplatesListResponseDeserializer,
            ),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetTypeTemplatesListResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetTypeTemplatesListRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_type_templates_list::GetTypeTemplatesListInput,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetTypeTemplatesListEndpointParamsInterceptor
{
