...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for PublishResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_publish::de_publish_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_publish::de_publish_http_response(
                status, headers, body,
            )
        };
    ...
    > {
        ...
        let mut request_builder = {
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_publish::ser_publish_headers(
                    input, builder,
                )?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_publish::ser_publish_input(&input)?,
        );
...
impl PublishError {
    ...
    /// Returns `true` if the error kind is `PublishError::WorkspaceLockConflict`.
