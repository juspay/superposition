...
impl UpdateSecretFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::update_secret::builders::UpdateSecretInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::update_secret::UpdateSecret::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::update_secret::UpdateSecret::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
