    ...
    fn config(
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
                CreateOrganisationRequestSerializer,
            ),
        );
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                CreateOrganisationResponseDeserializer,
            ),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CreateOrganisationResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for CreateOrganisationRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::create_organisation::CreateOrganisationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::create_organisation::CreateOrganisationInput,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateOrganisationEndpointParamsInterceptor
{
