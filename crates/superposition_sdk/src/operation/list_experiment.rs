    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_experiment::ListExperimentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_experiment::ListExperimentOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for ListExperimentResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_experiment::de_list_experiment_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_experiment::de_list_experiment_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for ListExperimentRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::list_experiment::ListExperimentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_experiment::ListExperimentInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError>
            {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/experiments/list")
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError>
            {
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.count {
                    {
                        query.push_kv(
                            "count",
                            ::aws_smithy_types::primitive::Encoder::from(*inner_2)
                                .encode(),
                        );
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.page {
                    {
                        query.push_kv(
                            "page",
                            ::aws_smithy_types::primitive::Encoder::from(*inner_3)
                                .encode(),
                        );
                    }
                }
                if let ::std::option::Option::Some(inner_4) = &_input.all {
                    {
                        query.push_kv(
                            "all",
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.from_date {
                    {
                        query.push_kv(
                            "from_date",
                ...
                if let ::std::option::Option::Some(inner_8) = &_input.to_date {
                    {
                        query.push_kv(
                            "to_date",
                            &::aws_smithy_http::query::fmt_timestamp(
                ...
                if let ::std::option::Option::Some(inner_9) = &_input.experiment_name {
                    {
                        query.push_kv(
                            "experiment_name",
                ...
                if let ::std::option::Option::Some(inner_10) = &_input.experiment_ids {
                    {
                ...
                if let ::std::option::Option::Some(inner_12) =
                    &_input.experiment_group_ids
                {
                    {
                ...
                if let ::std::option::Option::Some(inner_14) = &_input.created_by {
                    {
                ...
                if let ::std::option::Option::Some(inner_16) = &_input.sort_on {
                    {
                        query.push_kv(
                            "sort_on",
                ...
                if let ::std::option::Option::Some(inner_17) = &_input.sort_by {
                    {
                        query.push_kv(
                            "sort_by",
                ...
                if let ::std::option::Option::Some(inner_18) =
                    &_input.global_experiments_only
                {
                    {
                        query.push_kv(
                            "global_experiments_only",
                            ::aws_smithy_types::primitive::Encoder::from(*inner_18)
                                .encode(),
                        );
                    }
                }
                if let ::std::option::Option::Some(inner_19) =
                ...
                if let ::std::option::Option::Some(inner_20) = &_input.prefix {
                    {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_experiment::ser_list_experiment_input(
                &input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for ListExperimentEndpointParamsInterceptor
{
