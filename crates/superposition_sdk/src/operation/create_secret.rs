...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for CreateSecretResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for CreateSecretRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_secret::ser_create_secret_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for CreateSecretEndpointParamsInterceptor
{
...
impl CreateSecretError {
    ...
    /// Returns `true` if the error kind is `CreateSecretError::WorkspaceLockConflict`.
