...
impl ListSecretsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_secrets::builders::ListSecretsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_secrets::ListSecrets::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::list_secrets::ListSecrets::orchestrate(&runtime_plugins, input)
            .await
    }
