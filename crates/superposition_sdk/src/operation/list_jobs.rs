...
fn uri_query(_input: &crate::operation::list_jobs::ListJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_5) = &_input.job_type {
         {
            query.push_kv("job_type", &::aws_smithy_http::query::fmt_string(inner_5));
        }
    }
    ::std::result::Result::Ok(())
}
...
impl ListJobsError {
    ...
    /// Returns `true` if the error kind is `ListJobsError::InternalServerError`.
