...
impl DeleteSecretFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::delete_secret::builders::DeleteSecretInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::delete_secret::DeleteSecret::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::delete_secret::DeleteSecret::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
