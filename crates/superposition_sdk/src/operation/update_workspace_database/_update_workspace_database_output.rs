...
pub struct UpdateWorkspaceDatabaseOutput  {
    #[allow(missing_docs)] // documentation missing in model
...
impl  UpdateWorkspaceDatabaseOutput  {
    #[allow(missing_docs)] // documentation missing in model
...
impl UpdateWorkspaceDatabaseOutput {
    /// Creates a new builder-style object to manufacture [`UpdateWorkspaceDatabaseOutput`](crate::operation::update_workspace_database::UpdateWorkspaceDatabaseOutput).
    pub fn builder() -> crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder {
        crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::default()
    }
}

/// A builder for [`UpdateWorkspaceDatabaseOutput`](crate::operation::update_workspace_database::UpdateWorkspaceDatabaseOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateWorkspaceDatabaseOutputBuilder {
...
impl UpdateWorkspaceDatabaseOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`UpdateWorkspaceDatabaseOutput`](crate::operation::update_workspace_database::UpdateWorkspaceDatabaseOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`workspace_name`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::workspace_name)
    /// - [`organisation_id`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::organisation_id)
    /// - [`organisation_name`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::organisation_name)
    /// - [`workspace_schema_name`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::workspace_schema_name)
    /// - [`workspace_status`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::workspace_status)
    /// - [`workspace_admin_email`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::workspace_admin_email)
    /// - [`created_by`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::created_by)
    /// - [`last_modified_by`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::last_modified_by)
    /// - [`last_modified_at`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::last_modified_at)
    /// - [`created_at`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::created_at)
    /// - [`strict_mode`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::strict_mode)
    /// - [`allow_experiment_self_approval`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::allow_experiment_self_approval)
    /// - [`auto_populate_control`](crate::operation::update_workspace_database::builders::UpdateWorkspaceDatabaseOutputBuilder::auto_populate_control)
    pub fn build(self) -> ::std::result::Result<crate::operation::update_workspace_database::UpdateWorkspaceDatabaseOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_workspace_database::UpdateWorkspaceDatabaseOutput {
                workspace_name: self.workspace_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_name", "workspace_name was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                organisation_id: self.organisation_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("organisation_id", "organisation_id was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                organisation_name: self.organisation_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("organisation_name", "organisation_name was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                workspace_schema_name: self.workspace_schema_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_schema_name", "workspace_schema_name was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                workspace_status: self.workspace_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_status", "workspace_status was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                workspace_admin_email: self.workspace_admin_email
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_admin_email", "workspace_admin_email was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                ...
                created_by: self.created_by
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                last_modified_by: self.last_modified_by
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                last_modified_at: self.last_modified_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                ...
                strict_mode: self.strict_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("strict_mode", "strict_mode was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                ...
                allow_experiment_self_approval: self.allow_experiment_self_approval
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("allow_experiment_self_approval", "allow_experiment_self_approval was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
                auto_populate_control: self.auto_populate_control
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("auto_populate_control", "auto_populate_control was not specified but it is required when building UpdateWorkspaceDatabaseOutput")
                    )?
                ,
            }
        )
