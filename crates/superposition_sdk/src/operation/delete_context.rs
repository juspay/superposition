...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for DeleteContextResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DeleteContextRequestSerializer
{
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteContextEndpointParamsInterceptor
{
...
impl DeleteContextError {
    ...
    /// Returns `true` if the error kind is `DeleteContextError::WebhookFailed`.
    pub fn is_webhook_failed(&self) -> bool {
        matches!(self, Self::WebhookFailed(_))
    }
    /// Returns `true` if the error kind is `DeleteContextError::WorkspaceLockConflict`.
