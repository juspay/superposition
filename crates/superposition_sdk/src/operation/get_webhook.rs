    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_webhook::GetWebhookError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_webhook::GetWebhookOutput>()
    ...
    fn config(
        ...
        cfg.store_put(
            ::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
                GetWebhookResponseDeserializer,
            ),
        );
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for GetWebhookResponseDeserializer
{
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_webhook::de_get_webhook_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_webhook::de_get_webhook_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for GetWebhookRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        let input = input
            .downcast::<crate::operation::get_webhook::GetWebhookInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_webhook::GetWebhookInput,
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError>
            {
                ...
                ::std::write!(output, "/webhook/{name}", name = name)
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_get_webhook::ser_get_webhook_headers(
                        input, builder,
                    )?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for GetWebhookEndpointParamsInterceptor
{
