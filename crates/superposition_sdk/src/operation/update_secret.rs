...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse
    for UpdateSecretResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for UpdateSecretRequestSerializer
{
    #[allow(
        unused_mut,
    ...
    > {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_secret::ser_update_secret_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for UpdateSecretEndpointParamsInterceptor
{
...
impl UpdateSecretError {
    ...
    /// Returns `true` if the error kind is `UpdateSecretError::WorkspaceLockConflict`.
