...
#[derive(Debug)]
    ...
    ::std::write!(output, "/jobs/{id}/cancel", id = id).expect("formatting should succeed");
...
impl CancelJobError {
    ...
    /// Returns `true` if the error kind is `CancelJobError::ResourceNotFound`.
    pub fn is_resource_not_found(&self) -> bool {
        matches!(self, Self::ResourceNotFound(_))
    }
    /// Returns `true` if the error kind is `CancelJobError::InternalServerError`.
