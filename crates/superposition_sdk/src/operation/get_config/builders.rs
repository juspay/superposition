...
impl GetConfigFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::get_config::builders::GetConfigInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_config::GetConfig::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_config::GetConfig::orchestrate(&runtime_plugins, input)
            .await
    }
