...
pub struct GetConfigOutput  {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub cohort_dimensions: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::aws_smithy_types::Document>>,
    #[allow(missing_docs)] // documentation missing in model
...
impl  GetConfigOutput  {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn cohort_dimensions(&self) -> ::std::option::Option<&::std::collections::HashMap::<::std::string::String, ::aws_smithy_types::Document>> {
        self.cohort_dimensions.as_ref()
    }
    #[allow(missing_docs)] // documentation missing in model
...
pub struct GetConfigOutputBuilder {
    ...
    pub(crate) cohort_dimensions: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::aws_smithy_types::Document>>,
