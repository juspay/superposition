...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest
    for DeleteWebhookRequestSerializer
{
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for DeleteWebhookEndpointParamsInterceptor
{
...
impl DeleteWebhookError {
    ...
    /// Returns `true` if the error kind is `DeleteWebhookError::WorkspaceLockConflict`.
