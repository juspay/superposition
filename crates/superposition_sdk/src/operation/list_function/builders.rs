...
impl ListFunctionFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_function::builders::ListFunctionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_function::ListFunction::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::list_function::ListFunction::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
