...
impl super::Client {
    ...
    ///   - [`all(bool)`](crate::operation::list_dimensions::builders::ListDimensionsFluentBuilder::all) / [`set_all(Option<bool>)`](crate::operation::list_dimensions::builders::ListDimensionsFluentBuilder::set_all):<br>required: **false**<br>(undocumented)<br>
