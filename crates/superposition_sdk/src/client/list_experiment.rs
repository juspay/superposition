...
impl super::Client {
    ...
    ///   - [`filter_exact_match(bool)`](crate::operation::list_experiment::builders::ListExperimentFluentBuilder::filter_exact_match) / [`set_filter_exact_match(Option<bool>)`](crate::operation::list_experiment::builders::ListExperimentFluentBuilder::set_filter_exact_match):<br>required: **false**<br>(undocumented)<br>
