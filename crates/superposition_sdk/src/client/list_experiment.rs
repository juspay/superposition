...
impl super::Client {
    ...
    ///   - [`if_modified_since(DateTime)`](crate::operation::list_experiment::builders::ListExperimentFluentBuilder::if_modified_since) / [`set_if_modified_since(Option<DateTime>)`](crate::operation::list_experiment::builders::ListExperimentFluentBuilder::set_if_modified_since):<br>required: **false**<br>While using this, 304 response is treated as error, which needs to be handled separately by checking the response code of the http response. This is required to make sure that clients can cache the response and avoid unnecessary calls when there are no updates.<br>
