...
impl super::Client {
    ...
    ///   - [`exclude_prefix(impl Into<String>)`](crate::operation::get_config::builders::GetConfigFluentBuilder::exclude_prefix) / [`set_exclude_prefix(Option<Vec::<String>>)`](crate::operation::get_config::builders::GetConfigFluentBuilder::set_exclude_prefix):<br>required: **false**<br>(undocumented)<br>
    ...
    pub fn get_config(
        &self,
    ) -> crate::operation::get_config::builders::GetConfigFluentBuilder {
        crate::operation::get_config::builders::GetConfigFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
