...
impl super::Client {
    ...
    ///   - [`page(i64)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::page) / [`set_page(Option<i64>)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::set_page):<br>required: **false**<br>(undocumented)<br>
    ///   - [`count(i64)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::count) / [`set_count(Option<i64>)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::set_count):<br>required: **false**<br>(undocumented)<br>
    ...
    ///   - [`all(bool)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::all) / [`set_all(Option<bool>)`](crate::operation::list_experiment_groups::builders::ListExperimentGroupsFluentBuilder::set_all):<br>required: **false**<br>If true, returns all experiment groups, ignoring pagination parameters page and count.<br>
    ...
    ///   - [`total_pages(i64)`](crate::operation::list_experiment_groups::ListExperimentGroupsOutput::total_pages): (undocumented)
    ///   - [`total_items(i64)`](crate::operation::list_experiment_groups::ListExperimentGroupsOutput::total_items): (undocumented)
