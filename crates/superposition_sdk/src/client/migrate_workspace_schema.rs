...
impl super::Client {
    ...
    ///   - [`metrics(Document)`](crate::operation::migrate_workspace_schema::MigrateWorkspaceSchemaOutput::metrics): Workspace metric source and catalog. Each metric definition contains a unique name and whether higher or lower values are better.
    ...
    ///   - [`workspace_lock(Option<WorkspaceLock>)`](crate::operation::migrate_workspace_schema::MigrateWorkspaceSchemaOutput::workspace_lock): Metadata for an active workspace write lock. Present only while another write operation is holding the workspace lease.
