...
impl super::Client {
    ...
    ///   - [`metrics(Document)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::metrics) / [`set_metrics(Option<Document>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::set_metrics):<br>required: **false**<br>Optional metrics for the experiment. May carry a selection drawn from the workspace's metric list (primary and guardrail required, secondary optional) and/or a per-experiment source override; both are optional independently. A per-experiment source is only accepted when the workspace has a source configured.<br>
    ...
    ///   - [`idempotency_key(impl Into<String>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::idempotency_key) / [`set_idempotency_key(Option<String>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::set_idempotency_key):<br>required: **false**<br>(undocumented)<br>
    ///   - [`config_tags(impl Into<String>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::config_tags) / [`set_config_tags(Option<String>)`](crate::operation::create_experiment::builders::CreateExperimentFluentBuilder::set_config_tags):<br>required: **false**<br>(undocumented)<br>
