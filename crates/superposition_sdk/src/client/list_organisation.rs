...
impl super::Client {
    ...
    pub fn list_organisation(
        &self,
    ) -> crate::operation::list_organisation::builders::ListOrganisationFluentBuilder
    {
        crate::operation::list_organisation::builders::ListOrganisationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
