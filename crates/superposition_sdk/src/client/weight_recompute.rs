...
impl super::Client {
    ...
    pub fn weight_recompute(
        &self,
    ) -> crate::operation::weight_recompute::builders::WeightRecomputeFluentBuilder {
        crate::operation::weight_recompute::builders::WeightRecomputeFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
