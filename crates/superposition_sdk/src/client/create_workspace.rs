...
impl super::Client {
    ...
    ///   - [`metrics(Document)`](crate::operation::create_workspace::builders::CreateWorkspaceFluentBuilder::metrics) / [`set_metrics(Option<Document>)`](crate::operation::create_workspace::builders::CreateWorkspaceFluentBuilder::set_metrics):<br>required: **false**<br>Workspace metric source and catalog. Each metric definition contains a unique name and whether higher or lower values are better.<br>
    ...
    ///   - [`metrics(Document)`](crate::operation::create_workspace::CreateWorkspaceOutput::metrics): Workspace metric source and catalog. Each metric definition contains a unique name and whether higher or lower values are better.
    ...
    ///   - [`workspace_lock(Option<WorkspaceLock>)`](crate::operation::create_workspace::CreateWorkspaceOutput::workspace_lock): Metadata for an active workspace write lock. Present only while another write operation is holding the workspace lease.
