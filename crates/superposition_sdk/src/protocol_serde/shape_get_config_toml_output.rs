...
pub(crate) fn de_toml_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<::std::string::String>, crate::operation::get_config_toml::GetConfigTomlError> {
    (!body.is_empty()).then(||{
        let body_str = std::str::from_utf8(body).map_err(crate::operation::get_config_toml::GetConfigTomlError::unhandled)?;
