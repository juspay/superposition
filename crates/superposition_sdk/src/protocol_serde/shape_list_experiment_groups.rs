...
pub fn de_list_experiment_groups_http_error(
...
> {
    ...
    .map_err(
        crate::operation::list_experiment_groups::ListExperimentGroupsError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_experiment_groups_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_list_experiment_groups_input(
    input: &crate::operation::list_experiment_groups::ListExperimentGroupsInput,
) -> ::std::result::Result<
...
pub(crate) fn de_list_experiment_groups(
    value: &[u8],
