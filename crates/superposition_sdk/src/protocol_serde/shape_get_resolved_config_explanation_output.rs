...
pub(crate) fn de_explanation_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ResolveExplanation>, crate::operation::get_resolved_config_explanation::GetResolvedConfigExplanationError> {
    (!body.is_empty()).then(||{
