...
> {
    ...
    Err(match error_code {
        "WorkspaceLockConflict" => {
            crate::operation::create_function::CreateFunctionError::WorkspaceLockConflict(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WorkspaceLockConflictBuilder::default();
                        output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::create_function::CreateFunctionError::unhandled)?;
                        let output = output.meta(generic);
                        crate::serde_util::workspace_lock_conflict_correct_errors(output).build().map_err(crate::operation::create_function::CreateFunctionError::unhandled)?
                    };
                    tmp
                },
            )
        ...
        "InternalServerError" => {
            crate::operation::create_function::CreateFunctionError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        .map_err(crate::operation::create_function::CreateFunctionError::unhandled)?;
        crate::serde_util::create_function_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_function::CreateFunctionError::unhandled)?
    })
}
