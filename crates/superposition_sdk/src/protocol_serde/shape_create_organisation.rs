...
pub fn de_create_organisation_http_error(
...
> {
    ...
    .map_err(crate::operation::create_organisation::CreateOrganisationError::unhandled)?;
    let generic = generic_builder.build();
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::create_organisation::CreateOrganisationError::unhandled(
                    generic,
                ),
            ),
        };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_organisation_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_create_organisation::de_create_organisation(
                _response_body,
                output,
            )
            .map_err(
        ...
        crate::serde_util::create_organisation_output_output_correct_errors(output)
            .build()
            .map_err(
                crate::operation::create_organisation::CreateOrganisationError::unhandled,
            )?
...
pub fn ser_create_organisation_input(
...
pub(crate) fn de_create_organisation(
    value: &[u8],
