...
pub(crate) fn de_audit_log_full<'a, I>(tokens: &mut ::std::iter::Peekable<I>, _value: &'a [u8], depth: u32) -> ::std::result::Result<Option<crate::types::AuditLogFull>, ::aws_smithy_json::deserialize::error::DeserializeError>
