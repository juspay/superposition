...
pub(crate) fn de_update_type_templates(_value: &[u8], mut builder: crate::operation::update_type_templates::builders::UpdateTypeTemplatesOutputBuilder) -> ::std::result::Result<crate::operation::update_type_templates::builders::UpdateTypeTemplatesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
