...
pub fn de_update_type_templates_http_error(
...
> {
    ...
    .map_err(
        crate::operation::update_type_templates::UpdateTypeTemplatesError::unhandled,
    )?;
    ...
    Err(match error_code {
        ...
        "WorkspaceLockConflict" => crate::operation::update_type_templates::UpdateTypeTemplatesError::WorkspaceLockConflict({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WorkspaceLockConflictBuilder::default();
                    output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::update_type_templates::UpdateTypeTemplatesError::unhandled)?;
                    let output = output.meta(generic);
                    crate::serde_util::workspace_lock_conflict_correct_errors(output).build().map_err(crate::operation::update_type_templates::UpdateTypeTemplatesError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_type_templates_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_update_type_templates_input(
    input: &crate::operation::update_type_templates::UpdateTypeTemplatesInput,
) -> ::std::result::Result<
...
pub(crate) fn de_update_type_templates(
    value: &[u8],
