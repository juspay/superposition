...
pub(crate) fn de_context_action_out<'a, I>(tokens: &mut ::std::iter::Peekable<I>, _value: &'a [u8], depth: u32) -> ::std::result::Result<Option<crate::types::ContextActionOut>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        variant = match key.as_ref() {
                            "PUT" => {
                                Some(crate::types::ContextActionOut::Put(
                                    crate::protocol_serde::shape_context_response::de_context_response(tokens, _value, depth + 1)?
