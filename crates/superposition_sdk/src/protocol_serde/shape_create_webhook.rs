...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_webhook::CreateWebhookError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "WorkspaceLockConflict" => {
            crate::operation::create_webhook::CreateWebhookError::WorkspaceLockConflict({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerError" => {
            crate::operation::create_webhook::CreateWebhookError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        .map_err(crate::operation::create_webhook::CreateWebhookError::unhandled)?;
        crate::serde_util::create_webhook_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_webhook::CreateWebhookError::unhandled)?
    })
}
...
> {
    ...
    crate::protocol_serde::shape_create_webhook_input::ser_create_webhook_input_input(
        &mut object,
        input,
    )?;
    object.finish();
