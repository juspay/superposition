...
> {
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::publish::PublishError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "WorkspaceLockConflict" => {
            crate::operation::publish::PublishError::WorkspaceLockConflict({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WorkspaceLockConflictBuilder::default();
                    output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::publish::PublishError::unhandled)?;
                    let output = output.meta(generic);
        ...
        "InternalServerError" => {
            crate::operation::publish::PublishError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_publish::de_publish(_response_body, output)
            .map_err(crate::operation::publish::PublishError::unhandled)?;
        crate::serde_util::publish_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::publish::PublishError::unhandled)?
    })
}
...
> {
    ...
    crate::protocol_serde::shape_publish_input::ser_publish_input_input(
        &mut object,
        input,
    )?;
    object.finish();
