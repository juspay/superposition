...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_secret::CreateSecretError::unhandled(generic),
            )
        }
    };
        ...
        "WorkspaceLockConflict" => {
            crate::operation::create_secret::CreateSecretError::WorkspaceLockConflict({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::create_secret::CreateSecretError::unhandled)?;
                    let output = output.meta(generic);
                    crate::serde_util::workspace_lock_conflict_correct_errors(output)
                        .build()
                        .map_err(
                            crate::operation::create_secret::CreateSecretError::unhandled,
                        )?
                };
                tmp
            })
...
> {
    Ok({
        ...
        .map_err(crate::operation::create_secret::CreateSecretError::unhandled)?;
        crate::serde_util::create_secret_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_secret::CreateSecretError::unhandled)?
    })
}
...
> {
    ...
    crate::protocol_serde::shape_create_secret_input::ser_create_secret_input_input(
        &mut object,
        input,
    )?;
    object.finish();
