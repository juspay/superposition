...
> {
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::update_function::UpdateFunctionError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "WorkspaceLockConflict" => {
            crate::operation::update_function::UpdateFunctionError::WorkspaceLockConflict(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InternalServerError" => {
            crate::operation::update_function::UpdateFunctionError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        .map_err(crate::operation::update_function::UpdateFunctionError::unhandled)?;
        crate::serde_util::update_function_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_function::UpdateFunctionError::unhandled)?
    })
}
