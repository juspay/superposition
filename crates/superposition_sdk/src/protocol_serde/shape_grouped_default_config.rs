...
pub(crate) fn de_grouped_default_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> ::std::result::Result<Option<crate::types::GroupedDefaultConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            "Group" => {
                                Some(crate::types::GroupedDefaultConfig::Group(
                            ...
                            "Config" => {
                                Some(crate::types::GroupedDefaultConfig::Config(
                                    crate::protocol_serde::shape_default_config_response::de_default_config_response(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'Config' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                                                                              Some(crate::types::GroupedDefaultConfig::Unknown)
                                                                            }
                        };
                    }
