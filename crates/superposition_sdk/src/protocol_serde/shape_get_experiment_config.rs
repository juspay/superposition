...
pub fn de_get_experiment_config_http_error(
...
> {
    ...
    .map_err(
        crate::operation::get_experiment_config::GetExperimentConfigError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_experiment_config_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_get_experiment_config_input(
    input: &crate::operation::get_experiment_config::GetExperimentConfigInput,
) -> ::std::result::Result<
...
pub(crate) fn de_get_experiment_config(
    value: &[u8],
