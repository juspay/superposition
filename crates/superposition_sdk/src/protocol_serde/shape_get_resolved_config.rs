...
pub fn de_get_resolved_config_http_error(
...
> {
    ...
    .map_err(crate::operation::get_resolved_config::GetResolvedConfigError::unhandled)?;
    let generic = generic_builder.build();
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::get_resolved_config::GetResolvedConfigError::unhandled(
                    generic,
                ),
            ),
        };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_resolved_config_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_audit_id(
            crate::protocol_serde::shape_get_resolved_config_output::de_audit_id_header(
                _response_headers,
            )
            .map_err(|_| {
                crate::operation::get_resolved_config::GetResolvedConfigError::unhandled(
                    "Failed to parse audit_id from header `x-audit-id",
                )
            })?,
        );
        output = output.set_config(
            crate::protocol_serde::shape_get_resolved_config_output::de_config_payload(
                _response_body,
            )?,
        );
        ...
        output = output.set_version(
            crate::protocol_serde::shape_get_resolved_config_output::de_version_header(
                _response_headers,
            )
            .map_err(|_| {
                crate::operation::get_resolved_config::GetResolvedConfigError::unhandled(
        ...
        crate::serde_util::get_resolved_config_output_output_correct_errors(output)
            .build()
            .map_err(
                crate::operation::get_resolved_config::GetResolvedConfigError::unhandled,
            )?
...
pub fn ser_get_resolved_config_input(
    input: &crate::operation::get_resolved_config::GetResolvedConfigInput,
) -> ::std::result::Result<
