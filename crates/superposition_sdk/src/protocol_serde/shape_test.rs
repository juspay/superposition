...
> {
    ...
    .map_err(crate::operation::test::TestError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerError" => {
            crate::operation::test::TestError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_test::de_test(_response_body, output)
            .map_err(crate::operation::test::TestError::unhandled)?;
        crate::serde_util::test_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::test::TestError::unhandled)?
    })
}
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "fn_output" => {
                        builder = builder.set_fn_output(Some(
