...
pub fn de_get_context_from_condition_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_context_from_condition::GetContextFromConditionOutput, crate::operation::get_context_from_condition::GetContextFromConditionError> {
    ...
    Err(match error_code {
        ...
        "WebhookFailed" => crate::operation::get_context_from_condition::GetContextFromConditionError::WebhookFailed({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WebhookFailedBuilder::default();
                    output = crate::protocol_serde::shape_webhook_failed::de_webhook_failed_json_err(_response_body, output).map_err(crate::operation::get_context_from_condition::GetContextFromConditionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
