...
pub(crate) fn de_workspace_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>, _value: &'a [u8], depth: u32) -> ::std::result::Result<Option<crate::types::WorkspaceResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
