...
pub fn de_create_experiment_group_http_error(
...
> {
    ...
    .map_err(
        crate::operation::create_experiment_group::CreateExperimentGroupError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_experiment_group_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_create_experiment_group_input(
    input: &crate::operation::create_experiment_group::CreateExperimentGroupInput,
) -> ::std::result::Result<
