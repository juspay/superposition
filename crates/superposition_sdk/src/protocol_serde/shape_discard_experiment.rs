...
pub fn de_discard_experiment_http_error(
...
> {
    ...
    .map_err(crate::operation::discard_experiment::DiscardExperimentError::unhandled)?;
    let generic = generic_builder.build();
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::discard_experiment::DiscardExperimentError::unhandled(
                    generic,
                ),
            ),
        };
    ...
    Err(match error_code {
        ...
        "WebhookFailed" => crate::operation::discard_experiment::DiscardExperimentError::WebhookFailed({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WebhookFailedBuilder::default();
                    output = crate::protocol_serde::shape_webhook_failed::de_webhook_failed_json_err(_response_body, output).map_err(crate::operation::discard_experiment::DiscardExperimentError::unhandled)?;
                    let output = output.meta(generic);
                    crate::serde_util::webhook_failed_correct_errors(output).build().map_err(crate::operation::discard_experiment::DiscardExperimentError::unhandled)?
                }
            ;
            if tmp.message.is_none() {
                                                            tmp.message = _error_message;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_discard_experiment_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_discard_experiment::de_discard_experiment(
            _response_body,
            output,
        )
        .map_err(
        ...
        crate::serde_util::discard_experiment_output_output_correct_errors(output)
            .build()
            .map_err(
                crate::operation::discard_experiment::DiscardExperimentError::unhandled,
            )?
...
pub fn ser_discard_experiment_input(
    input: &crate::operation::discard_experiment::DiscardExperimentInput,
) -> ::std::result::Result<
...
pub(crate) fn de_discard_experiment(
    value: &[u8],
