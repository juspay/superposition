...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::delete_context::DeleteContextError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        ...
        "WebhookFailed" => {
            crate::operation::delete_context::DeleteContextError::WebhookFailed({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                        crate::types::error::builders::WebhookFailedBuilder::default();
                    output = crate::protocol_serde::shape_webhook_failed::de_webhook_failed_json_err(_response_body, output).map_err(crate::operation::delete_context::DeleteContextError::unhandled)?;
                    let output = output.meta(generic);
                    crate::serde_util::webhook_failed_correct_errors(output).build().map_err(crate::operation::delete_context::DeleteContextError::unhandled)?
                };
                if tmp.message.is_none() {
                    tmp.message = _error_message;
                }
        ...
        "WorkspaceLockConflict" => {
            crate::operation::delete_context::DeleteContextError::WorkspaceLockConflict({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WorkspaceLockConflictBuilder::default();
                    output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::delete_context::DeleteContextError::unhandled)?;
                    let output = output.meta(generic);
                    crate::serde_util::workspace_lock_conflict_correct_errors(output).build().map_err(crate::operation::delete_context::DeleteContextError::unhandled)?
                };
                tmp
            })
        }
        "InternalServerError" => {
            crate::operation::delete_context::DeleteContextError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
