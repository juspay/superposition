...
pub fn de_delete_context_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_context::DeleteContextOutput, crate::operation::delete_context::DeleteContextError> {
    ...
    Err(match error_code {
        ...
        "WebhookFailed" => crate::operation::delete_context::DeleteContextError::WebhookFailed({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "WorkspaceLockConflict" => crate::operation::delete_context::DeleteContextError::WorkspaceLockConflict({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
