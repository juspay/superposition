...
pub(crate) fn de_dimension_type<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<
    Option<crate::types::DimensionType>,
...
pub fn ser_dimension_type(
    object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::DimensionType,
    ...
    match input {
        ...
        crate::types::DimensionType::Unknown => {
            return Err(
