...
> {
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::delete_function::DeleteFunctionError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "WorkspaceLockConflict" => {
            crate::operation::delete_function::DeleteFunctionError::WorkspaceLockConflict(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::WorkspaceLockConflictBuilder::default();
                        output = crate::protocol_serde::shape_workspace_lock_conflict::de_workspace_lock_conflict_json_err(_response_body, output).map_err(crate::operation::delete_function::DeleteFunctionError::unhandled)?;
                        let output = output.meta(generic);
                        crate::serde_util::workspace_lock_conflict_correct_errors(output).build().map_err(crate::operation::delete_function::DeleteFunctionError::unhandled)?
                    };
                    tmp
                },
            )
        ...
        "InternalServerError" => {
            crate::operation::delete_function::DeleteFunctionError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
