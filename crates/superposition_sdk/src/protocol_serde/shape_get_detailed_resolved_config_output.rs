...
pub(crate) fn de_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<::aws_smithy_types::Document>, crate::operation::get_detailed_resolved_config::GetDetailedResolvedConfigError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_document::de_document_payload(body).map_err(crate::operation::get_detailed_resolved_config::GetDetailedResolvedConfigError::unhandled)
    }).transpose()
}
