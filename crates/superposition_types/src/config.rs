...
use crate::{overridden::filter_keys_by_prefix, Cac, Contextual, Exp};
...
impl Config {
    ...
    pub fn filter_default_by_prefix(
        ...
        filter_keys_by_prefix(self.default_configs.clone(), prefix_list)
    }

    fn _filter_by_prefix(
        &self,
        prefix_list: &HashSet<String>,
    ...
    pub fn try_filter_by_prefix(
        ...
        self._filter_by_prefix(prefix_list, true)
    }
    ...
    pub fn filter_by_prefix(&self, prefix_list: &HashSet<String>) -> Self {
        self._filter_by_prefix(prefix_list, false).unwrap()
    }
}
