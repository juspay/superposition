...
ADD COLUMN IF NOT EXISTS enable_context_validation BOOLEAN DEFAULT TRUE;

UPDATE superposition.workspaces SET enable_context_validation = FALSE;

ALTER TABLE superposition.workspaces
ADD COLUMN IF NOT EXISTS enable_change_reason_validation BOOLEAN DEFAULT TRUE;

UPDATE superposition.workspaces SET enable_change_reason_validation = FALSE;
