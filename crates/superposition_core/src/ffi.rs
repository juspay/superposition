...
use crate::{
    ...
    experiment::FfiExperimentGroup, get_applicable_variants, FfiExperiment, MergeStrategy,
};
...
impl ProviderCache {
    ...
    fn filter_config(
        ...
        let dimension_data = dimension_data
            ...
            .transpose()
            .map_err(|err| OperationError::Unexpected(err.to_string()))?;
        self.filter_config_inner(dimension_data.as_ref(), prefix, exclude_prefix)
            .map_err(OperationError::Unexpected)
    }
    ...
    fn filter_experiment(
        ...
        let dimension_data = dimension_data
            ...
            .map_err(|err| OperationError::Unexpected(err.to_string()))?
            .unwrap_or_default();
        self.filter_experiment_inner(&dimension_data, prefix, exclude_prefix, partial_apply)
            .map_err(OperationError::Unexpected)
    }
