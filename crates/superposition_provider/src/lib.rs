...
mod tests {
    ...
    // #[tokio::test]
    // async fn test_superposition_provider_creation() {
    //     let options = SuperpositionProviderOptions::new(
    ...
    //         ),
    //         ConfigurationOptions::new(RefreshStrategy::OnDemand(
    //             OnDemandStrategy::default(),
    //         )),
    //         None, // No experimentation options
    //     );

    //     let provider = SuperpositionProvider::new(options);
    //     assert_eq!(provider.get_status().await, ProviderStatus::NotReady);
    // }
    ...
    async fn test_cac_config_creation() {
        ...
        let config_options = ConfigurationOptions::new(RefreshStrategy::OnDemand(
            OnDemandStrategy::default(),
        ));
