...
impl ConversionUtils {
    ...
    pub fn serde_value_to_struct_value(value: &Value) -> Result<open_feature::StructValue> {
        match value {
            Value::Object(map) => {
    ...
    pub fn serde_value_to_openfeature_value(value: &Value) -> Result<open_feature::Value> {
        match value {
