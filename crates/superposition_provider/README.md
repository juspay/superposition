...
```toml
[dependencies]
superposition_provider = { path = "../superposition_provider" }
open-feature = "0.2"
...
let options = SuperpositionProviderOptions {
    ...
    cac_options: ConfigurationOptions::new(
    ...
    experimentation_options: Some(ExperimentationOptions {
        ...
        default_toss: Some(50), // Default randomization percentage
    })
};
```
...
Use the builder pattern for more readable configuration:

```rust
let options = SuperpositionProviderOptions::with_experimentation(
    ...
    ConfigurationOptions::new(RefreshStrategy::Polling(PollingStrategy::default()))
        .with_fallback_config(fallback_map)
        .with_evaluation_cache(EvaluationCacheOptions::default()),
    ExperimentationOptions::new(RefreshStrategy::OnDemand(OnDemandStrategy::default()))
        .with_default_toss(42)
);
```
