...
instance Data.Aeson.FromJSON RemoveMembersFromGroupError
...
deserializeResponse response = do
    ...
    Io.Superposition.Model.RemoveMembersFromGroupOutput.build $ do
        Io.Superposition.Model.RemoveMembersFromGroupOutput.setBuckets bucketsDocumentE
        ...
        Io.Superposition.Model.RemoveMembersFromGroupOutput.setGroupType group_typeDocumentE
