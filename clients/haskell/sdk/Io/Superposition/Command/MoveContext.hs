...
instance Io.Superposition.Utility.OperationError MoveContextError where
...
moveContext :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.MoveContextInput.MoveContextInputBuilder () -> IO (Either MoveContextError Io.Superposition.Model.MoveContextOutput.MoveContextOutput)
moveContext client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.MoveContextInput.build builder)
