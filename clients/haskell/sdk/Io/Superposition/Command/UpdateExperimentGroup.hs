...
instance Data.Aeson.ToJSON UpdateExperimentGroupError
instance Data.Aeson.FromJSON UpdateExperimentGroupError
instance Io.Superposition.Utility.OperationError UpdateExperimentGroupError where
...
updateExperimentGroup :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.UpdateExperimentGroupInput.UpdateExperimentGroupInputBuilder () -> IO (Either UpdateExperimentGroupError Io.Superposition.Model.UpdateExperimentGroupOutput.UpdateExperimentGroupOutput)
updateExperimentGroup client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.UpdateExperimentGroupInput.build builder)
