...
instance Io.Superposition.Utility.OperationError ListContextsError where
...
listContexts :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.ListContextsInput.ListContextsInputBuilder () -> IO (Either ListContextsError Io.Superposition.Model.ListContextsOutput.ListContextsOutput)
listContexts client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.ListContextsInput.build builder)
