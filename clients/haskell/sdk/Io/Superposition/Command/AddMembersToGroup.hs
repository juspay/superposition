...
instance Io.Superposition.Utility.OperationError AddMembersToGroupError where
...
addMembersToGroup :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.AddMembersToGroupInput.AddMembersToGroupInputBuilder () -> IO (Either AddMembersToGroupError Io.Superposition.Model.AddMembersToGroupOutput.AddMembersToGroupOutput)
addMembersToGroup client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.AddMembersToGroupInput.build builder)
