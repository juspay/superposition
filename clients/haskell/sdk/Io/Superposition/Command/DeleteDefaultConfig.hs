...
instance Io.Superposition.Utility.OperationError DeleteDefaultConfigError where
...
deleteDefaultConfig :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.DeleteDefaultConfigInput.DeleteDefaultConfigInputBuilder () -> IO (Either DeleteDefaultConfigError Io.Superposition.Model.DeleteDefaultConfigOutput.DeleteDefaultConfigOutput)
deleteDefaultConfig client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.DeleteDefaultConfigInput.build builder)
