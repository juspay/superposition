...
serDeleteTypeTemplatesHEADER input =
    let 
        workspace_idHeader = (Io.Superposition.Model.DeleteTypeTemplatesInput.workspace_id input
        ...
        org_idHeader = (Io.Superposition.Model.DeleteTypeTemplatesInput.org_id input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
...
serDeleteTypeTemplatesLABEL :: Io.Superposition.Model.DeleteTypeTemplatesInput.DeleteTypeTemplatesInput -> Data.ByteString.ByteString
serDeleteTypeTemplatesLABEL input = 
    Data.ByteString.toStrict $ Data.ByteString.Builder.toLazyByteString $ Network.HTTP.Types.URI.encodePathSegmentsRelative [
        "types",
        (Io.Superposition.Model.DeleteTypeTemplatesInput.type_name input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
        
        ]
    

deleteTypeTemplates :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.DeleteTypeTemplatesInput.DeleteTypeTemplatesInputBuilder () -> IO (Data.Either.Either DeleteTypeTemplatesError Io.Superposition.Model.DeleteTypeTemplatesOutput.DeleteTypeTemplatesOutput)
deleteTypeTemplates client inputB = do
    let inputE = Io.Superposition.Model.DeleteTypeTemplatesInput.build inputB
    ...
    where
        ...
        toRequest input req =
            req {
                Network.HTTP.Client.path = serDeleteTypeTemplatesLABEL input
                , Network.HTTP.Client.method = method
                , Network.HTTP.Client.requestHeaders = (serDeleteTypeTemplatesHEADER input) ++ [("Authorization", "Bearer " <> token)]
            }
        
    


deserializeResponse :: Network.HTTP.Client.Response Data.ByteString.Lazy.ByteString -> Data.Either.Either Data.Text.Text Io.Superposition.Model.DeleteTypeTemplatesOutput.DeleteTypeTemplatesOutput
deserializeResponse response = do
    ...
    Io.Superposition.Model.DeleteTypeTemplatesOutput.build $ do
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setTypeName type_nameDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setChangeReason change_reasonDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setTypeSchema type_schemaDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setDescription descriptionDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setCreatedAt created_atDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setLastModifiedBy last_modified_byDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setCreatedBy created_byDocumentE
        Io.Superposition.Model.DeleteTypeTemplatesOutput.setLastModifiedAt last_modified_atDocumentE
