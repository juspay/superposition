...
instance Data.Aeson.FromJSON GetExperimentError

serGetExperimentHEADER :: Io.Superposition.Model.GetExperimentInput.GetExperimentInput -> Network.HTTP.Types.Header.RequestHeaders
serGetExperimentHEADER input =
    let 
        workspace_idHeader = (Io.Superposition.Model.GetExperimentInput.workspace_id input
        ...
        org_idHeader = (Io.Superposition.Model.GetExperimentInput.org_id input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
...
serGetExperimentLABEL :: Io.Superposition.Model.GetExperimentInput.GetExperimentInput -> Data.ByteString.ByteString
serGetExperimentLABEL input = 
    Data.ByteString.toStrict $ Data.ByteString.Builder.toLazyByteString $ Network.HTTP.Types.URI.encodePathSegmentsRelative [
        "experiments",
        (Io.Superposition.Model.GetExperimentInput.id' input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
        
        ]
    

getExperiment :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.GetExperimentInput.GetExperimentInputBuilder () -> IO (Data.Either.Either GetExperimentError Io.Superposition.Model.GetExperimentOutput.GetExperimentOutput)
getExperiment client inputB = do
    let inputE = Io.Superposition.Model.GetExperimentInput.build inputB
    ...
    where
        ...
        toRequest input req =
            req {
                Network.HTTP.Client.path = serGetExperimentLABEL input
                , Network.HTTP.Client.method = method
                , Network.HTTP.Client.requestHeaders = (serGetExperimentHEADER input) ++ [("Authorization", "Bearer " <> token)]
            }
        
    


deserializeResponse :: Network.HTTP.Client.Response Data.ByteString.Lazy.ByteString -> Data.Either.Either Data.Text.Text Io.Superposition.Model.GetExperimentOutput.GetExperimentOutput
deserializeResponse response = do
    ...
    Io.Superposition.Model.GetExperimentOutput.build $ do
        Io.Superposition.Model.GetExperimentOutput.setChosenVariant chosen_variantDocumentE
        Io.Superposition.Model.GetExperimentOutput.setCreatedAt created_atDocumentE
        Io.Superposition.Model.GetExperimentOutput.setDescription descriptionDocumentE
        Io.Superposition.Model.GetExperimentOutput.setVariants variantsDocumentE
        Io.Superposition.Model.GetExperimentOutput.setLastModifiedBy last_modified_byDocumentE
        Io.Superposition.Model.GetExperimentOutput.setOverrideKeys override_keysDocumentE
        ...
        Io.Superposition.Model.GetExperimentOutput.setExperimentGroupId experiment_group_idDocumentE
