...
instance Io.Superposition.Utility.OperationError GetDimensionError where
...
getDimension :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.GetDimensionInput.GetDimensionInputBuilder () -> IO (Either GetDimensionError Io.Superposition.Model.GetDimensionOutput.GetDimensionOutput)
getDimension client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.GetDimensionInput.build builder)
