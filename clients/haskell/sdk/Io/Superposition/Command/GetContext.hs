...
instance Io.Superposition.Utility.OperationError GetContextError where
...
getContext :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.GetContextInput.GetContextInputBuilder () -> IO (Either GetContextError Io.Superposition.Model.GetContextOutput.GetContextOutput)
