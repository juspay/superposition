...
instance Data.Aeson.ToJSON DeleteExperimentGroupError
instance Data.Aeson.FromJSON DeleteExperimentGroupError
instance Io.Superposition.Utility.OperationError DeleteExperimentGroupError where
...
deleteExperimentGroup :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.DeleteExperimentGroupInput.DeleteExperimentGroupInputBuilder () -> IO (Either DeleteExperimentGroupError Io.Superposition.Model.DeleteExperimentGroupOutput.DeleteExperimentGroupOutput)
deleteExperimentGroup client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.DeleteExperimentGroupInput.build builder)
