module Io.Superposition.Command.UpdateSecret (
    UpdateSecretError (..),
    updateSecret
) where
...
import qualified Io.Superposition.Model.UpdateSecretInput
import qualified Io.Superposition.Model.UpdateSecretOutput
import qualified Io.Superposition.Model.WorkspaceLockConflict
import qualified Io.Superposition.SuperpositionClient
import qualified Io.Superposition.Utility

data UpdateSecretError =
...
instance Data.Aeson.ToJSON UpdateSecretError
instance Io.Superposition.Utility.OperationError UpdateSecretError where
...
updateSecret :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.UpdateSecretInput.UpdateSecretInputBuilder () -> IO (Either UpdateSecretError Io.Superposition.Model.UpdateSecretOutput.UpdateSecretOutput)
updateSecret client builder =
    let endpoint = Io.Superposition.SuperpositionClient.endpointUri client
        manager = Io.Superposition.SuperpositionClient.httpManager client
        auth = Io.Superposition.SuperpositionClient.getAuth client
    in Io.Superposition.Utility.runOperation endpoint manager auth (Io.Superposition.Model.UpdateSecretInput.build builder)
