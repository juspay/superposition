module Io.Superposition.Command.UpdateVariable (
    UpdateVariableError (..),
    updateVariable
) where
...
instance Data.Aeson.ToJSON UpdateVariableError
instance Io.Superposition.Utility.OperationError UpdateVariableError where
...
updateVariable :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.UpdateVariableInput.UpdateVariableInputBuilder () -> IO (Either UpdateVariableError Io.Superposition.Model.UpdateVariableOutput.UpdateVariableOutput)
updateVariable client builder =
    ...
    in Io.Superposition.Utility.runOperation endpoint manager setAuth (Io.Superposition.Model.UpdateVariableInput.build builder)
