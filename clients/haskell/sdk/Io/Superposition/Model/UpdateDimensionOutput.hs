...
setSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> UpdateDimensionOutputBuilder ()
setSchema value =
   Control.Monad.State.Strict.modify (\s -> (s { schemaBuilderState = Data.Maybe.Just value }))

setValueValidationFunctionName :: Data.Maybe.Maybe Data.Text.Text -> UpdateDimensionOutputBuilder ()
...
setDependencyGraph :: Data.Map.Map Data.Text.Text ([] Data.Text.Text) -> UpdateDimensionOutputBuilder ()
setDependencyGraph value =
   Control.Monad.State.Strict.modify (\s -> (s { dependency_graphBuilderState = Data.Maybe.Just value }))

setDimensionType :: Io.Superposition.Model.DimensionType.DimensionType -> UpdateDimensionOutputBuilder ()
setDimensionType value =
   Control.Monad.State.Strict.modify (\s -> (s { dimension_typeBuilderState = Data.Maybe.Just value }))

setValueComputeFunctionName :: Data.Maybe.Maybe Data.Text.Text -> UpdateDimensionOutputBuilder ()
