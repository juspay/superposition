...
instance Io.Superposition.Utility.SerializeBody CreateWorkspaceOutput
...
setMetrics :: Data.Aeson.Value -> CreateWorkspaceOutputBuilder ()
setMetrics value =
...
setEnableContextValidation :: Bool -> CreateWorkspaceOutputBuilder ()
...
setEnableChangeReasonValidation :: Bool -> CreateWorkspaceOutputBuilder ()
...
setWorkspaceLock :: Data.Maybe.Maybe Io.Superposition.Model.WorkspaceLock.WorkspaceLock -> CreateWorkspaceOutputBuilder ()
...
build builder = do
    ...
    metrics' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.CreateWorkspaceOutput.CreateWorkspaceOutput.metrics is a required property.") Data.Either.Right (metricsBuilderState st)
...
instance Io.Superposition.Utility.FromResponseParser CreateWorkspaceOutput where
