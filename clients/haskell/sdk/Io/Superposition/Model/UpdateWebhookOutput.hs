...
instance Io.Superposition.Utility.SerializeBody UpdateWebhookOutput
...
type UpdateWebhookOutputBuilder = Control.Monad.State.Strict.State UpdateWebhookOutputBuilderState
...
setMaxRetries :: Data.Int.Int32 -> UpdateWebhookOutputBuilder ()
setMaxRetries value =
...
instance Io.Superposition.Utility.FromResponseParser UpdateWebhookOutput where
