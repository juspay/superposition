...
instance Io.Superposition.Utility.SerializeBody GetDimensionOutput
...
type GetDimensionOutputBuilder = Control.Monad.State.Strict.State GetDimensionOutputBuilderState
...
setPosition :: Data.Int.Int32 -> GetDimensionOutputBuilder ()
setPosition value =
   Control.Monad.State.Strict.modify (\s -> (s { positionBuilderState = Data.Maybe.Just value }))

setSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> GetDimensionOutputBuilder ()
setSchema value =
   Control.Monad.State.Strict.modify (\s -> (s { schemaBuilderState = Data.Maybe.Just value }))

setValueValidationFunctionName :: Data.Maybe.Maybe Data.Text.Text -> GetDimensionOutputBuilder ()
...
setDependencyGraph :: Data.Map.Map Data.Text.Text ([] Data.Text.Text) -> GetDimensionOutputBuilder ()
...
instance Io.Superposition.Utility.FromResponseParser GetDimensionOutput where
    ...
    responseParser = do
        ...
        var6 <- Io.Superposition.Utility.deSerField "value_validation_function_name"
        ...
        var11 <- Io.Superposition.Utility.deSerField "value_compute_function_name"
        ...
        pure $ GetDimensionOutput {
            ...
            position = var12,
            schema = var0,
            value_validation_function_name = var6,
            description = var1,
            change_reason = var9,
            ...
            value_compute_function_name = var11,
            mandatory = var5
        }
