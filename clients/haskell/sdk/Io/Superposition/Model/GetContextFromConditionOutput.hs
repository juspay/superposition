...
instance Io.Superposition.Utility.SerializeBody GetContextFromConditionOutput
...
type GetContextFromConditionOutputBuilder = Control.Monad.State.Strict.State GetContextFromConditionOutputBuilderState
...
instance Io.Superposition.Utility.FromResponseParser GetContextFromConditionOutput where
    ...
    responseParser = do
        ...
        pure $ GetContextFromConditionOutput {
            id' = var5,
            value = var8,
            override = var6,
            override_id = var1,
