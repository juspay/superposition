...
instance Io.Superposition.Utility.SerializeBody CreateTypeTemplatesOutput
...
type CreateTypeTemplatesOutputBuilder = Control.Monad.State.Strict.State CreateTypeTemplatesOutputBuilderState
...
setTypeSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> CreateTypeTemplatesOutputBuilder ()
setTypeSchema value =
...
instance Io.Superposition.Utility.FromResponseParser CreateTypeTemplatesOutput where
    ...
    responseParser = do
        ...
        pure $ CreateTypeTemplatesOutput {
            type_name = var0,
            type_schema = var2,
            description = var3,
            change_reason = var1,
