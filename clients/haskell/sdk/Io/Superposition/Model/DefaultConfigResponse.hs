module Io.Superposition.Model.DefaultConfigResponse (
    setKey,
    setValue,
    setSchema,
    setDescription,
...
data DefaultConfigResponse = DefaultConfigResponse {
    key :: Data.Text.Text,
...
instance Data.Aeson.ToJSON DefaultConfigResponse where
...
instance Io.Superposition.Utility.SerializeBody DefaultConfigResponse

instance Data.Aeson.FromJSON DefaultConfigResponse where
    parseJSON = Data.Aeson.withObject "DefaultConfigResponse" $ \v -> DefaultConfigResponse
...
data DefaultConfigResponseBuilderState = DefaultConfigResponseBuilderState {
...
defaultBuilderState :: DefaultConfigResponseBuilderState
defaultBuilderState = DefaultConfigResponseBuilderState {
...
setKey :: Data.Text.Text -> DefaultConfigResponseBuilder ()
setKey value =
   Control.Monad.State.Strict.modify (\s -> (s { keyBuilderState = Data.Maybe.Just value }))

setValue :: Data.Aeson.Value -> DefaultConfigResponseBuilder ()
setValue value =
   Control.Monad.State.Strict.modify (\s -> (s { valueBuilderState = Data.Maybe.Just value }))

setSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> DefaultConfigResponseBuilder ()
setSchema value =
   Control.Monad.State.Strict.modify (\s -> (s { schemaBuilderState = Data.Maybe.Just value }))

setDescription :: Data.Text.Text -> DefaultConfigResponseBuilder ()
setDescription value =
   Control.Monad.State.Strict.modify (\s -> (s { descriptionBuilderState = Data.Maybe.Just value }))

setChangeReason :: Data.Text.Text -> DefaultConfigResponseBuilder ()
setChangeReason value =
   Control.Monad.State.Strict.modify (\s -> (s { change_reasonBuilderState = Data.Maybe.Just value }))

setValueValidationFunctionName :: Data.Maybe.Maybe Data.Text.Text -> DefaultConfigResponseBuilder ()
...
setCreatedBy :: Data.Text.Text -> DefaultConfigResponseBuilder ()
setCreatedBy value =
   Control.Monad.State.Strict.modify (\s -> (s { created_byBuilderState = Data.Maybe.Just value }))

setLastModifiedAt :: Data.Time.UTCTime -> DefaultConfigResponseBuilder ()
setLastModifiedAt value =
   Control.Monad.State.Strict.modify (\s -> (s { last_modified_atBuilderState = Data.Maybe.Just value }))

setLastModifiedBy :: Data.Text.Text -> DefaultConfigResponseBuilder ()
...
build builder = do
    ...
    key' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.DefaultConfigResponse.DefaultConfigResponse.key is a required property.") Data.Either.Right (keyBuilderState st)
    value' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.DefaultConfigResponse.DefaultConfigResponse.value is a required property.") Data.Either.Right (valueBuilderState st)
    schema' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.DefaultConfigResponse.DefaultConfigResponse.schema is a required property.") Data.Either.Right (schemaBuilderState st)
