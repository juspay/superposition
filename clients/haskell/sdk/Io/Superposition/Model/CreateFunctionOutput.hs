...
setPublishedRuntimeVersion :: Data.Maybe.Maybe Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> CreateFunctionOutputBuilder ()
setPublishedRuntimeVersion value =
   Control.Monad.State.Strict.modify (\s -> (s { published_runtime_versionBuilderState = value }))

setDraftRuntimeVersion :: Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> CreateFunctionOutputBuilder ()
