...
setEnableContextValidation :: Bool -> CreateWorkspaceInputBuilder ()
...
setEnableChangeReasonValidation :: Bool -> CreateWorkspaceInputBuilder ()
...
build builder = do
    ...
    enable_context_validation' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.CreateWorkspaceInput.CreateWorkspaceInput.enable_context_validation is a required property.") Data.Either.Right (enable_context_validationBuilderState st)
    enable_change_reason_validation' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.CreateWorkspaceInput.CreateWorkspaceInput.enable_change_reason_validation is a required property.") Data.Either.Right (enable_change_reason_validationBuilderState st)
...
instance Io.Superposition.Utility.IntoRequestBuilder CreateWorkspaceInput where
    intoRequestBuilder self = do
        ...
        Io.Superposition.Utility.serField "enable_change_reason_validation" (enable_change_reason_validation self)
