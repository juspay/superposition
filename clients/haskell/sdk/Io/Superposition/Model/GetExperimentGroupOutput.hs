...
instance Io.Superposition.Utility.SerializeBody GetExperimentGroupOutput
...
setTrafficPercentage :: Data.Int.Int32 -> GetExperimentGroupOutputBuilder ()
...
setBuckets value =
   GetExperimentGroupOutputBuilder (\s -> (s { bucketsBuilderState = Data.Maybe.Just value }, ()))

setGroupType :: Io.Superposition.Model.GroupType.GroupType -> GetExperimentGroupOutputBuilder ()
setGroupType value =
   GetExperimentGroupOutputBuilder (\s -> (s { group_typeBuilderState = Data.Maybe.Just value }, ()))
...
build builder = do
    ...
    buckets' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.GetExperimentGroupOutput.GetExperimentGroupOutput.buckets is a required property.") Data.Either.Right (bucketsBuilderState st)
    group_type' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.GetExperimentGroupOutput.GetExperimentGroupOutput.group_type is a required property.") Data.Either.Right (group_typeBuilderState st)
...
instance Io.Superposition.Utility.FromResponseParser GetExperimentGroupOutput where
