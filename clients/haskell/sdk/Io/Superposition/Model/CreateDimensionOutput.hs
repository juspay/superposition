...
setValueValidationFunctionName :: Data.Maybe.Maybe Data.Text.Text -> CreateDimensionOutputBuilder ()
...
setValueComputeFunctionName :: Data.Maybe.Maybe Data.Text.Text -> CreateDimensionOutputBuilder ()
setValueComputeFunctionName value =
   Control.Monad.State.Strict.modify (\s -> (s { value_compute_function_nameBuilderState = value }))

setMandatory :: Bool -> CreateDimensionOutputBuilder ()
setMandatory value =
...
build builder = do
    ...
    mandatory' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.CreateDimensionOutput.CreateDimensionOutput.mandatory is a required property.") Data.Either.Right (mandatoryBuilderState st)
