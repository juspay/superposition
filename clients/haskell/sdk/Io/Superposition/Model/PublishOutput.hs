...
type PublishOutputBuilder = Control.Monad.State.Strict.State PublishOutputBuilderState
...
setPublishedRuntimeVersion :: Data.Maybe.Maybe Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> PublishOutputBuilder ()
setPublishedRuntimeVersion value =
   Control.Monad.State.Strict.modify (\s -> (s { published_runtime_versionBuilderState = value }))

setDraftRuntimeVersion :: Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> PublishOutputBuilder ()
