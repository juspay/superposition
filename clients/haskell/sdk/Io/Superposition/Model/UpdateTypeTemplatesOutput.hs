...
instance Io.Superposition.Utility.SerializeBody UpdateTypeTemplatesOutput
...
type UpdateTypeTemplatesOutputBuilder = Control.Monad.State.Strict.State UpdateTypeTemplatesOutputBuilderState
...
setTypeSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> UpdateTypeTemplatesOutputBuilder ()
setTypeSchema value =
...
instance Io.Superposition.Utility.FromResponseParser UpdateTypeTemplatesOutput where
    ...
    responseParser = do
        ...
        pure $ UpdateTypeTemplatesOutput {
            type_name = var0,
            type_schema = var2,
            description = var3,
            change_reason = var1,
