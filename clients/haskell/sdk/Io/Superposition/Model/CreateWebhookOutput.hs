...
instance Io.Superposition.Utility.SerializeBody CreateWebhookOutput
...
type CreateWebhookOutputBuilder = Control.Monad.State.Strict.State CreateWebhookOutputBuilderState
...
setMaxRetries :: Data.Int.Int32 -> CreateWebhookOutputBuilder ()
setMaxRetries value =
...
instance Io.Superposition.Utility.FromResponseParser CreateWebhookOutput where
