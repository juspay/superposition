...
type UpdateExperimentGroupOutputBuilder = Control.Monad.State.Strict.State UpdateExperimentGroupOutputBuilderState
...
setBuckets :: [] (Data.Maybe.Maybe Io.Superposition.Model.Bucket.Bucket) -> UpdateExperimentGroupOutputBuilder ()
setBuckets value =
