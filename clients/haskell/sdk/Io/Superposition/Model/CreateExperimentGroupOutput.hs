...
instance Io.Superposition.Utility.SerializeBody CreateExperimentGroupOutput
...
type CreateExperimentGroupOutputBuilder = Control.Monad.State.Strict.State CreateExperimentGroupOutputBuilderState
...
setTrafficPercentage :: Data.Int.Int32 -> CreateExperimentGroupOutputBuilder ()
...
setBuckets :: [] (Data.Maybe.Maybe Io.Superposition.Model.Bucket.Bucket) -> CreateExperimentGroupOutputBuilder ()
setBuckets value =
...
instance Io.Superposition.Utility.FromResponseParser CreateExperimentGroupOutput where
    ...
    responseParser = do
        ...
        pure $ CreateExperimentGroupOutput {
            id' = var13,
            context_hash = var8,
            name = var10,
            description = var1,
