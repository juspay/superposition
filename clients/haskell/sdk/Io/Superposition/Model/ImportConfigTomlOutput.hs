...
setMode :: Data.Text.Text -> ImportConfigTomlOutputBuilder ()
setMode value =
...
build builder = do
    ...
    mode' <- Data.Maybe.maybe (Data.Either.Left "Io.Superposition.Model.ImportConfigTomlOutput.ImportConfigTomlOutput.mode is a required property.") Data.Either.Right (modeBuilderState st)
