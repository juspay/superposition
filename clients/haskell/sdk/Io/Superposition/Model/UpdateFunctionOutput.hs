...
instance Io.Superposition.Utility.SerializeBody UpdateFunctionOutput
...
type UpdateFunctionOutputBuilder = Control.Monad.State.Strict.State UpdateFunctionOutputBuilderState
