...
instance Io.Superposition.Utility.SerializeBody DeleteExperimentGroupOutput
...
type DeleteExperimentGroupOutputBuilder = Control.Monad.State.Strict.State DeleteExperimentGroupOutputBuilderState
...
setTrafficPercentage :: Data.Int.Int32 -> DeleteExperimentGroupOutputBuilder ()
...
setBuckets :: [] (Data.Maybe.Maybe Io.Superposition.Model.Bucket.Bucket) -> DeleteExperimentGroupOutputBuilder ()
setBuckets value =
...
instance Io.Superposition.Utility.FromResponseParser DeleteExperimentGroupOutput where
    ...
    responseParser = do
        ...
        pure $ DeleteExperimentGroupOutput {
            id' = var13,
            context_hash = var8,
            name = var10,
            description = var1,
