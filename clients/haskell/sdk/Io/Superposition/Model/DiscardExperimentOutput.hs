...
instance Io.Superposition.Utility.SerializeBody DiscardExperimentOutput
...
type DiscardExperimentOutputBuilder = Control.Monad.State.Strict.State DiscardExperimentOutputBuilderState
...
setTrafficPercentage :: Data.Int.Int32 -> DiscardExperimentOutputBuilder ()
...
instance Io.Superposition.Utility.FromResponseParser DiscardExperimentOutput where
