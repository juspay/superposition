...
type AddMembersToGroupOutputBuilder = Control.Monad.State.Strict.State AddMembersToGroupOutputBuilderState
...
setBuckets :: [] (Data.Maybe.Maybe Io.Superposition.Model.Bucket.Bucket) -> AddMembersToGroupOutputBuilder ()
setBuckets value =
