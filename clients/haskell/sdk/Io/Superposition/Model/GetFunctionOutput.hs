...
instance Io.Superposition.Utility.SerializeBody GetFunctionOutput
...
type GetFunctionOutputBuilder = Control.Monad.State.Strict.State GetFunctionOutputBuilderState
...
setPublishedRuntimeVersion :: Data.Maybe.Maybe Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> GetFunctionOutputBuilder ()
setPublishedRuntimeVersion value =
   Control.Monad.State.Strict.modify (\s -> (s { published_runtime_versionBuilderState = value }))

setDraftRuntimeVersion :: Io.Superposition.Model.FunctionRuntimeVersion.FunctionRuntimeVersion -> GetFunctionOutputBuilder ()
...
instance Io.Superposition.Utility.FromResponseParser GetFunctionOutput where
