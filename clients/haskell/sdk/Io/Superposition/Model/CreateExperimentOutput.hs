...
instance Io.Superposition.Utility.SerializeBody CreateExperimentOutput
...
type CreateExperimentOutputBuilder = Control.Monad.State.Strict.State CreateExperimentOutputBuilderState
...
setTrafficPercentage :: Data.Int.Int32 -> CreateExperimentOutputBuilder ()
...
instance Io.Superposition.Utility.FromResponseParser CreateExperimentOutput where
