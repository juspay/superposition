...
instance Io.Superposition.Utility.SerializeBody UpdateDefaultConfigOutput
...
type UpdateDefaultConfigOutputBuilder = Control.Monad.State.Strict.State UpdateDefaultConfigOutputBuilderState
...
setValueValidationFunctionName :: Data.Maybe.Maybe Data.Text.Text -> UpdateDefaultConfigOutputBuilder ()
...
setValueComputeFunctionName :: Data.Maybe.Maybe Data.Text.Text -> UpdateDefaultConfigOutputBuilder ()
...
instance Io.Superposition.Utility.FromResponseParser UpdateDefaultConfigOutput where
    ...
    responseParser = do
        ...
        pure $ UpdateDefaultConfigOutput {
            key = var8,
            value = var6,
            schema = var0,
            description = var3,
