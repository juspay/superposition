...
data ListWebhookOutput = ListWebhookOutput {
    ...
    data' :: Data.Maybe.Maybe ([] Io.Superposition.Model.WebhookResponse.WebhookResponse)
} deriving (
  GHC.Show.Show,
  Data.Eq.Eq,
...
setTotalPages :: Data.Maybe.Maybe Data.Int.Int32 -> ListWebhookOutputBuilder ()
setTotalPages value =
   Control.Monad.State.Strict.modify (\s -> (s { total_pagesBuilderState = value }))

setTotalItems :: Data.Maybe.Maybe Data.Int.Int32 -> ListWebhookOutputBuilder ()
setTotalItems value =
   Control.Monad.State.Strict.modify (\s -> (s { total_itemsBuilderState = value }))

setData' :: Data.Maybe.Maybe ([] Io.Superposition.Model.WebhookResponse.WebhookResponse) -> ListWebhookOutputBuilder ()
setData' value =
