...
instance Io.Superposition.Utility.SerializeBody GetExperimentGroupInput
...
type GetExperimentGroupInputBuilder = Control.Monad.State.Strict.State GetExperimentGroupInputBuilderState
...
instance Io.Superposition.Utility.IntoRequestBuilder GetExperimentGroupInput where
