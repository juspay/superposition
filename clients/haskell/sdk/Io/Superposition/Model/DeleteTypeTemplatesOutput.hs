...
instance Io.Superposition.Utility.SerializeBody DeleteTypeTemplatesOutput
...
type DeleteTypeTemplatesOutputBuilder = Control.Monad.State.Strict.State DeleteTypeTemplatesOutputBuilderState
...
setTypeSchema :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> DeleteTypeTemplatesOutputBuilder ()
setTypeSchema value =
...
instance Io.Superposition.Utility.FromResponseParser DeleteTypeTemplatesOutput where
    ...
    responseParser = do
        ...
        pure $ DeleteTypeTemplatesOutput {
            type_name = var0,
            type_schema = var2,
            description = var3,
            change_reason = var1,
