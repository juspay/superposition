...
- **C FFI Function**: `core_parse_config_file_with_filters` from `ffi_legacy.rs`
...
const result = evalTomlConfig(tomlContent, { region: "us", vehicle_type: "cab" }, "merge");
...
const config = evalTomlConfig(tomlString, { city: "Bangalore", vehicle_type: "cab" }, "merge");
...
char* core_parse_config_file_with_filters(
    const char* file_content,
    const char* format,
    const char* dimension_data,
    const char* prefix,
