...
const native_resolver_1 = require("./native-resolver");
async function testFFIDirectly() {
    console.log("Testing FFI directly with known data...");
    const resolver = new native_resolver_1.NativeResolver();
    ...
    try {
        ...
        const result = resolver.resolveConfig(defaultConfigs, contexts, overrides, queryData, 'merge');
