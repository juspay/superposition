...
export class NativeResolver {
    ...
    /**
     * Parse configuration into structured format matching the Config type
     *
     * @param content - Configuration string
     * @param format - Format of the configuration (e.g., "toml")
     * @param dimensions - Dimensions data for parsing
     * @param filterPrefixes - Optional array of prefixes to filter contexts
     * @param filterExcludePrefixes - Optional array of prefixes to exclude contexts
