...
import { ContextAction, ContextIdentifier, FunctionExecutionRequest, FunctionNotFound, InternalServerError, OrganisationNotFound, ResourceNotFound, TypeTemplatesNotFound, WebhookNotFound, WorkspaceNotFound, } from "../models/models_0";
...
export const se_AddMembersToGroupCommand = async (input, context) => {
...
export const se_CreateExperimentGroupCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        'content-type': 'application/json',
        [_xt]: input[_wi],
...
export const se_DeleteExperimentGroupCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        [_xt]: input[_wi],
        [_xoi]: input[_oi],
...
export const se_GetDimensionCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        [_xt]: input[_wi],
        [_xoi]: input[_oi],
...
export const se_GetExperimentGroupCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        [_xt]: input[_wi],
        [_xoi]: input[_oi],
...
export const se_ListExperimentGroupsCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        [_xt]: input[_wi],
        [_xoi]: input[_oi],
...
export const se_ListWebhookCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        [_xt]: input[_wi],
        [_xoi]: input[_oi],
...
export const se_PauseExperimentCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        'content-type': 'application/json',
        [_xt]: input[_wi],
...
export const se_RemoveMembersFromGroupCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        'content-type': 'application/json',
        [_xt]: input[_wi],
...
export const se_ResumeExperimentCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        'content-type': 'application/json',
        [_xt]: input[_wi],
...
export const se_UpdateExperimentGroupCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = map({}, isSerializableHeaderValue, {
        'content-type': 'application/json',
        [_xt]: input[_wi],
...
export const de_AddMembersToGroupCommand = async (output, context) => {
...
export const de_CreateExperimentGroupCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_DeleteExperimentGroupCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_GetDimensionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_GetExperimentGroupCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_ListExperimentGroupsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_ListWebhookCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_PauseExperimentCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_RemoveMembersFromGroupCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_ResumeExperimentCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_UpdateExperimentGroupCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
