 ...
 * ```javascript
 * import { SuperpositionClient, WeightRecomputeCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, WeightRecomputeCommand } = require("@juspay/superposition-sdk"); // CommonJS import
