 ...
 * ```javascript
 * import { SuperpositionClient, CreateWorkspaceCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, CreateWorkspaceCommand } = require("@juspay/superposition-sdk"); // CommonJS import
