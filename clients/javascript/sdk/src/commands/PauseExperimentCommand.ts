 ...
 * ```javascript
 * import { SuperpositionClient, PauseExperimentCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, PauseExperimentCommand } = require("@juspay/superposition-sdk"); // CommonJS import
