 ...
 * ```javascript
 * import { SuperpositionClient, ListWorkspaceCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, ListWorkspaceCommand } = require("@juspay/superposition-sdk"); // CommonJS import
