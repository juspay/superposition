 ...
 * ```javascript
 * import { SuperpositionClient, UpdateFunctionCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, UpdateFunctionCommand } = require("@juspay/superposition-sdk"); // CommonJS import
