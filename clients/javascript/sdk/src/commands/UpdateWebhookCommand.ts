 ...
 * ```javascript
 * import { SuperpositionClient, UpdateWebhookCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, UpdateWebhookCommand } = require("@juspay/superposition-sdk"); // CommonJS import
