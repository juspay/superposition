 ...
 * ```javascript
 * import { SuperpositionClient, GetContextCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, GetContextCommand } = require("@juspay/superposition-sdk"); // CommonJS import
