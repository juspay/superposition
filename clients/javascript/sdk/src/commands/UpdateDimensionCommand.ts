 ...
 * ```javascript
 * import { SuperpositionClient, UpdateDimensionCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, UpdateDimensionCommand } = require("@juspay/superposition-sdk"); // CommonJS import
