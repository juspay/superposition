 ...
 * ```javascript
 * import { SuperpositionClient, CreateFunctionCommand } from "@juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, CreateFunctionCommand } = require("@juspay/superposition-sdk"); // CommonJS import
