 ...
 * @public
 */
export type ServiceInputTypes = AddMembersToGroupCommandInput | ApplicableVariantsCommandInput | BulkOperationCommandInput | ConcludeExperimentCommandInput | CreateContextCommandInput | CreateDefaultConfigCommandInput | CreateDimensionCommandInput | CreateExperimentCommandInput | CreateExperimentGroupCommandInput | CreateFunctionCommandInput | CreateOrganisationCommandInput | CreateTypeTemplatesCommandInput | CreateWebhookCommandInput | CreateWorkspaceCommandInput | DeleteContextCommandInput | DeleteDefaultConfigCommandInput | DeleteDimensionCommandInput | DeleteExperimentGroupCommandInput | DeleteFunctionCommandInput | DeleteTypeTemplatesCommandInput | DiscardExperimentCommandInput | GetConfigCommandInput | GetConfigFastCommandInput | GetContextCommandInput | GetContextFromConditionCommandInput | GetDimensionCommandInput | GetExperimentCommandInput | GetExperimentGroupCommandInput | GetFunctionCommandInput | GetOrganisationCommandInput | GetResolvedConfigCommandInput | GetTypeTemplatesListCommandInput | GetWebhookCommandInput | ListAuditLogsCommandInput | ListContextsCommandInput | ListDefaultConfigsCommandInput | ListDimensionsCommandInput | ListExperimentCommandInput | ListExperimentGroupsCommandInput | ListFunctionCommandInput | ListOrganisationCommandInput | ListVersionsCommandInput | ListWebhookCommandInput | ListWorkspaceCommandInput | MoveContextCommandInput | PauseExperimentCommandInput | PublishCommandInput | RampExperimentCommandInput | RemoveMembersFromGroupCommandInput | ResumeExperimentCommandInput | TestCommandInput | UpdateDefaultConfigCommandInput | UpdateDimensionCommandInput | UpdateExperimentGroupCommandInput | UpdateFunctionCommandInput | UpdateOrganisationCommandInput | UpdateOverrideCommandInput | UpdateOverridesExperimentCommandInput | UpdateTypeTemplatesCommandInput | UpdateWebhookCommandInput | UpdateWorkspaceCommandInput | WeightRecomputeCommandInput;
/**
 * @public
 */
export type ServiceOutputTypes = AddMembersToGroupCommandOutput | ApplicableVariantsCommandOutput | BulkOperationCommandOutput | ConcludeExperimentCommandOutput | CreateContextCommandOutput | CreateDefaultConfigCommandOutput | CreateDimensionCommandOutput | CreateExperimentCommandOutput | CreateExperimentGroupCommandOutput | CreateFunctionCommandOutput | CreateOrganisationCommandOutput | CreateTypeTemplatesCommandOutput | CreateWebhookCommandOutput | CreateWorkspaceCommandOutput | DeleteContextCommandOutput | DeleteDefaultConfigCommandOutput | DeleteDimensionCommandOutput | DeleteExperimentGroupCommandOutput | DeleteFunctionCommandOutput | DeleteTypeTemplatesCommandOutput | DiscardExperimentCommandOutput | GetConfigCommandOutput | GetConfigFastCommandOutput | GetContextCommandOutput | GetContextFromConditionCommandOutput | GetDimensionCommandOutput | GetExperimentCommandOutput | GetExperimentGroupCommandOutput | GetFunctionCommandOutput | GetOrganisationCommandOutput | GetResolvedConfigCommandOutput | GetTypeTemplatesListCommandOutput | GetWebhookCommandOutput | ListAuditLogsCommandOutput | ListContextsCommandOutput | ListDefaultConfigsCommandOutput | ListDimensionsCommandOutput | ListExperimentCommandOutput | ListExperimentGroupsCommandOutput | ListFunctionCommandOutput | ListOrganisationCommandOutput | ListVersionsCommandOutput | ListWebhookCommandOutput | ListWorkspaceCommandOutput | MoveContextCommandOutput | PauseExperimentCommandOutput | PublishCommandOutput | RampExperimentCommandOutput | RemoveMembersFromGroupCommandOutput | ResumeExperimentCommandOutput | TestCommandOutput | UpdateDefaultConfigCommandOutput | UpdateDimensionCommandOutput | UpdateExperimentGroupCommandOutput | UpdateFunctionCommandOutput | UpdateOrganisationCommandOutput | UpdateOverrideCommandOutput | UpdateOverridesExperimentCommandOutput | UpdateTypeTemplatesCommandOutput | UpdateWebhookCommandOutput | UpdateWorkspaceCommandOutput | WeightRecomputeCommandOutput;
/**
 * @public
 */
 ...
 * @public
 */
export type SuperpositionClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & UserAgentInputConfig & CustomEndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & HttpAuthSchemeInputConfig;
/**
 * @public
 *
 ...
 * @public
 */
export type SuperpositionClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RuntimeExtensionsConfig & UserAgentResolvedConfig & CustomEndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & HttpAuthSchemeResolvedConfig;
/**
 * @public
 *
 ...
 * @public
 */
export declare class SuperpositionClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, SuperpositionClientResolvedConfig> {
    /**
