...
import { ExperimentResponse, PauseExperimentInput } from "../models/models_0";
...
declare const PauseExperimentCommand_base: {
    new (input: PauseExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<PauseExperimentCommandInput, PauseExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PauseExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<PauseExperimentCommandInput, PauseExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { SuperpositionClient, PauseExperimentCommand } from "io.juspay/superposition-typescript-sdk"; // ES Modules import
 * // const { SuperpositionClient, PauseExperimentCommand } = require("io.juspay/superposition-typescript-sdk"); // CommonJS import
 ...
 *
 */
export declare class PauseExperimentCommand extends PauseExperimentCommand_base {
