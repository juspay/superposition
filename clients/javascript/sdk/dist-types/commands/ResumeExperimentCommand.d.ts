...
import { ExperimentResponse, ResumeExperimentInput } from "../models/models_0";
...
declare const ResumeExperimentCommand_base: {
    new (input: ResumeExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<ResumeExperimentCommandInput, ResumeExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ResumeExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<ResumeExperimentCommandInput, ResumeExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { SuperpositionClient, ResumeExperimentCommand } from "io.juspay/superposition-typescript-sdk"; // ES Modules import
 * // const { SuperpositionClient, ResumeExperimentCommand } = require("io.juspay/superposition-typescript-sdk"); // CommonJS import
 ...
 *
 */
export declare class ResumeExperimentCommand extends ResumeExperimentCommand_base {
