...
import { DimensionExt, GetDimensionInput } from "../models/models_0";
...
declare const GetDimensionCommand_base: {
    new (input: GetDimensionCommandInput): import("@smithy/smithy-client").CommandImpl<GetDimensionCommandInput, GetDimensionCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDimensionCommandInput): import("@smithy/smithy-client").CommandImpl<GetDimensionCommandInput, GetDimensionCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class GetDimensionCommand extends GetDimensionCommand_base {
