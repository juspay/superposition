...
import { ListExperimentGroupsInput, ListExperimentGroupsResponse } from "../models/models_0";
...
declare const ListExperimentGroupsCommand_base: {
    new (input: ListExperimentGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListExperimentGroupsCommandInput, ListExperimentGroupsCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListExperimentGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListExperimentGroupsCommandInput, ListExperimentGroupsCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { SuperpositionClient, ListExperimentGroupsCommand } from "io.juspay/superposition-typescript-sdk"; // ES Modules import
 * // const { SuperpositionClient, ListExperimentGroupsCommand } = require("io.juspay/superposition-typescript-sdk"); // CommonJS import
 ...
 * @public
 */
export declare class ListExperimentGroupsCommand extends ListExperimentGroupsCommand_base {
