 ...
 * @public
 */
export type ContextIdentifier = ContextIdentifier.ContextMember | ContextIdentifier.IdMember | ContextIdentifier.$UnknownMember;
/**
 * @public
 */
export declare namespace ContextIdentifier {
    interface IdMember {
        id: string;
        context?: never;
        $unknown?: never;
    ...
    const visit: <T>(value: ContextIdentifier, visitor: Visitor<T>) => T;
}
/**
 * @public
 */
...
export declare const ExperimentType: {
    ...
    readonly DELETE_OVERRIDES: "DELETE_OVERRIDES";
};
/**
 * @public
 */
 ...
 * @enum
 */
export declare const ExperimentGroupSortOn: {
    /**
 ...
 * @public
 */
export declare class WebhookNotFound extends __BaseException {
    readonly name: "WebhookNotFound";
    readonly $fault: "client";
    /**
     * @internal
     */
