...
def check_boolean_val(client, ctx):
    ...
    bool_result = client.get_boolean_value("bool", True, ctx)  # Using "bool" key like Java test
...
def check_string_val(client, ctx):
    ...
    string_result = client.get_string_value("string", "", ctx)  # Using "string" key like Java test
...
def check_integer_val(client, ctx):
    ...
    int_result = client.get_integer_value("integer", 2, ctx)  # Using "integer" key like Java test
...
def check_float_val(client, ctx):
    ...
    float_result = client.get_float_value("double", 2.0, ctx)  # Using "double" key like Java test
...
def check_object_val(client, ctx):
    ...
    obj_result = client.get_object_value("object", {}, ctx)  # Using "object" key like Java test
...
def check_list_val(client, ctx):
    ...
    list_result = client.get_object_value("list", [], ctx)  # Using "list" key like Java test
...
async def test_config():
    ...
    try:
        ...
        # val = client.get_boolean_value("bool", True, ctx)
