...
class Superposition:
    ...
    async def create_function(self, input: CreateFunctionInput, plugins: list[Plugin] | None = None) -> CreateFunctionOutput:
        """
        Creates a new custom function for value_validation, value_compute or
        context_validation with specified code, runtime version, and function type.
    ...
    async def publish(self, input: PublishInput, plugins: list[Plugin] | None = None) -> PublishOutput:
        ...
        value_validation, value_compute or context_validation in the system.
