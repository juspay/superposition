...
import { UpdateWorkspaceRequest, WorkspaceResponse } from "../models/models_0";
...
declare const UpdateWorkspaceCommand_base: {
    new (input: UpdateWorkspaceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceCommandInput, UpdateWorkspaceCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateWorkspaceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceCommandInput, UpdateWorkspaceCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { SuperpositionClient, UpdateWorkspaceCommand } from "@io.juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, UpdateWorkspaceCommand } = require("@io.juspay/superposition-sdk"); // CommonJS import
