...
import { ExperimentResponse, UpdateOverrideRequest } from "../models/models_0";
...
declare const UpdateOverridesExperimentCommand_base: {
    new (input: UpdateOverridesExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateOverridesExperimentCommandInput, UpdateOverridesExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateOverridesExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateOverridesExperimentCommandInput, UpdateOverridesExperimentCommandOutput, SuperpositionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { SuperpositionClient, UpdateOverridesExperimentCommand } from "@io.juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, UpdateOverridesExperimentCommand } = require("@io.juspay/superposition-sdk"); // CommonJS import
 ...
 *
 */
export declare class UpdateOverridesExperimentCommand extends UpdateOverridesExperimentCommand_base {
