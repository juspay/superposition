 ...
 * ```javascript
 * import { SuperpositionClient, PublishCommand } from "@io.juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, PublishCommand } = require("@io.juspay/superposition-sdk"); // CommonJS import
