 ...
 * ```javascript
 * import { SuperpositionClient, WeightRecomputeCommand } from "@io.juspay/superposition-sdk"; // ES Modules import
 * // const { SuperpositionClient, WeightRecomputeCommand } = require("@io.juspay/superposition-sdk"); // CommonJS import
 ...
 * //     "<keys>": "DOCUMENT_VALUE",
 * //   },
 * //   old_weight: Number("int"),
 * //   new_weight: Number("int"),
 * // };
 *
 * ```
 *
