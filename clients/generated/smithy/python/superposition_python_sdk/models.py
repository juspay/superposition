...
class CreateExperimentGroupOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_CREATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"], self.experiment_group_id)
        serializer.write_string(_SCHEMA_CREATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"], self.experiment_group_hash)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_CREATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"])

                case 1:
                    kwargs["experiment_group_hash"] = de.read_string(_SCHEMA_CREATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"])
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_DELETE_EXPERIMENT_GROUP_INPUT.members["experiment_group_id"])
...
class DeleteExperimentGroupOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_DELETE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"], self.experiment_group_id)
        serializer.write_string(_SCHEMA_DELETE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"], self.experiment_group_hash)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_DELETE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"])

                case 1:
                    kwargs["experiment_group_hash"] = de.read_string(_SCHEMA_DELETE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"])
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_GET_EXPERIMENT_GROUP_INPUT.members["experiment_group_id"])
...
class GetExperimentGroupOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_GET_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"], self.experiment_group_id)
        serializer.write_string(_SCHEMA_GET_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"], self.experiment_group_hash)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_GET_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"])

                case 1:
                    kwargs["experiment_group_hash"] = de.read_string(_SCHEMA_GET_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"])
...
class ExperimentGroupResponse:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_EXPERIMENT_GROUP_RESPONSE.members["experiment_group_id"], self.experiment_group_id)
        serializer.write_string(_SCHEMA_EXPERIMENT_GROUP_RESPONSE.members["experiment_group_hash"], self.experiment_group_hash)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_EXPERIMENT_GROUP_RESPONSE.members["experiment_group_id"])

                case 1:
                    kwargs["experiment_group_hash"] = de.read_string(_SCHEMA_EXPERIMENT_GROUP_RESPONSE.members["experiment_group_hash"])
...
class UpdateExperimentGroupInput:
    ...
    :param member_experiment_ids:
         Optional new list of member experiment IDs. Replaces the existing list if
         provided.
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.member_experiment_ids is not None:
            _serialize_string_list(serializer, _SCHEMA_UPDATE_EXPERIMENT_GROUP_INPUT.members["member_experiment_ids"], self.member_experiment_ids)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_UPDATE_EXPERIMENT_GROUP_INPUT.members["experiment_group_id"])
                ...
                case 5:
                    kwargs["member_experiment_ids"] = _deserialize_string_list(de, _SCHEMA_UPDATE_EXPERIMENT_GROUP_INPUT.members["member_experiment_ids"])
...
class UpdateExperimentGroupOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_UPDATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"], self.experiment_group_id)
        serializer.write_string(_SCHEMA_UPDATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"], self.experiment_group_hash)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_group_id"] = de.read_string(_SCHEMA_UPDATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_id"])

                case 1:
                    kwargs["experiment_group_hash"] = de.read_string(_SCHEMA_UPDATE_EXPERIMENT_GROUP_OUTPUT.members["experiment_group_hash"])
