...
@SmithyGenerated
public final class GetOrganisationOutput implements SerializableStruct {
    ...
    private GetOrganisationOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        GetOrganisationOutput that = (GetOrganisationOutput) other;
     ...
     *
     * @return a builder for {@link GetOrganisationOutput}.
     */
    ...
    /**
     * Builder for {@link GetOrganisationOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetOrganisationOutput> {
        ...
        @Override
        public GetOrganisationOutput build() {
            tracker.validate();
            return new GetOrganisationOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetOrganisationOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
