 ...
 */
@SmithyGenerated
public final class RemoveMembersFromGroupOutput implements SerializableStruct {
    ...
    private final transient List<String> buckets;
    private final transient GroupType groupType;

    private RemoveMembersFromGroupOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        RemoveMembersFromGroupOutput that = (RemoveMembersFromGroupOutput) other;
     ...
     *
     * @return a builder for {@link RemoveMembersFromGroupOutput}.
     */
    ...
    /**
     * Builder for {@link RemoveMembersFromGroupOutput}.
     */
    public static final class Builder implements ShapeBuilder<RemoveMembersFromGroupOutput> {
        ...
        @Override
        public RemoveMembersFromGroupOutput build() {
            tracker.validate();
            return new RemoveMembersFromGroupOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 12 -> buckets((List<String>) SchemaUtils.validateSameMember($SCHEMA_BUCKETS, member, value));
        ...
        @Override
        public ShapeBuilder<RemoveMembersFromGroupOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
