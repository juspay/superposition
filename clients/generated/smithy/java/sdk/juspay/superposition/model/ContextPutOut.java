...
@SmithyGenerated
public final class ContextPutOut implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ContextPutOut");
    ...
    private ContextPutOut(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ContextPutOut that = (ContextPutOut) other;
     ...
     *
     * @return a builder for {@link ContextPutOut}.
     */
    ...
    /**
     * Builder for {@link ContextPutOut}.
     */
    public static final class Builder implements ShapeBuilder<ContextPutOut> {
        ...
        @Override
        public ContextPutOut build() {
            return new ContextPutOut(this);
        }
