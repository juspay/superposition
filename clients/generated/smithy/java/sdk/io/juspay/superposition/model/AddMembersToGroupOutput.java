 ...
 */
@SmithyGenerated
public final class AddMembersToGroupOutput implements SerializableStruct {
    ...
    private AddMembersToGroupOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        AddMembersToGroupOutput that = (AddMembersToGroupOutput) other;
     ...
     *
     * @return a builder for {@link AddMembersToGroupOutput}.
     */
    ...
    /**
     * Builder for {@link AddMembersToGroupOutput}.
     */
    public static final class Builder implements ShapeBuilder<AddMembersToGroupOutput> {
        ...
        @Override
        public AddMembersToGroupOutput build() {
            tracker.validate();
            return new AddMembersToGroupOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<AddMembersToGroupOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
