...
@SmithyGenerated
public final class ListVersionsInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListVersionsInput");
     ...
     *
     * @return a builder for {@link ListVersionsInput}.
     */
    ...
    public static final class Builder implements ShapeBuilder<ListVersionsInput> {
        ...
        @Override
        public ListVersionsInput build() {
            tracker.validate();
            return new ListVersionsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListVersionsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
