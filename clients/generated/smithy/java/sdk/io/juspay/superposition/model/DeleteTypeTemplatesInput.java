...
@SmithyGenerated
public final class DeleteTypeTemplatesInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#DeleteTypeTemplatesInput");
    ...
    private DeleteTypeTemplatesInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteTypeTemplatesInput that = (DeleteTypeTemplatesInput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, typeName);
    }
     ...
     *
     * @return a builder for {@link DeleteTypeTemplatesInput}.
     */
    ...
    /**
     * Builder for {@link DeleteTypeTemplatesInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteTypeTemplatesInput> {
        ...
        @Override
        public DeleteTypeTemplatesInput build() {
            tracker.validate();
            return new DeleteTypeTemplatesInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteTypeTemplatesInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
