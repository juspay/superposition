...
@SmithyGenerated
public final class ContextFull implements SerializableStruct {
    ...
    private ContextFull(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        ContextFull that = (ContextFull) other;
     ...
     *
     * @return a builder for {@link ContextFull}.
     */
    ...
    /**
     * Builder for {@link ContextFull}.
     */
    public static final class Builder implements ShapeBuilder<ContextFull> {
        ...
        @Override
        public ContextFull build() {
            tracker.validate();
            return new ContextFull(this);
        }
        ...
        @Override
        public ShapeBuilder<ContextFull> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
