...
@SmithyGenerated
public final class ListWorkspaceOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#WorkspaceListResponse");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.LONG,
                new RequiredTrait())
        .putMember("data", SharedSchemas.WORKSPACE_LIST,
                new RequiredTrait())
        .build();
    ...
    private final transient List<WorkspaceResponse> data;

    private ListWorkspaceOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListWorkspaceOutput that = (ListWorkspaceOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.WorkspaceListSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListWorkspaceOutput}.
     */
    ...
    /**
     * Builder for {@link ListWorkspaceOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListWorkspaceOutput> {
        ...
        @Override
        public ListWorkspaceOutput build() {
            tracker.validate();
            return new ListWorkspaceOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<WorkspaceResponse>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListWorkspaceOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeWorkspaceList(member, de));
