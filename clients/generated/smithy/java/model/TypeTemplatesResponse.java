...
@SmithyGenerated
public final class TypeTemplatesResponse implements SerializableStruct {
    ...
    private TypeTemplatesResponse(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        TypeTemplatesResponse that = (TypeTemplatesResponse) other;
     ...
     *
     * @return a builder for {@link TypeTemplatesResponse}.
     */
    ...
    /**
     * Builder for {@link TypeTemplatesResponse}.
     */
    public static final class Builder implements ShapeBuilder<TypeTemplatesResponse> {
        ...
        @Override
        public TypeTemplatesResponse build() {
            tracker.validate();
            return new TypeTemplatesResponse(this);
        }
        ...
        @Override
        public ShapeBuilder<TypeTemplatesResponse> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
