...
@SmithyGenerated
public final class CreateDefaultConfigOutput implements SerializableStruct {
    ...
    public boolean equals(Object other) {
        ...
        CreateDefaultConfigOutput that = (CreateDefaultConfigOutput) other;
     ...
     *
     * @return a builder for {@link CreateDefaultConfigOutput}.
     */
    ...
    /**
     * Builder for {@link CreateDefaultConfigOutput}.
     */
    public static final class Builder implements ShapeBuilder<CreateDefaultConfigOutput> {
        ...
        public CreateDefaultConfigOutput build() {
            tracker.validate();
            return new CreateDefaultConfigOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<CreateDefaultConfigOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
