...
@SmithyGenerated
public final class UpdateOrganisationOutput implements SerializableStruct {
    ...
    private UpdateOrganisationOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        UpdateOrganisationOutput that = (UpdateOrganisationOutput) other;
     ...
     *
     * @return a builder for {@link UpdateOrganisationOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateOrganisationOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateOrganisationOutput> {
        ...
        @Override
        public UpdateOrganisationOutput build() {
            tracker.validate();
            return new UpdateOrganisationOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateOrganisationOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
