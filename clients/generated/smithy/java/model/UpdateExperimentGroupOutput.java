 ...
 */
@SmithyGenerated
public final class UpdateExperimentGroupOutput implements SerializableStruct {
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        .putMember("experiment_group_id", PreludeSchemas.STRING,
                new RequiredTrait())
        .putMember("experiment_group_hash", PreludeSchemas.STRING,
                new RequiredTrait())
    ...
    private static final Schema $SCHEMA_EXPERIMENT_GROUP_HASH = $SCHEMA.member("experiment_group_hash");
    ...
    private final transient String experimentGroupHash;
    ...
    private UpdateExperimentGroupOutput(Builder builder) {
        this.experimentGroupId = builder.experimentGroupId;
        this.experimentGroupHash = builder.experimentGroupHash;
    ...
    public String experimentGroupHash() {
        return experimentGroupHash;
    }
    ...
    public boolean equals(Object other) {
        ...
        UpdateExperimentGroupOutput that = (UpdateExperimentGroupOutput) other;
        return Objects.equals(this.experimentGroupId, that.experimentGroupId)
               && Objects.equals(this.experimentGroupHash, that.experimentGroupHash)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(experimentGroupId, experimentGroupHash, name, description, changeReason, context, trafficPercentage, memberExperimentIds, createdAt, createdBy, lastModifiedAt, lastModifiedBy);
    }
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeString($SCHEMA_EXPERIMENT_GROUP_HASH, experimentGroupHash);
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            case 0 -> (T) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_ID, member, experimentGroupId);
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_HASH, member, experimentGroupHash);
     ...
     *
     * @return a builder for {@link UpdateExperimentGroupOutput}.
     */
    public Builder toBuilder() {
        var builder = new Builder();
        builder.experimentGroupId(this.experimentGroupId);
        builder.experimentGroupHash(this.experimentGroupHash);
    ...
    /**
     * Builder for {@link UpdateExperimentGroupOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateExperimentGroupOutput> {
        private final PresenceTracker tracker = PresenceTracker.of($SCHEMA);
        private String experimentGroupId;
        private String experimentGroupHash;
        private String name;
         ...
         * @return this builder.
         */
        public Builder experimentGroupHash(String experimentGroupHash) {
            this.experimentGroupHash = Objects.requireNonNull(experimentGroupHash, "experimentGroupHash cannot be null");
            tracker.setMember($SCHEMA_EXPERIMENT_GROUP_HASH);
            return this;
        }
        ...
        @Override
        public UpdateExperimentGroupOutput build() {
            tracker.validate();
            return new UpdateExperimentGroupOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> experimentGroupId((String) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_ID, member, value));
                case 1 -> experimentGroupHash((String) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_HASH, member, value));
        ...
        @Override
        public ShapeBuilder<UpdateExperimentGroupOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_EXPERIMENT_GROUP_HASH)) {
                experimentGroupHash("");
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.experimentGroupId(de.readString(member));
                    case 1 -> builder.experimentGroupHash(de.readString(member));
