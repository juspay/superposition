...
@SmithyGenerated
public final class UpdateContextOverrideRequest implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#UpdateContextOverrideRequest");

    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        .putMember("context", ContextIdentifier.$SCHEMA,
                new RequiredTrait())
    ...
    private final transient ContextIdentifier context;
    private final transient Map<String, Document> override;
    private final transient String description;
    private final transient String changeReason;

    private UpdateContextOverrideRequest(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateContextOverrideRequest that = (UpdateContextOverrideRequest) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        if (context != null) {
            serializer.writeStruct($SCHEMA_CONTEXT, context);
        }
     ...
     *
     * @return a builder for {@link UpdateContextOverrideRequest}.
     */
    ...
    /**
     * Builder for {@link UpdateContextOverrideRequest}.
     */
    public static final class Builder implements ShapeBuilder<UpdateContextOverrideRequest> {
         ...
         * @return this builder.
         */
        public Builder context(ContextIdentifier context) {
        ...
        @Override
        public UpdateContextOverrideRequest build() {
            tracker.validate();
            return new UpdateContextOverrideRequest(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> context((ContextIdentifier) SchemaUtils.validateSameMember($SCHEMA_CONTEXT, member, value));
        ...
        @Override
        public ShapeBuilder<UpdateContextOverrideRequest> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.context(ContextIdentifier.builder().deserializeMember(de, member).build());
