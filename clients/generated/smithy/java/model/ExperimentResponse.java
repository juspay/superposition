...
@SmithyGenerated
public final class ExperimentResponse implements SerializableStruct {
    ...
    private ExperimentResponse(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        ExperimentResponse that = (ExperimentResponse) other;
     ...
     *
     * @return a builder for {@link ExperimentResponse}.
     */
    ...
    /**
     * Builder for {@link ExperimentResponse}.
     */
    public static final class Builder implements ShapeBuilder<ExperimentResponse> {
        ...
        @Override
        public ShapeBuilder<ExperimentResponse> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
