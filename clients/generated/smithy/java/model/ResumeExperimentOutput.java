...
@SmithyGenerated
public final class ResumeExperimentOutput implements SerializableStruct {
    ...
    private ResumeExperimentOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        ResumeExperimentOutput that = (ResumeExperimentOutput) other;
     ...
     *
     * @return a builder for {@link ResumeExperimentOutput}.
     */
    ...
    /**
     * Builder for {@link ResumeExperimentOutput}.
     */
    public static final class Builder implements ShapeBuilder<ResumeExperimentOutput> {
        ...
        @Override
        public ResumeExperimentOutput build() {
            tracker.validate();
            return new ResumeExperimentOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<ResumeExperimentOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
