...
@SmithyGenerated
public final class GetExperimentInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetExperimentInput");
    ...
    private GetExperimentInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetExperimentInput that = (GetExperimentInput) other;
     ...
     *
     * @return a builder for {@link GetExperimentInput}.
     */
    ...
    /**
     * Builder for {@link GetExperimentInput}.
     */
    public static final class Builder implements ShapeBuilder<GetExperimentInput> {
        ...
        @Override
        public GetExperimentInput build() {
            tracker.validate();
            return new GetExperimentInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetExperimentInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
