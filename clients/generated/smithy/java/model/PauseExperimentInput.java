...
@SmithyGenerated
public final class PauseExperimentInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#PauseExperimentInput");
     ...
     *
     * @return a builder for {@link PauseExperimentInput}.
     */
    ...
    /**
     * Builder for {@link PauseExperimentInput}.
     */
    public static final class Builder implements ShapeBuilder<PauseExperimentInput> {
        ...
        @Override
        public PauseExperimentInput build() {
            tracker.validate();
            return new PauseExperimentInput(this);
        }
        ...
        @Override
        public ShapeBuilder<PauseExperimentInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
