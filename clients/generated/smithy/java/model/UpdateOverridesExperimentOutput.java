...
@SmithyGenerated
public final class UpdateOverridesExperimentOutput implements SerializableStruct {
    ...
    private UpdateOverridesExperimentOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        UpdateOverridesExperimentOutput that = (UpdateOverridesExperimentOutput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdAt, createdBy, lastModified, name, experimentType, overrideKeys, status, trafficPercentage, context, variants, lastModifiedBy, chosenVariant, description, changeReason, experimentGroupId);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 15 -> (T) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_ID, member, experimentGroupId);
     ...
     *
     * @return a builder for {@link UpdateOverridesExperimentOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateOverridesExperimentOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateOverridesExperimentOutput> {
        ...
        @Override
        public UpdateOverridesExperimentOutput build() {
            tracker.validate();
            return new UpdateOverridesExperimentOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 15 -> experimentGroupId((String) SchemaUtils.validateSameMember($SCHEMA_EXPERIMENT_GROUP_ID, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<UpdateOverridesExperimentOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 15 -> builder.experimentGroupId(de.readString(member));
