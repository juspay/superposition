...
@SmithyGenerated
public final class DeleteExperimentGroupInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#DeleteExperimentGroupInput");
    ...
    private DeleteExperimentGroupInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteExperimentGroupInput that = (DeleteExperimentGroupInput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, experimentGroupId);
    }
     ...
     *
     * @return a builder for {@link DeleteExperimentGroupInput}.
     */
    ...
    /**
     * Builder for {@link DeleteExperimentGroupInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteExperimentGroupInput> {
        ...
        @Override
        public DeleteExperimentGroupInput build() {
            tracker.validate();
            return new DeleteExperimentGroupInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteExperimentGroupInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
