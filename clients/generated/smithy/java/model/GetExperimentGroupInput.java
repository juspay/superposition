...
@SmithyGenerated
public final class GetExperimentGroupInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetExperimentGroupInput");
    ...
    private GetExperimentGroupInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetExperimentGroupInput that = (GetExperimentGroupInput) other;
     ...
     *
     * @return a builder for {@link GetExperimentGroupInput}.
     */
    ...
    /**
     * Builder for {@link GetExperimentGroupInput}.
     */
    public static final class Builder implements ShapeBuilder<GetExperimentGroupInput> {
        ...
        @Override
        public GetExperimentGroupInput build() {
            tracker.validate();
            return new GetExperimentGroupInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetExperimentGroupInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
