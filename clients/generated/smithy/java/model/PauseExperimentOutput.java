...
@SmithyGenerated
public final class PauseExperimentOutput implements SerializableStruct {
    ...
    private PauseExperimentOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        PauseExperimentOutput that = (PauseExperimentOutput) other;
     ...
     *
     * @return a builder for {@link PauseExperimentOutput}.
     */
    ...
    /**
     * Builder for {@link PauseExperimentOutput}.
     */
    public static final class Builder implements ShapeBuilder<PauseExperimentOutput> {
        ...
        @Override
        public PauseExperimentOutput build() {
            tracker.validate();
            return new PauseExperimentOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<PauseExperimentOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
