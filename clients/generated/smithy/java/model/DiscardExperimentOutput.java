...
@SmithyGenerated
public final class DiscardExperimentOutput implements SerializableStruct {
    ...
    private DiscardExperimentOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        DiscardExperimentOutput that = (DiscardExperimentOutput) other;
     ...
     *
     * @return a builder for {@link DiscardExperimentOutput}.
     */
    ...
    /**
     * Builder for {@link DiscardExperimentOutput}.
     */
    public static final class Builder implements ShapeBuilder<DiscardExperimentOutput> {
        ...
        @Override
        public DiscardExperimentOutput build() {
            tracker.validate();
            return new DiscardExperimentOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<DiscardExperimentOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
