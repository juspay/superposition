...
@SmithyGenerated
public final class UpdateTypeTemplatesOutput implements SerializableStruct {
    ...
    private UpdateTypeTemplatesOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateTypeTemplatesOutput that = (UpdateTypeTemplatesOutput) other;
     ...
     *
     * @return a builder for {@link UpdateTypeTemplatesOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateTypeTemplatesOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateTypeTemplatesOutput> {
        ...
        @Override
        public UpdateTypeTemplatesOutput build() {
            tracker.validate();
            return new UpdateTypeTemplatesOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateTypeTemplatesOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
