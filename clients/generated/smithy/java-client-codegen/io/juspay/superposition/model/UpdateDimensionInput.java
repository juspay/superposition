...
public final class UpdateDimensionInput implements SerializableStruct {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, dimension, schemaMember, functionName, description, dependencies, changeReason);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 5 -> (T) SchemaUtils.validateSameMember($SCHEMA_FUNCTION_NAME, member, functionName);
            case 6 -> (T) SchemaUtils.validateSameMember($SCHEMA_DESCRIPTION, member, description);
            case 7 -> (T) SchemaUtils.validateSameMember($SCHEMA_DEPENDENCIES, member, dependencies);
    ...
    public static final class Builder implements ShapeBuilder<UpdateDimensionInput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 5 -> functionName((String) SchemaUtils.validateSameMember($SCHEMA_FUNCTION_NAME, member, value));
                case 6 -> description((String) SchemaUtils.validateSameMember($SCHEMA_DESCRIPTION, member, value));
                case 7 -> dependencies((List<String>) SchemaUtils.validateSameMember($SCHEMA_DEPENDENCIES, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 5 -> builder.functionName(de.readString(member));
                    case 6 -> builder.description(de.readString(member));
                    case 7 -> builder.dependencies(SharedSerde.deserializeDependencies(member, de));
