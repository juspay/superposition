...
@SmithyGenerated
public final class GetTypeTemplatesListInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetTypeTemplatesListInput");
    ...
    public boolean equals(Object other) {
        ...
        GetTypeTemplatesListInput that = (GetTypeTemplatesListInput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(count, page, workspaceId, orgId);
    }
     ...
     *
     * @return a builder for {@link GetTypeTemplatesListInput}.
     */
    ...
    /**
     * Builder for {@link GetTypeTemplatesListInput}.
     */
    public static final class Builder implements ShapeBuilder<GetTypeTemplatesListInput> {
        ...
        public GetTypeTemplatesListInput build() {
            tracker.validate();
            return new GetTypeTemplatesListInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetTypeTemplatesListInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
