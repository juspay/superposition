...
GET_RESOLVED_CONFIG_INPUT = Schema.collection(
    ...
    members={
        ...
        "merge_strategy": {
            ...
            "traits": [
                Trait.new(id=ShapeID("smithy.api#notProperty")),
                Trait.new(id=ShapeID("smithy.api#httpQuery"), value="x-merge-strategy"),
...
CONTEXT_FILTER_SORT_ON = Schema.collection(
    ...
    members={
        "CreatedAt": {
            ...
            "index": 0,
            "traits": [
                Trait.new(id=ShapeID("smithy.api#enumValue"), value="CreatedAt"),
...
LIST_CONTEXTS_INPUT = Schema.collection(
    ...
    members={
        ...
        "size": {
            ...
            "traits": [
                Trait.new(id=ShapeID("smithy.api#notProperty")),
                Trait.new(id=ShapeID("smithy.api#httpQuery"), value="size"),
...
CREATE_EXPERIMENT_OUTPUT = Schema.collection(
    ...
    traits=[
        Trait.new(id=ShapeID("smithy.synthetic#originalShapeId"), value="io.superposition#CreateExperimentResponse"),
        Trait.new(id=ShapeID("smithy.api#output")),
