...
class ContextMove:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        _serialize_condition(serializer, _SCHEMA_CONTEXT_MOVE.members["condition"], self.condition)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["condition"] = _deserialize_condition(de, _SCHEMA_CONTEXT_MOVE.members["condition"])
...
class ContextPut:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_condition(serializer, _SCHEMA_CONTEXT_PUT.members["condition"], self.condition)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["condition"] = _deserialize_condition(de, _SCHEMA_CONTEXT_PUT.members["condition"])
...
def _serialize_list_versions_out(serializer: ShapeSerializer, schema: Schema, value: list[str]) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
            ls.write_string(member_schema, e)

def _deserialize_list_versions_out(deserializer: ShapeDeserializer, schema: Schema) -> list[str]:
    result: list[str] = []
    member_schema = schema.members["member"]
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["size"] = de.read_integer(_SCHEMA_LIST_CONTEXTS_INPUT.members["size"])
...
class CreateExperimentOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_CREATE_EXPERIMENT_OUTPUT.members["experiment_id"], self.experiment_id)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["experiment_id"] = de.read_string(_SCHEMA_CREATE_EXPERIMENT_OUTPUT.members["experiment_id"])
