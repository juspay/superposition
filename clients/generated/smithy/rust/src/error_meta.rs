...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                        crate::error::sealed_unhandled::Unhandled {
...
impl From<crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError> for Error {
    fn from(err: crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError) -> Self {
        match err {
            crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError::InternalServerError(inner) => Error::InternalServerError(inner),
            crate::operation::update_workspace_database::UpdateWorkspaceDatabaseError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
