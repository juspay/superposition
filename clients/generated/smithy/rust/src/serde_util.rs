...
pub(crate) fn create_experiment_group_output_output_correct_errors(mut builder: crate::operation::create_experiment_group::builders::CreateExperimentGroupOutputBuilder) -> crate::operation::create_experiment_group::builders::CreateExperimentGroupOutputBuilder {
                if builder.experiment_group_id.is_none() { builder.experiment_group_id = Some(Default::default()) }
if builder.experiment_group_hash.is_none() { builder.experiment_group_hash = Some(Default::default()) }
if builder.name.is_none() { builder.name = Some(Default::default()) }
if builder.description.is_none() { builder.description = Some(Default::default()) }
if builder.change_reason.is_none() { builder.change_reason = Some(Default::default()) }
if builder.context.is_none() { builder.context = Some(Default::default()) }
