...
#[derive(Debug)]
    ...
    ::std::write!(output, "/context/list").expect("formatting should succeed");
...
fn uri_query(_input: &crate::operation::list_contexts::ListContextsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.sort_on {
         {
            query.push_kv("sort_on", &::aws_smithy_http::query::fmt_string(inner_4));
        }
    }
    if let ::std::option::Option::Some(inner_5) = &_input.sort_by {
         {
            query.push_kv("sort_by", &::aws_smithy_http::query::fmt_string(inner_5));
        }
    }
    ...
    if let ::std::option::Option::Some(inner_8) = &_input.plaintext {
         {
            query.push_kv("plaintext", &::aws_smithy_http::query::fmt_string(inner_8));
        }
    }
    ::std::result::Result::Ok(())
}
