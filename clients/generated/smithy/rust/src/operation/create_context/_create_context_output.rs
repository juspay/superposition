...
impl CreateContextOutputBuilder {
    ...
    /// - [`context_id`](crate::operation::create_context::builders::CreateContextOutputBuilder::context_id)
        ...
        ::std::result::Result::Ok(
            crate::operation::create_context::CreateContextOutput {
                context_id: self.context_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("context_id", "context_id was not specified but it is required when building CreateContextOutput")
                    )?
                ,
