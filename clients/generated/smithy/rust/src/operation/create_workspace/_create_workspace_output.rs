...
impl CreateWorkspaceOutputBuilder {
    ...
    /// - [`workspace_strict_mode`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::workspace_strict_mode)
        ...
        ::std::result::Result::Ok(
            crate::operation::create_workspace::CreateWorkspaceOutput {
                ...
                workspace_strict_mode: self.workspace_strict_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_strict_mode", "workspace_strict_mode was not specified but it is required when building CreateWorkspaceOutput")
                    )?
                ,
            }
        )
