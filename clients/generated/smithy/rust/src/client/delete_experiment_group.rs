...
impl super::Client {
    ...
    ///   - [`experiment_group_id(impl Into<String>)`](crate::operation::delete_experiment_group::builders::DeleteExperimentGroupFluentBuilder::experiment_group_id) / [`set_experiment_group_id(Option<String>)`](crate::operation::delete_experiment_group::builders::DeleteExperimentGroupFluentBuilder::set_experiment_group_id):<br>required: **true**<br>(undocumented)<br>
    ...
    ///   - [`experiment_group_id(String)`](crate::operation::delete_experiment_group::DeleteExperimentGroupOutput::experiment_group_id): (undocumented)
    ///   - [`experiment_group_hash(String)`](crate::operation::delete_experiment_group::DeleteExperimentGroupOutput::experiment_group_hash): (undocumented)
