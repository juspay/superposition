...
impl super::Client {
    ...
    ///   - [`experiment_group_id(String)`](crate::operation::create_experiment_group::CreateExperimentGroupOutput::experiment_group_id): (undocumented)
    ///   - [`experiment_group_hash(String)`](crate::operation::create_experiment_group::CreateExperimentGroupOutput::experiment_group_hash): (undocumented)
