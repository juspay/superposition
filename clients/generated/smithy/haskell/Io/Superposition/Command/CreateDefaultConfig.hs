module Io.Superposition.Command.CreateDefaultConfig (
...
serCreateDefaultConfigPAYLOAD input =
    Network.HTTP.Client.RequestBodyLBS $ Data.Aeson.encode $ Data.Aeson.object [
        ...
        "value" Data.Aeson..= Io.Superposition.Model.CreateDefaultConfigInput.value input,
        "key" Data.Aeson..= Io.Superposition.Model.CreateDefaultConfigInput.key input
        ]
    

serCreateDefaultConfigHEADER :: Io.Superposition.Model.CreateDefaultConfigInput.CreateDefaultConfigInput -> Network.HTTP.Types.Header.RequestHeaders
serCreateDefaultConfigHEADER input =
    let 
        workspace_idHeader = (Io.Superposition.Model.CreateDefaultConfigInput.workspace_id input
        ...
        org_idHeader = (Io.Superposition.Model.CreateDefaultConfigInput.org_id input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
...
serCreateDefaultConfigLABEL :: Io.Superposition.Model.CreateDefaultConfigInput.CreateDefaultConfigInput -> Data.ByteString.ByteString
serCreateDefaultConfigLABEL input = 
    Data.ByteString.toStrict $ Data.ByteString.Builder.toLazyByteString $ Network.HTTP.Types.URI.encodePathSegmentsRelative [
        "default-config"
        ]
    

createDefaultConfig :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.CreateDefaultConfigInput.CreateDefaultConfigInputBuilder () -> IO (Data.Either.Either CreateDefaultConfigError Io.Superposition.Model.CreateDefaultConfigOutput.CreateDefaultConfigOutput)
createDefaultConfig client inputB = do
    let inputE = Io.Superposition.Model.CreateDefaultConfigInput.build inputB
    ...
    where
        ...
        toRequest input req =
            req {
                Network.HTTP.Client.path = serCreateDefaultConfigLABEL input
                , Network.HTTP.Client.method = method
                , Network.HTTP.Client.requestBody = serCreateDefaultConfigPAYLOAD input
                , Network.HTTP.Client.requestHeaders = (serCreateDefaultConfigHEADER input) ++ [("Authorization", "Bearer " <> token)]
            }
        
    


deserializeResponse :: Network.HTTP.Client.Response Data.ByteString.Lazy.ByteString -> Data.Either.Either Data.Text.Text Io.Superposition.Model.CreateDefaultConfigOutput.CreateDefaultConfigOutput
deserializeResponse response = do
    ...
    Io.Superposition.Model.CreateDefaultConfigOutput.build $ do
        ...
        Io.Superposition.Model.CreateDefaultConfigOutput.setCreatedAt created_atDocumentE
        Io.Superposition.Model.CreateDefaultConfigOutput.setLastModifiedBy last_modified_byDocumentE
        Io.Superposition.Model.CreateDefaultConfigOutput.setValue valueDocumentE
        Io.Superposition.Model.CreateDefaultConfigOutput.setCreatedBy created_byDocumentE
        Io.Superposition.Model.CreateDefaultConfigOutput.setKey keyDocumentE
        Io.Superposition.Model.CreateDefaultConfigOutput.setLastModifiedAt last_modified_atDocumentE
