...
serGetExperimentGroupHEADER input =
    let 
        workspace_idHeader = (Io.Superposition.Model.GetExperimentGroupInput.workspace_id input
        ...
        org_idHeader = (Io.Superposition.Model.GetExperimentGroupInput.org_id input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
...
serGetExperimentGroupLABEL :: Io.Superposition.Model.GetExperimentGroupInput.GetExperimentGroupInput -> Data.ByteString.ByteString
serGetExperimentGroupLABEL input = 
    Data.ByteString.toStrict $ Data.ByteString.Builder.toLazyByteString $ Network.HTTP.Types.URI.encodePathSegmentsRelative [
        "experiment-groups",
        (Io.Superposition.Model.GetExperimentGroupInput.id' input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
        
        ]
    

getExperimentGroup :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.GetExperimentGroupInput.GetExperimentGroupInputBuilder () -> IO (Data.Either.Either GetExperimentGroupError Io.Superposition.Model.GetExperimentGroupOutput.GetExperimentGroupOutput)
getExperimentGroup client inputB = do
    let inputE = Io.Superposition.Model.GetExperimentGroupInput.build inputB
    ...
    where
        ...
        toRequest input req =
            req {
                Network.HTTP.Client.path = serGetExperimentGroupLABEL input
                , Network.HTTP.Client.method = method
                , Network.HTTP.Client.requestHeaders = (serGetExperimentGroupHEADER input) ++ [("Authorization", "Bearer " <> token)]
            }
        
    


deserializeResponse :: Network.HTTP.Client.Response Data.ByteString.Lazy.ByteString -> Data.Either.Either Data.Text.Text Io.Superposition.Model.GetExperimentGroupOutput.GetExperimentGroupOutput
deserializeResponse response = do
    ...
    bucketsDocumentE :: [] Data.Text.Text <-
