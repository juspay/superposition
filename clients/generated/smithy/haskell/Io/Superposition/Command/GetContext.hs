module Io.Superposition.Command.GetContext (
    GetContextError(..),
    getContext
) where
...
serGetContextHEADER input =
    let 
        workspace_idHeader = (Io.Superposition.Model.GetContextInput.workspace_id input
        ...
        org_idHeader = (Io.Superposition.Model.GetContextInput.org_id input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
...
serGetContextLABEL :: Io.Superposition.Model.GetContextInput.GetContextInput -> Data.ByteString.ByteString
serGetContextLABEL input = 
    Data.ByteString.toStrict $ Data.ByteString.Builder.toLazyByteString $ Network.HTTP.Types.URI.encodePathSegmentsRelative [
        "context",
        (Io.Superposition.Model.GetContextInput.id' input
                    Data.Function.& Io.Superposition.Utility.toRequestSegment)
        
        ]
    

getContext :: Io.Superposition.SuperpositionClient.SuperpositionClient -> Io.Superposition.Model.GetContextInput.GetContextInputBuilder () -> IO (Data.Either.Either GetContextError Io.Superposition.Model.GetContextOutput.GetContextOutput)
getContext client inputB = do
    let inputE = Io.Superposition.Model.GetContextInput.build inputB
    ...
    where
        ...
        toRequest input req =
            req {
                Network.HTTP.Client.path = serGetContextLABEL input
                , Network.HTTP.Client.method = method
                , Network.HTTP.Client.requestHeaders = (serGetContextHEADER input) ++ [("Authorization", "Bearer " <> token)]
            }
        
    


deserializeResponse :: Network.HTTP.Client.Response Data.ByteString.Lazy.ByteString -> Data.Either.Either Data.Text.Text Io.Superposition.Model.GetContextOutput.GetContextOutput
deserializeResponse response = do
    ...
    Io.Superposition.Model.GetContextOutput.build $ do
        Io.Superposition.Model.GetContextOutput.setChangeReason change_reasonDocumentE
        Io.Superposition.Model.GetContextOutput.setOverrideId override_idDocumentE
        Io.Superposition.Model.GetContextOutput.setWeight weightDocumentE
        Io.Superposition.Model.GetContextOutput.setDescription descriptionDocumentE
        Io.Superposition.Model.GetContextOutput.setCreatedAt created_atDocumentE
        Io.Superposition.Model.GetContextOutput.setId' id'DocumentE
        Io.Superposition.Model.GetContextOutput.setOverride overrideDocumentE
        Io.Superposition.Model.GetContextOutput.setLastModifiedBy last_modified_byDocumentE
        Io.Superposition.Model.GetContextOutput.setValue valueDocumentE
        Io.Superposition.Model.GetContextOutput.setCreatedBy created_byDocumentE
        Io.Superposition.Model.GetContextOutput.setLastModifiedAt last_modified_atDocumentE
