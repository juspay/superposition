...
newtype RemoveMembersFromGroupOutputBuilder a = RemoveMembersFromGroupOutputBuilder {
    runRemoveMembersFromGroupOutputBuilder :: RemoveMembersFromGroupOutputBuilderState -> (RemoveMembersFromGroupOutputBuilderState, a)
}

instance Data.Functor.Functor RemoveMembersFromGroupOutputBuilder where
    fmap f (RemoveMembersFromGroupOutputBuilder g) =
        RemoveMembersFromGroupOutputBuilder (\s -> let (s', a) = g s in (s', f a))

instance Control.Applicative.Applicative RemoveMembersFromGroupOutputBuilder where
    pure a = RemoveMembersFromGroupOutputBuilder (\s -> (s, a))
    (RemoveMembersFromGroupOutputBuilder f) <*> (RemoveMembersFromGroupOutputBuilder g) = RemoveMembersFromGroupOutputBuilder (\s ->
        let (s', h) = f s
            (s'', a) = g s'
        in (s'', h a))

instance Control.Monad.Monad RemoveMembersFromGroupOutputBuilder where
    (RemoveMembersFromGroupOutputBuilder f) >>= g = RemoveMembersFromGroupOutputBuilder (\s ->
        let (s', a) = f s
            (RemoveMembersFromGroupOutputBuilder h) = g a
        in h s')

setId' :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setId' value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { id'BuilderState = Data.Maybe.Just value }, ()))

setContextHash :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setContextHash value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { context_hashBuilderState = Data.Maybe.Just value }, ()))

setName :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setName value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { nameBuilderState = Data.Maybe.Just value }, ()))

setDescription :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setDescription value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { descriptionBuilderState = Data.Maybe.Just value }, ()))

setChangeReason :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setChangeReason value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { change_reasonBuilderState = Data.Maybe.Just value }, ()))

setContext :: Data.Map.Map Data.Text.Text Data.Aeson.Value -> RemoveMembersFromGroupOutputBuilder ()
setContext value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { contextBuilderState = Data.Maybe.Just value }, ()))

setTrafficPercentage :: Integer -> RemoveMembersFromGroupOutputBuilder ()
setTrafficPercentage value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { traffic_percentageBuilderState = Data.Maybe.Just value }, ()))

setMemberExperimentIds :: [] Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setMemberExperimentIds value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { member_experiment_idsBuilderState = Data.Maybe.Just value }, ()))

setCreatedAt :: Data.Time.UTCTime -> RemoveMembersFromGroupOutputBuilder ()
setCreatedAt value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { created_atBuilderState = Data.Maybe.Just value }, ()))

setCreatedBy :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setCreatedBy value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { created_byBuilderState = Data.Maybe.Just value }, ()))

setLastModifiedAt :: Data.Time.UTCTime -> RemoveMembersFromGroupOutputBuilder ()
setLastModifiedAt value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { last_modified_atBuilderState = Data.Maybe.Just value }, ()))

setLastModifiedBy :: Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setLastModifiedBy value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { last_modified_byBuilderState = Data.Maybe.Just value }, ()))

setBuckets :: [] Data.Text.Text -> RemoveMembersFromGroupOutputBuilder ()
setBuckets value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { bucketsBuilderState = Data.Maybe.Just value }, ()))

setGroupType :: Io.Superposition.Model.GroupType.GroupType -> RemoveMembersFromGroupOutputBuilder ()
setGroupType value =
   RemoveMembersFromGroupOutputBuilder (\s -> (s { group_typeBuilderState = Data.Maybe.Just value }, ()))

build :: RemoveMembersFromGroupOutputBuilder () -> Data.Either.Either Data.Text.Text RemoveMembersFromGroupOutput
build builder = do
    let (st, _) = runRemoveMembersFromGroupOutputBuilder builder defaultBuilderState
