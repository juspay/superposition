...
newtype DimensionExtBuilder a = DimensionExtBuilder {
    runDimensionExtBuilder :: DimensionExtBuilderState -> (DimensionExtBuilderState, a)
}

instance Data.Functor.Functor DimensionExtBuilder where
    fmap f (DimensionExtBuilder g) =
        DimensionExtBuilder (\s -> let (s', a) = g s in (s', f a))

instance Control.Applicative.Applicative DimensionExtBuilder where
    pure a = DimensionExtBuilder (\s -> (s, a))
    (DimensionExtBuilder f) <*> (DimensionExtBuilder g) = DimensionExtBuilder (\s ->
        let (s', h) = f s
            (s'', a) = g s'
        in (s'', h a))

instance Control.Monad.Monad DimensionExtBuilder where
    (DimensionExtBuilder f) >>= g = DimensionExtBuilder (\s ->
        let (s', a) = f s
            (DimensionExtBuilder h) = g a
        in h s')

setDimension :: Data.Text.Text -> DimensionExtBuilder ()
setDimension value =
   DimensionExtBuilder (\s -> (s { dimensionBuilderState = Data.Maybe.Just value }, ()))

setPosition :: Integer -> DimensionExtBuilder ()
setPosition value =
   DimensionExtBuilder (\s -> (s { positionBuilderState = Data.Maybe.Just value }, ()))

setSchema :: Data.Aeson.Value -> DimensionExtBuilder ()
setSchema value =
   DimensionExtBuilder (\s -> (s { schemaBuilderState = Data.Maybe.Just value }, ()))

setFunctionName :: Data.Maybe.Maybe Data.Text.Text -> DimensionExtBuilder ()
setFunctionName value =
   DimensionExtBuilder (\s -> (s { function_nameBuilderState = value }, ()))

setDescription :: Data.Text.Text -> DimensionExtBuilder ()
setDescription value =
   DimensionExtBuilder (\s -> (s { descriptionBuilderState = Data.Maybe.Just value }, ()))

setChangeReason :: Data.Text.Text -> DimensionExtBuilder ()
setChangeReason value =
   DimensionExtBuilder (\s -> (s { change_reasonBuilderState = Data.Maybe.Just value }, ()))

setLastModifiedAt :: Data.Time.UTCTime -> DimensionExtBuilder ()
setLastModifiedAt value =
   DimensionExtBuilder (\s -> (s { last_modified_atBuilderState = Data.Maybe.Just value }, ()))

setLastModifiedBy :: Data.Text.Text -> DimensionExtBuilder ()
setLastModifiedBy value =
   DimensionExtBuilder (\s -> (s { last_modified_byBuilderState = Data.Maybe.Just value }, ()))

setCreatedAt :: Data.Time.UTCTime -> DimensionExtBuilder ()
setCreatedAt value =
   DimensionExtBuilder (\s -> (s { created_atBuilderState = Data.Maybe.Just value }, ()))

setCreatedBy :: Data.Text.Text -> DimensionExtBuilder ()
setCreatedBy value =
   DimensionExtBuilder (\s -> (s { created_byBuilderState = Data.Maybe.Just value }, ()))

setDependencies :: [] Data.Text.Text -> DimensionExtBuilder ()
setDependencies value =
   DimensionExtBuilder (\s -> (s { dependenciesBuilderState = Data.Maybe.Just value }, ()))

setDependents :: [] Data.Text.Text -> DimensionExtBuilder ()
setDependents value =
   DimensionExtBuilder (\s -> (s { dependentsBuilderState = Data.Maybe.Just value }, ()))
...
setDimensionType value =
   DimensionExtBuilder (\s -> (s { dimension_typeBuilderState = Data.Maybe.Just value }, ()))

setCohortBasedOn :: Data.Maybe.Maybe Data.Text.Text -> DimensionExtBuilder ()
setCohortBasedOn value =
   DimensionExtBuilder (\s -> (s { cohort_based_onBuilderState = value }, ()))
...
build builder = do
    let (st, _) = runDimensionExtBuilder builder defaultBuilderState
