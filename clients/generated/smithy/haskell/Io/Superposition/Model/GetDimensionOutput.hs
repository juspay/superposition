...
setDimensionType value =
   GetDimensionOutputBuilder (\s -> (s { dimension_typeBuilderState = Data.Maybe.Just value }, ()))

setCohortBasedOn :: Data.Maybe.Maybe Data.Text.Text -> GetDimensionOutputBuilder ()
setCohortBasedOn value =
   GetDimensionOutputBuilder (\s -> (s { cohort_based_onBuilderState = value }, ()))
