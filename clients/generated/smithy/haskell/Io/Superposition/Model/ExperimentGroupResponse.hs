...
setBuckets :: [] Data.Text.Text -> ExperimentGroupResponseBuilder ()
setBuckets value =
   ExperimentGroupResponseBuilder (\s -> (s { bucketsBuilderState = Data.Maybe.Just value }, ()))

setGroupType :: Io.Superposition.Model.GroupType.GroupType -> ExperimentGroupResponseBuilder ()
setGroupType value =
   ExperimentGroupResponseBuilder (\s -> (s { group_typeBuilderState = Data.Maybe.Just value }, ()))
