...
setDimensionType value =
   UpdateDimensionOutputBuilder (\s -> (s { dimension_typeBuilderState = Data.Maybe.Just value }, ()))

setCohortBasedOn :: Data.Maybe.Maybe Data.Text.Text -> UpdateDimensionOutputBuilder ()
setCohortBasedOn value =
   UpdateDimensionOutputBuilder (\s -> (s { cohort_based_onBuilderState = value }, ()))
