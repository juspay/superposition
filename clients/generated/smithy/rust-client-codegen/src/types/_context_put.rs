...
impl ContextPutBuilder {
    ...
    /// - [`condition`](crate::types::builders::ContextPutBuilder::condition)
        ...
        ::std::result::Result::Ok(
            crate::types::ContextPut {
                condition: self.condition
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("condition", "condition was not specified but it is required when building ContextPut")
                    )?
                ,
