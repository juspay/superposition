...
impl ContextFull {
    /// Creates a new builder-style object to manufacture [`ContextFull`](crate::types::ContextFull).
    pub fn builder() -> crate::types::builders::ContextFullBuilder {
        crate::types::builders::ContextFullBuilder::default()
    }
}

/// A builder for [`ContextFull`](crate::types::ContextFull).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ContextFullBuilder {
...
impl ContextFullBuilder {
    ...
    /// Consumes the builder and constructs a [`ContextFull`](crate::types::ContextFull).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::types::builders::ContextFullBuilder::id)
    pub fn build(self) -> ::std::result::Result<crate::types::ContextFull, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ContextFull {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building ContextFull")
                    )?
                ,
                value: self.value
                ,
