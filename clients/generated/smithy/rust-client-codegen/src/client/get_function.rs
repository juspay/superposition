...
impl super::Client {
    ...
    ///   - [`published_runtime_version(Option<String>)`](crate::operation::get_function::GetFunctionOutput::published_runtime_version): (undocumented)
    ///   - [`draft_runtime_version(String)`](crate::operation::get_function::GetFunctionOutput::draft_runtime_version): (undocumented)
