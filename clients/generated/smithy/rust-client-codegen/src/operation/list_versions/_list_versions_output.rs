...
pub struct ListVersionsOutputBuilder {
    ...
    pub(crate) data: ::std::option::Option<::std::vec::Vec::<::std::string::String>>,
}
impl ListVersionsOutputBuilder {
    ...
    #[allow(missing_docs)] // documentation missing in model
    pub fn set_data(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.data = input; self
    }
    #[allow(missing_docs)] // documentation missing in model
    pub fn get_data(&self) -> &::std::option::Option<::std::vec::Vec::<::std::string::String>> {
        &self.data
    }
