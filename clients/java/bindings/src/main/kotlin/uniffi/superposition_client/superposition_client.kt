...
fun uniffi_superposition_core_fn_method_providercache_init_experiments(`ptr`: Pointer,`experimentation`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_superposition_core_checksum_method_providercache_init_experiments() != 29243.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface ProviderCacheInterface {
    ...
    fun `initExperiments`(`experimentation`: ExperimentationArgs)
...
open class ProviderCache: Disposable, AutoCloseable, ProviderCacheInterface
{
    ...
    @Throws(OperationException::class)override fun `initExperiments`(`experimentation`: ExperimentationArgs)
        = 
    callWithPointer {
    uniffiRustCallWithError(OperationException) { _status ->
    UniffiLib.INSTANCE.uniffi_superposition_core_fn_method_providercache_init_experiments(
        it, FfiConverterTypeExperimentationArgs.lower(`experimentation`),_status)
}
    }
