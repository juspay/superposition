...
@SmithyGenerated
public final class GetDefaultConfigOutput implements SerializableStruct {
    ...
    private GetDefaultConfigOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetDefaultConfigOutput that = (GetDefaultConfigOutput) other;
     ...
     *
     * @return a builder for {@link GetDefaultConfigOutput}.
     */
    ...
    /**
     * Builder for {@link GetDefaultConfigOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetDefaultConfigOutput> {
        ...
        @Override
        public GetDefaultConfigOutput build() {
            tracker.validate();
            return new GetDefaultConfigOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetDefaultConfigOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
