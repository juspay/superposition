...
@SmithyGenerated
public final class ListContextsOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListContextsOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.LIST_CONTEXT_OUT,
                new RequiredTrait())
        .build();
    ...
    public boolean equals(Object other) {
        ...
        ListContextsOutput that = (ListContextsOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.ListContextOutSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListContextsOutput}.
     */
    ...
    /**
     * Builder for {@link ListContextsOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListContextsOutput> {
        ...
        @Override
        public ListContextsOutput build() {
            tracker.validate();
            return new ListContextsOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListContextsOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeListContextOut(member, de));
