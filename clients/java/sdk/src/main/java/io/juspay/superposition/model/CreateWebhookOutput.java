...
@SmithyGenerated
public final class CreateWebhookOutput implements SerializableStruct {
    ...
    private CreateWebhookOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateWebhookOutput that = (CreateWebhookOutput) other;
     ...
     *
     * @return a builder for {@link CreateWebhookOutput}.
     */
    ...
    /**
     * Builder for {@link CreateWebhookOutput}.
     */
    public static final class Builder implements ShapeBuilder<CreateWebhookOutput> {
        ...
        @Override
        public CreateWebhookOutput build() {
            tracker.validate();
            return new CreateWebhookOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<CreateWebhookOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
