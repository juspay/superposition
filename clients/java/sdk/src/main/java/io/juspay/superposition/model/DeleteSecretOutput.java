 ...
 */
@SmithyGenerated
public final class DeleteSecretOutput implements SerializableStruct {
    ...
    private DeleteSecretOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteSecretOutput that = (DeleteSecretOutput) other;
     ...
     *
     * @return a builder for {@link DeleteSecretOutput}.
     */
    ...
    /**
     * Builder for {@link DeleteSecretOutput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteSecretOutput> {
        ...
        @Override
        public DeleteSecretOutput build() {
            tracker.validate();
            return new DeleteSecretOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteSecretOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
