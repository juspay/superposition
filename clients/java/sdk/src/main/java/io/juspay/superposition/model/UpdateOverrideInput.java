    ...
    public static final class Builder implements ShapeBuilder<UpdateOverrideInput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> request((UpdateContextOverrideRequest) SchemaUtils.validateSameMember($SCHEMA_REQUEST, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.request(UpdateContextOverrideRequest.builder().deserializeMember(de, member).build());
