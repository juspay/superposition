...
@SmithyGenerated
public final class ListJobsOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListJobsOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.JOB_LIST,
                new RequiredTrait())
        .build();
    ...
    private final transient List<JobDetailResponse> data;

    private ListJobsOutput(Builder builder) {
    ...
    public List<JobDetailResponse> data() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        ListJobsOutput that = (ListJobsOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.JobListSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListJobsOutput}.
     */
    ...
    /**
     * Builder for {@link ListJobsOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListJobsOutput> {
        private final PresenceTracker tracker = PresenceTracker.of($SCHEMA);
        private int totalPages;
        private int totalItems;
        private List<JobDetailResponse> data;
         ...
         * @return this builder.
         */
        public Builder data(List<JobDetailResponse> data) {
        ...
        @Override
        public ListJobsOutput build() {
            tracker.validate();
            return new ListJobsOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<JobDetailResponse>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListJobsOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeJobList(member, de));
