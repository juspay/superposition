...
@SmithyGenerated
public final class GetDimensionInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetDimensionInput");
    ...
    private GetDimensionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetDimensionInput that = (GetDimensionInput) other;
     ...
     *
     * @return a builder for {@link GetDimensionInput}.
     */
    ...
    /**
     * Builder for {@link GetDimensionInput}.
     */
    public static final class Builder implements ShapeBuilder<GetDimensionInput> {
        ...
        @Override
        public GetDimensionInput build() {
            tracker.validate();
            return new GetDimensionInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetDimensionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
