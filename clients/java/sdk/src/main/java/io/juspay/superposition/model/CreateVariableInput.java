...
@SmithyGenerated
public final class CreateVariableInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#CreateVariableInput");
    ...
    private CreateVariableInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateVariableInput that = (CreateVariableInput) other;
     ...
     *
     * @return a builder for {@link CreateVariableInput}.
     */
    ...
    /**
     * Builder for {@link CreateVariableInput}.
     */
    public static final class Builder implements ShapeBuilder<CreateVariableInput> {
        ...
        @Override
        public CreateVariableInput build() {
            tracker.validate();
            return new CreateVariableInput(this);
        }
        ...
        @Override
        public ShapeBuilder<CreateVariableInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
