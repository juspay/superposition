...
@SmithyGenerated
public final class ResumeExperimentInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ResumeExperimentInput");
    ...
    private ResumeExperimentInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ResumeExperimentInput that = (ResumeExperimentInput) other;
     ...
     *
     * @return a builder for {@link ResumeExperimentInput}.
     */
    ...
    /**
     * Builder for {@link ResumeExperimentInput}.
     */
    public static final class Builder implements ShapeBuilder<ResumeExperimentInput> {
        ...
        @Override
        public ResumeExperimentInput build() {
            tracker.validate();
            return new ResumeExperimentInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ResumeExperimentInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
