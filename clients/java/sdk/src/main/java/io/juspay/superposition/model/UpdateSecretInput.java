...
@SmithyGenerated
public final class UpdateSecretInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#UpdateSecretInput");
    ...
    private UpdateSecretInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateSecretInput that = (UpdateSecretInput) other;
     ...
     *
     * @return a builder for {@link UpdateSecretInput}.
     */
    ...
    /**
     * Builder for {@link UpdateSecretInput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateSecretInput> {
        ...
        public UpdateSecretInput build() {
            tracker.validate();
            return new UpdateSecretInput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateSecretInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
