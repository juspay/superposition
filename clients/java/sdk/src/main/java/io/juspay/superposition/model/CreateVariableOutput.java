...
@SmithyGenerated
public final class CreateVariableOutput implements SerializableStruct {
    ...
    private CreateVariableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateVariableOutput that = (CreateVariableOutput) other;
     ...
     *
     * @return a builder for {@link CreateVariableOutput}.
     */
    ...
    /**
     * Builder for {@link CreateVariableOutput}.
     */
    public static final class Builder implements ShapeBuilder<CreateVariableOutput> {
        ...
        @Override
        public CreateVariableOutput build() {
            tracker.validate();
            return new CreateVariableOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<CreateVariableOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
