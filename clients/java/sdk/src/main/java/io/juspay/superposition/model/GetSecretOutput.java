 ...
 */
@SmithyGenerated
public final class GetSecretOutput implements SerializableStruct {
    ...
    private GetSecretOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetSecretOutput that = (GetSecretOutput) other;
     ...
     *
     * @return a builder for {@link GetSecretOutput}.
     */
    ...
    /**
     * Builder for {@link GetSecretOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetSecretOutput> {
        ...
        @Override
        public GetSecretOutput build() {
            tracker.validate();
            return new GetSecretOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetSecretOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
