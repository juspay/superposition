...
@SmithyGenerated
public final class DeleteTypeTemplatesOutput implements SerializableStruct {
    ...
    public boolean equals(Object other) {
        ...
        DeleteTypeTemplatesOutput that = (DeleteTypeTemplatesOutput) other;
     ...
     *
     * @return a builder for {@link DeleteTypeTemplatesOutput}.
     */
    ...
    /**
     * Builder for {@link DeleteTypeTemplatesOutput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteTypeTemplatesOutput> {
        ...
        @Override
        public DeleteTypeTemplatesOutput build() {
            tracker.validate();
            return new DeleteTypeTemplatesOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteTypeTemplatesOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
