...
public final class ListVersionsMember implements SerializableStruct {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, config, createdAt, description, tags);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 2 -> (T) SchemaUtils.validateSameMember($SCHEMA_CREATED_AT, member, createdAt);
    ...
    public static final class Builder implements ShapeBuilder<ListVersionsMember> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> createdAt((Instant) SchemaUtils.validateSameMember($SCHEMA_CREATED_AT, member, value));
                case 3 -> description((String) SchemaUtils.validateSameMember($SCHEMA_DESCRIPTION, member, value));
                case 4 -> tags((List<String>) SchemaUtils.validateSameMember($SCHEMA_TAGS, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.createdAt(de.readTimestamp(member));
                    case 3 -> builder.description(de.readString(member));
                    case 4 -> builder.tags(SharedSerde.deserializeStringList(member, de));
