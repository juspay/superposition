...
public final class UpdateOverrideOutput implements SerializableStruct {
    ...
    public boolean equals(Object other) {
        ...
        UpdateOverrideOutput that = (UpdateOverrideOutput) other;
     ...
     *
     * @return a builder for {@link UpdateOverrideOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateOverrideOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateOverrideOutput> {
        ...
        @Override
        public UpdateOverrideOutput build() {
            tracker.validate();
            return new UpdateOverrideOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateOverrideOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
