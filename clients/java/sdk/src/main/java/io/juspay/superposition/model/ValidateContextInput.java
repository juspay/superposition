...
@SmithyGenerated
public final class ValidateContextInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ValidateContextInput");
     ...
     *
     * @return a builder for {@link ValidateContextInput}.
     */
    ...
    /**
     * Builder for {@link ValidateContextInput}.
     */
    public static final class Builder implements ShapeBuilder<ValidateContextInput> {
        ...
        @Override
        public ValidateContextInput build() {
            tracker.validate();
            return new ValidateContextInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ValidateContextInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
