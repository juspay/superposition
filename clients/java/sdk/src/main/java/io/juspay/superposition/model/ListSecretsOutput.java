...
@SmithyGenerated
public final class ListSecretsOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListSecretsOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.SECRET_LIST,
                new RequiredTrait())
        .build();
    ...
    private final transient List<SecretResponse> data;

    private ListSecretsOutput(Builder builder) {
    ...
    public List<SecretResponse> data() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        ListSecretsOutput that = (ListSecretsOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.SecretListSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListSecretsOutput}.
     */
    ...
    /**
     * Builder for {@link ListSecretsOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListSecretsOutput> {
         ...
         * @return this builder.
         */
        public Builder data(List<SecretResponse> data) {
        ...
        @Override
        public ListSecretsOutput build() {
            tracker.validate();
            return new ListSecretsOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<SecretResponse>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListSecretsOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeSecretList(member, de));
