...
public final class ListExperimentInput implements SerializableStruct {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, page, count, all, status, fromDate, toDate, experimentName, experimentIds, experimentGroupIds, createdBy, sortOn, sortBy, globalExperimentsOnly, filterExactMatch);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 15 -> (T) SchemaUtils.validateSameMember($SCHEMA_FILTER_EXACT_MATCH, member, filterExactMatch);
    ...
    public static final class Builder implements ShapeBuilder<ListExperimentInput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 15 -> filterExactMatch((boolean) SchemaUtils.validateSameMember($SCHEMA_FILTER_EXACT_MATCH, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 15 -> builder.filterExactMatch(de.readBoolean(member));
