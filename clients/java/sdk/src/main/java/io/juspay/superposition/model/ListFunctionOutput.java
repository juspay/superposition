...
@SmithyGenerated
public final class ListFunctionOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListFunctionOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.FUNCTION_LIST_RESPONSE,
                new RequiredTrait())
        .build();
    ...
    private final transient List<FunctionResponse> data;

    private ListFunctionOutput(Builder builder) {
    ...
    public List<FunctionResponse> data() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        ListFunctionOutput that = (ListFunctionOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.FunctionListResponseSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListFunctionOutput}.
     */
    ...
    /**
     * Builder for {@link ListFunctionOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListFunctionOutput> {
         ...
         * @return this builder.
         */
        public Builder data(List<FunctionResponse> data) {
        ...
        @Override
        public ListFunctionOutput build() {
            tracker.validate();
            return new ListFunctionOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<FunctionResponse>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListFunctionOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeFunctionListResponse(member, de));
