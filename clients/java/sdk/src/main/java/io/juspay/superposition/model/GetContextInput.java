...
@SmithyGenerated
public final class GetContextInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetContextInput");
    ...
    private GetContextInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetContextInput that = (GetContextInput) other;
     ...
     *
     * @return a builder for {@link GetContextInput}.
     */
    ...
    /**
     * Builder for {@link GetContextInput}.
     */
    public static final class Builder implements ShapeBuilder<GetContextInput> {
        ...
        @Override
        public ShapeBuilder<GetContextInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
