...
@SmithyGenerated
public final class MoveContextOutput implements SerializableStruct {
    ...
    private MoveContextOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        MoveContextOutput that = (MoveContextOutput) other;
     ...
     *
     * @return a builder for {@link MoveContextOutput}.
     */
    ...
    /**
     * Builder for {@link MoveContextOutput}.
     */
    public static final class Builder implements ShapeBuilder<MoveContextOutput> {
        ...
        @Override
        public MoveContextOutput build() {
            tracker.validate();
            return new MoveContextOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<MoveContextOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
