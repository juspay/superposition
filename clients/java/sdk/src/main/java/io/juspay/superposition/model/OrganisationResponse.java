...
@SmithyGenerated
public final class OrganisationResponse implements SerializableStruct {
    ...
    private OrganisationResponse(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        OrganisationResponse that = (OrganisationResponse) other;
     ...
     *
     * @return a builder for {@link OrganisationResponse}.
     */
    ...
    /**
     * Builder for {@link OrganisationResponse}.
     */
    public static final class Builder implements ShapeBuilder<OrganisationResponse> {
        ...
        @Override
        public OrganisationResponse build() {
            tracker.validate();
            return new OrganisationResponse(this);
        }
        ...
        @Override
        public ShapeBuilder<OrganisationResponse> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
