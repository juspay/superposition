...
@SmithyGenerated
public final class GetExperimentConfigInput implements SerializableStruct {
     ...
     *
     * @return a builder for {@link GetExperimentConfigInput}.
     */
    ...
    /**
     * Builder for {@link GetExperimentConfigInput}.
     */
    public static final class Builder implements ShapeBuilder<GetExperimentConfigInput> {
        ...
        public GetExperimentConfigInput build() {
            tracker.validate();
            return new GetExperimentConfigInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetExperimentConfigInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
