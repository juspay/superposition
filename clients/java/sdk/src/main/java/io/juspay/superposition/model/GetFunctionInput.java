...
@SmithyGenerated
public final class GetFunctionInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetFunctionInput");
    ...
    private GetFunctionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetFunctionInput that = (GetFunctionInput) other;
     ...
     *
     * @return a builder for {@link GetFunctionInput}.
     */
    ...
    /**
     * Builder for {@link GetFunctionInput}.
     */
    public static final class Builder implements ShapeBuilder<GetFunctionInput> {
        ...
        @Override
        public GetFunctionInput build() {
            tracker.validate();
            return new GetFunctionInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetFunctionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
