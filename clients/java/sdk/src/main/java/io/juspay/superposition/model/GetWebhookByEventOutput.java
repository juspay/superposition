...
@SmithyGenerated
public final class GetWebhookByEventOutput implements SerializableStruct {
    ...
    private GetWebhookByEventOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetWebhookByEventOutput that = (GetWebhookByEventOutput) other;
     ...
     *
     * @return a builder for {@link GetWebhookByEventOutput}.
     */
    ...
    /**
     * Builder for {@link GetWebhookByEventOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetWebhookByEventOutput> {
        ...
        @Override
        public GetWebhookByEventOutput build() {
            tracker.validate();
            return new GetWebhookByEventOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetWebhookByEventOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
