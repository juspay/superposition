...
@SmithyGenerated
public final class GetWorkspaceInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetWorkspaceInput");
    ...
    private GetWorkspaceInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetWorkspaceInput that = (GetWorkspaceInput) other;
     ...
     *
     * @return a builder for {@link GetWorkspaceInput}.
     */
    ...
    /**
     * Builder for {@link GetWorkspaceInput}.
     */
    public static final class Builder implements ShapeBuilder<GetWorkspaceInput> {
        ...
        @Override
        public GetWorkspaceInput build() {
            tracker.validate();
            return new GetWorkspaceInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetWorkspaceInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
