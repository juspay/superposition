...
@SmithyGenerated
public final class DeleteDimensionInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#DeleteDimensionInput");
    ...
    private DeleteDimensionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteDimensionInput that = (DeleteDimensionInput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, dimension);
    }
     ...
     *
     * @return a builder for {@link DeleteDimensionInput}.
     */
    ...
    /**
     * Builder for {@link DeleteDimensionInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteDimensionInput> {
        ...
        @Override
        public DeleteDimensionInput build() {
            tracker.validate();
            return new DeleteDimensionInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteDimensionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
