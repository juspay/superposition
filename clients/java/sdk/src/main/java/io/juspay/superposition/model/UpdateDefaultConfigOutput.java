...
public final class UpdateDefaultConfigOutput implements SerializableStruct {
    ...
    private UpdateDefaultConfigOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateDefaultConfigOutput that = (UpdateDefaultConfigOutput) other;
     ...
     *
     * @return a builder for {@link UpdateDefaultConfigOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateDefaultConfigOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateDefaultConfigOutput> {
        ...
        @Override
        public UpdateDefaultConfigOutput build() {
            tracker.validate();
            return new UpdateDefaultConfigOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateDefaultConfigOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
