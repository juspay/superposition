...
@SmithyGenerated
public final class GetResolvedConfigOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetResolvedConfigOutput");
    ...
    private GetResolvedConfigOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetResolvedConfigOutput that = (GetResolvedConfigOutput) other;
     ...
     *
     * @return a builder for {@link GetResolvedConfigOutput}.
     */
