...
@SmithyGenerated
public final class UpdateVariableOutput implements SerializableStruct {
    ...
    private UpdateVariableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateVariableOutput that = (UpdateVariableOutput) other;
     ...
     *
     * @return a builder for {@link UpdateVariableOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateVariableOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateVariableOutput> {
        ...
        @Override
        public UpdateVariableOutput build() {
            tracker.validate();
            return new UpdateVariableOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateVariableOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
