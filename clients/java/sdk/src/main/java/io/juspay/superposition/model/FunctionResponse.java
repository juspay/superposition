...
@SmithyGenerated
public final class FunctionResponse implements SerializableStruct {
    ...
    private FunctionResponse(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        FunctionResponse that = (FunctionResponse) other;
     ...
     *
     * @return a builder for {@link FunctionResponse}.
     */
    ...
    /**
     * Builder for {@link FunctionResponse}.
     */
    public static final class Builder implements ShapeBuilder<FunctionResponse> {
        ...
        @Override
        public ShapeBuilder<FunctionResponse> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
