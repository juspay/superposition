 ...
 */
@SmithyGenerated
public final class CreateSecretOutput implements SerializableStruct {
    ...
    private CreateSecretOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateSecretOutput that = (CreateSecretOutput) other;
     ...
     *
     * @return a builder for {@link CreateSecretOutput}.
     */
    ...
    /**
     * Builder for {@link CreateSecretOutput}.
     */
    public static final class Builder implements ShapeBuilder<CreateSecretOutput> {
        ...
        @Override
        public CreateSecretOutput build() {
            tracker.validate();
            return new CreateSecretOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<CreateSecretOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
