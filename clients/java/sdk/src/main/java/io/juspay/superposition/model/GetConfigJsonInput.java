...
@SmithyGenerated
public final class GetConfigJsonInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetConfigJsonInput");
     ...
     *
     * @return a builder for {@link GetConfigJsonInput}.
     */
    ...
    /**
     * Builder for {@link GetConfigJsonInput}.
     */
    public static final class Builder implements ShapeBuilder<GetConfigJsonInput> {
        ...
        public GetConfigJsonInput build() {
            tracker.validate();
            return new GetConfigJsonInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetConfigJsonInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
