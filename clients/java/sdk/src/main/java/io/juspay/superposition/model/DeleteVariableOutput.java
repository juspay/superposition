...
@SmithyGenerated
public final class DeleteVariableOutput implements SerializableStruct {
    ...
    private DeleteVariableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteVariableOutput that = (DeleteVariableOutput) other;
     ...
     *
     * @return a builder for {@link DeleteVariableOutput}.
     */
    ...
    /**
     * Builder for {@link DeleteVariableOutput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteVariableOutput> {
        ...
        @Override
        public DeleteVariableOutput build() {
            tracker.validate();
            return new DeleteVariableOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteVariableOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
