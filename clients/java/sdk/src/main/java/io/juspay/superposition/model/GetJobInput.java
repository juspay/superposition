...
@SmithyGenerated
public final class GetJobInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetJobInput");
    ...
    private GetJobInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetJobInput that = (GetJobInput) other;
     ...
     *
     * @return a builder for {@link GetJobInput}.
     */
    ...
    /**
     * Builder for {@link GetJobInput}.
     */
    public static final class Builder implements ShapeBuilder<GetJobInput> {
        ...
        @Override
        public GetJobInput build() {
            tracker.validate();
            return new GetJobInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetJobInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
