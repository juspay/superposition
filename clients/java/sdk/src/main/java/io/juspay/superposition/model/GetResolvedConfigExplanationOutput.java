...
@SmithyGenerated
public final class GetResolvedConfigExplanationOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetResolvedConfigExplanationOutput");

    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        .putMember("explanation", ResolveExplanation.$SCHEMA,
                new RequiredTrait(),
    ...
    private static final Schema $SCHEMA_EXPLANATION = $SCHEMA.member("explanation");
    ...
    private final transient ResolveExplanation explanation;
    private final transient String version;
    private final transient Instant lastModified;
    private final transient String auditId;

    private GetResolvedConfigExplanationOutput(Builder builder) {
    ...
    public ResolveExplanation explanation() {
        return explanation;
    }
    ...
    public boolean equals(Object other) {
        ...
        GetResolvedConfigExplanationOutput that = (GetResolvedConfigExplanationOutput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(explanation, version, lastModified, auditId);
    }
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        if (explanation != null) {
            serializer.writeStruct($SCHEMA_EXPLANATION, explanation);
        }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            case 0 -> (T) SchemaUtils.validateSameMember($SCHEMA_EXPLANATION, member, explanation);
     ...
     *
     * @return a builder for {@link GetResolvedConfigExplanationOutput}.
     */
    ...
    /**
     * Builder for {@link GetResolvedConfigExplanationOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetResolvedConfigExplanationOutput> {
        private final PresenceTracker tracker = PresenceTracker.of($SCHEMA);
        private ResolveExplanation explanation;
         ...
         * @return this builder.
         */
        public Builder explanation(ResolveExplanation explanation) {
            this.explanation = Objects.requireNonNull(explanation, "explanation cannot be null");
            tracker.setMember($SCHEMA_EXPLANATION);
            return this;
        }
        ...
        @Override
        public GetResolvedConfigExplanationOutput build() {
            tracker.validate();
            return new GetResolvedConfigExplanationOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> explanation((ResolveExplanation) SchemaUtils.validateSameMember($SCHEMA_EXPLANATION, member, value));
        ...
        @Override
        public ShapeBuilder<GetResolvedConfigExplanationOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            if (!tracker.checkMember($SCHEMA_EXPLANATION)) {
                tracker.setMember($SCHEMA_EXPLANATION);
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.explanation(ResolveExplanation.builder().deserializeMember(de, member).build());
