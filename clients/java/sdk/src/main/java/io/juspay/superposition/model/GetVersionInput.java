...
@SmithyGenerated
public final class GetVersionInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetVersionInput");
    ...
    private GetVersionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetVersionInput that = (GetVersionInput) other;
     ...
     *
     * @return a builder for {@link GetVersionInput}.
     */
    ...
    /**
     * Builder for {@link GetVersionInput}.
     */
    public static final class Builder implements ShapeBuilder<GetVersionInput> {
        ...
        @Override
        public ShapeBuilder<GetVersionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
