...
@SmithyGenerated
public final class GetWebhookByEventInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetWebhookByEventInput");
     ...
     *
     * @return a builder for {@link GetWebhookByEventInput}.
     */
    ...
    /**
     * Builder for {@link GetWebhookByEventInput}.
     */
    public static final class Builder implements ShapeBuilder<GetWebhookByEventInput> {
        ...
        public Builder event(String event) {
            ...
            tracker.setMember($SCHEMA_EVENT);
            return this;
        }

        @Override
        public GetWebhookByEventInput build() {
            tracker.validate();
            return new GetWebhookByEventInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetWebhookByEventInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_EVENT)) {
                event("");
            }
            return this;
        }
