...
@SmithyGenerated
public final class RotateWorkspaceEncryptionKeyInput implements SerializableStruct {
     ...
     *
     * @return a builder for {@link RotateWorkspaceEncryptionKeyInput}.
     */
    ...
    /**
     * Builder for {@link RotateWorkspaceEncryptionKeyInput}.
     */
    public static final class Builder implements ShapeBuilder<RotateWorkspaceEncryptionKeyInput> {
        ...
        @Override
        public RotateWorkspaceEncryptionKeyInput build() {
            tracker.validate();
            return new RotateWorkspaceEncryptionKeyInput(this);
        }
        ...
        @Override
        public ShapeBuilder<RotateWorkspaceEncryptionKeyInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
