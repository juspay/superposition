...
@SmithyGenerated
public final class GetTypeTemplateOutput implements SerializableStruct {
    ...
    private GetTypeTemplateOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetTypeTemplateOutput that = (GetTypeTemplateOutput) other;
     ...
     *
     * @return a builder for {@link GetTypeTemplateOutput}.
     */
    ...
    /**
     * Builder for {@link GetTypeTemplateOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetTypeTemplateOutput> {
        ...
        @Override
        public GetTypeTemplateOutput build() {
            tracker.validate();
            return new GetTypeTemplateOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetTypeTemplateOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
