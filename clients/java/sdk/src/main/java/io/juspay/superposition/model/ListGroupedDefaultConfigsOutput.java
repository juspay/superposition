...
@SmithyGenerated
public final class ListGroupedDefaultConfigsOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListGroupedDefaultConfigsOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.LIST_GROUPED_DEFAULT_CONFIG_OUT,
                new RequiredTrait())
        .build();
    ...
    private final transient List<GroupedDefaultConfig> data;

    private ListGroupedDefaultConfigsOutput(Builder builder) {
    ...
    public List<GroupedDefaultConfig> data() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        ListGroupedDefaultConfigsOutput that = (ListGroupedDefaultConfigsOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.ListGroupedDefaultConfigOutSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListGroupedDefaultConfigsOutput}.
     */
    ...
    /**
     * Builder for {@link ListGroupedDefaultConfigsOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListGroupedDefaultConfigsOutput> {
        private final PresenceTracker tracker = PresenceTracker.of($SCHEMA);
        private int totalPages;
        private int totalItems;
        private List<GroupedDefaultConfig> data;
         ...
         * @return this builder.
         */
        public Builder data(List<GroupedDefaultConfig> data) {
        ...
        @Override
        public ListGroupedDefaultConfigsOutput build() {
            tracker.validate();
            return new ListGroupedDefaultConfigsOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<GroupedDefaultConfig>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListGroupedDefaultConfigsOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeListGroupedDefaultConfigOut(member, de));
