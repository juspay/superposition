...
@SmithyGenerated
public final class CreateWebhookInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#CreateWebhookInput");
     ...
     *
     * @return a builder for {@link CreateWebhookInput}.
     */
    ...
    /**
     * Builder for {@link CreateWebhookInput}.
     */
    public static final class Builder implements ShapeBuilder<CreateWebhookInput> {
        ...
        @Override
        public ShapeBuilder<CreateWebhookInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
