...
@SmithyGenerated
public final class GetDetailedResolvedConfigOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetDetailedResolvedConfigOutput");
    ...
    private GetDetailedResolvedConfigOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetDetailedResolvedConfigOutput that = (GetDetailedResolvedConfigOutput) other;
     ...
     *
     * @return a builder for {@link GetDetailedResolvedConfigOutput}.
     */
    ...
    /**
     * Builder for {@link GetDetailedResolvedConfigOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetDetailedResolvedConfigOutput> {
        ...
        @Override
        public GetDetailedResolvedConfigOutput build() {
            tracker.validate();
            return new GetDetailedResolvedConfigOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetDetailedResolvedConfigOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
