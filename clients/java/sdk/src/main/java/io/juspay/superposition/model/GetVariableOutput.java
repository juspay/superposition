...
@SmithyGenerated
public final class GetVariableOutput implements SerializableStruct {
    ...
    private GetVariableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetVariableOutput that = (GetVariableOutput) other;
     ...
     *
     * @return a builder for {@link GetVariableOutput}.
     */
    ...
    /**
     * Builder for {@link GetVariableOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetVariableOutput> {
        ...
        @Override
        public GetVariableOutput build() {
            tracker.validate();
            return new GetVariableOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetVariableOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
