...
@SmithyGenerated
public final class GetVersionOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetVersionResponse");

    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        .putMember("id", PreludeSchemas.STRING,
                new RequiredTrait())
        .putMember("config", ConfigData.$SCHEMA,
                new RequiredTrait())
    ...
    private final transient ConfigData config;
    ...
    private GetVersionOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        GetVersionOutput that = (GetVersionOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (config != null) {
            serializer.writeStruct($SCHEMA_CONFIG, config);
        }
     ...
     *
     * @return a builder for {@link GetVersionOutput}.
     */
    ...
    /**
     * Builder for {@link GetVersionOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetVersionOutput> {
         ...
         * @return this builder.
         */
        public Builder config(ConfigData config) {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> config((ConfigData) SchemaUtils.validateSameMember($SCHEMA_CONFIG, member, value));
        ...
        @Override
        public ShapeBuilder<GetVersionOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.config(ConfigData.builder().deserializeMember(de, member).build());
