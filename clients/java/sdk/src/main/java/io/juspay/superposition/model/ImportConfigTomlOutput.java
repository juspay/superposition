...
public final class ImportConfigTomlOutput implements SerializableStruct {
    ...
    private ImportConfigTomlOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ImportConfigTomlOutput that = (ImportConfigTomlOutput) other;
     ...
     *
     * @return a builder for {@link ImportConfigTomlOutput}.
     */
    ...
    /**
     * Builder for {@link ImportConfigTomlOutput}.
     */
    public static final class Builder implements ShapeBuilder<ImportConfigTomlOutput> {
        ...
        @Override
        public ImportConfigTomlOutput build() {
            tracker.validate();
            return new ImportConfigTomlOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<ImportConfigTomlOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
