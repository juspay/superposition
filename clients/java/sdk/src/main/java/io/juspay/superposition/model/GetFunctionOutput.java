...
@SmithyGenerated
public final class GetFunctionOutput implements SerializableStruct {
    ...
    private GetFunctionOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetFunctionOutput that = (GetFunctionOutput) other;
     ...
     *
     * @return a builder for {@link GetFunctionOutput}.
     */
    ...
    /**
     * Builder for {@link GetFunctionOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetFunctionOutput> {
        ...
        @Override
        public GetFunctionOutput build() {
            tracker.validate();
            return new GetFunctionOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetFunctionOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
