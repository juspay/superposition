...
@SmithyGenerated
public final class DiscardExperimentInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#DiscardExperimentInput");
    ...
    public boolean equals(Object other) {
        ...
        DiscardExperimentInput that = (DiscardExperimentInput) other;
     ...
     *
     * @return a builder for {@link DiscardExperimentInput}.
     */
    ...
    /**
     * Builder for {@link DiscardExperimentInput}.
     */
    public static final class Builder implements ShapeBuilder<DiscardExperimentInput> {
        ...
        public DiscardExperimentInput build() {
            tracker.validate();
            return new DiscardExperimentInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DiscardExperimentInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
