...
@SmithyGenerated
public final class GetResolvedConfigWithIdentifierInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetResolvedConfigWithIdentifierInput");
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspaceId, orgId, prefix, version, showReasoning, mergeStrategy, contextId, resolveRemote, context, identifier);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 9 -> (T) SchemaUtils.validateSameMember($SCHEMA_IDENTIFIER, member, identifier);
     ...
     *
     * @return a builder for {@link GetResolvedConfigWithIdentifierInput}.
     */
    ...
    /**
     * Builder for {@link GetResolvedConfigWithIdentifierInput}.
     */
    public static final class Builder implements ShapeBuilder<GetResolvedConfigWithIdentifierInput> {
        ...
        @Override
        public GetResolvedConfigWithIdentifierInput build() {
            tracker.validate();
            return new GetResolvedConfigWithIdentifierInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 9 -> identifier((String) SchemaUtils.validateSameMember($SCHEMA_IDENTIFIER, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<GetResolvedConfigWithIdentifierInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 9 -> builder.identifier(de.readString(member));
