...
@SmithyGenerated
public final class GetDimensionOutput implements SerializableStruct {
    ...
    private GetDimensionOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetDimensionOutput that = (GetDimensionOutput) other;
     ...
     *
     * @return a builder for {@link GetDimensionOutput}.
     */
    ...
    /**
     * Builder for {@link GetDimensionOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetDimensionOutput> {
        ...
        @Override
        public GetDimensionOutput build() {
            tracker.validate();
            return new GetDimensionOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetDimensionOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
