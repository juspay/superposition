...
public final class WebhookFailed extends ModeledException {
    ...
    /**
     * The successful operation result that would have been returned with HTTP 200, serialized as an
     * untyped/raw JSON document. The structure logically corresponds to the operation's normal output
     * type, but is modeled as Document since this single error is shared across multiple operations with
    ...
    public static final class Builder implements ShapeBuilder<WebhookFailed> {
        ...
        @Override
        public ShapeBuilder<WebhookFailed> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
