 ...
 */
@SmithyGenerated
public final class RemoveMembersFromGroupInput implements SerializableStruct {
    ...
    private RemoveMembersFromGroupInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        RemoveMembersFromGroupInput that = (RemoveMembersFromGroupInput) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_MEMBER_EXPERIMENT_IDS, member, memberExperimentIds);
     ...
     *
     * @return a builder for {@link RemoveMembersFromGroupInput}.
     */
    ...
    /**
     * Builder for {@link RemoveMembersFromGroupInput}.
     */
    public static final class Builder implements ShapeBuilder<RemoveMembersFromGroupInput> {
        ...
        @Override
        public RemoveMembersFromGroupInput build() {
            tracker.validate();
            return new RemoveMembersFromGroupInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> memberExperimentIds((List<String>) SchemaUtils.validateSameMember($SCHEMA_MEMBER_EXPERIMENT_IDS, member, value));
        ...
        @Override
        public ShapeBuilder<RemoveMembersFromGroupInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 3 -> builder.memberExperimentIds(SharedSerde.deserializeStringList(member, de));
