 ...
 */
@SmithyGenerated
public final class SecretResponse implements SerializableStruct {
    ...
    private SecretResponse(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        SecretResponse that = (SecretResponse) other;
     ...
     *
     * @return a builder for {@link SecretResponse}.
     */
    ...
    /**
     * Builder for {@link SecretResponse}.
     */
    public static final class Builder implements ShapeBuilder<SecretResponse> {
        ...
        public SecretResponse build() {
            tracker.validate();
            return new SecretResponse(this);
        }
        ...
        @Override
        public ShapeBuilder<SecretResponse> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
