...
@SmithyGenerated
public final class ListVariablesOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListVariablesOutput");
    ...
    public static final Schema $SCHEMA = Schema.structureBuilder($ID)
        ...
        .putMember("total_items", PreludeSchemas.INTEGER,
                new RequiredTrait())
        .putMember("data", SharedSchemas.VARIABLE_LIST,
                new RequiredTrait())
        .build();
    ...
    private final transient List<VariableResponse> data;

    private ListVariablesOutput(Builder builder) {
    ...
    public List<VariableResponse> data() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        ListVariablesOutput that = (ListVariablesOutput) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeList($SCHEMA_DATA, data, data.size(), SharedSerde.VariableListSerializer.INSTANCE);
    }
     ...
     *
     * @return a builder for {@link ListVariablesOutput}.
     */
    ...
    /**
     * Builder for {@link ListVariablesOutput}.
     */
    public static final class Builder implements ShapeBuilder<ListVariablesOutput> {
        private final PresenceTracker tracker = PresenceTracker.of($SCHEMA);
        private int totalPages;
        private int totalItems;
        private List<VariableResponse> data;
         ...
         * @return this builder.
         */
        public Builder data(List<VariableResponse> data) {
        ...
        @Override
        public ListVariablesOutput build() {
            tracker.validate();
            return new ListVariablesOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> data((List<VariableResponse>) SchemaUtils.validateSameMember($SCHEMA_DATA, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListVariablesOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.data(SharedSerde.deserializeVariableList(member, de));
