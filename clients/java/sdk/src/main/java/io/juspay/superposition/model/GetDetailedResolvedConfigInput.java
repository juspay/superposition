...
@SmithyGenerated
public final class GetDetailedResolvedConfigInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#GetDetailedResolvedConfigInput");
    ...
    private GetDetailedResolvedConfigInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetDetailedResolvedConfigInput that = (GetDetailedResolvedConfigInput) other;
     ...
     *
     * @return a builder for {@link GetDetailedResolvedConfigInput}.
     */
    ...
    /**
     * Builder for {@link GetDetailedResolvedConfigInput}.
     */
    public static final class Builder implements ShapeBuilder<GetDetailedResolvedConfigInput> {
        ...
        @Override
        public GetDetailedResolvedConfigInput build() {
            tracker.validate();
            return new GetDetailedResolvedConfigInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetDetailedResolvedConfigInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
