...
@SmithyGenerated
public final class UpdateWorkspaceDatabaseInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#UpdateWorkspaceDatabaseRequest");
    ...
    private UpdateWorkspaceDatabaseInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateWorkspaceDatabaseInput that = (UpdateWorkspaceDatabaseInput) other;
     ...
     *
     * @return a builder for {@link UpdateWorkspaceDatabaseInput}.
     */
    ...
    /**
     * Builder for {@link UpdateWorkspaceDatabaseInput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateWorkspaceDatabaseInput> {
        ...
        @Override
        public UpdateWorkspaceDatabaseInput build() {
            tracker.validate();
            return new UpdateWorkspaceDatabaseInput(this);
        }
        ...
        @Override
        public ShapeBuilder<UpdateWorkspaceDatabaseInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
