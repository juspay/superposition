...
@SmithyGenerated
public final class ConfigData implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ConfigData");
    ...
    @Override
    public int hashCode() {
        return Objects.hash(contexts, overrides, defaultConfigs, dimensions);
    }
     ...
     *
     * @return a builder for {@link ConfigData}.
     */
    ...
    /**
     * Builder for {@link ConfigData}.
     */
    public static final class Builder implements ShapeBuilder<ConfigData> {
        ...
        @Override
        public ShapeBuilder<ConfigData> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
