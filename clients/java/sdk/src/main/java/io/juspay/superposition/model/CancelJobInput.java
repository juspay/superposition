...
@SmithyGenerated
public final class CancelJobInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#CancelJobInput");
    ...
    private CancelJobInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CancelJobInput that = (CancelJobInput) other;
     ...
     *
     * @return a builder for {@link CancelJobInput}.
     */
    ...
    /**
     * Builder for {@link CancelJobInput}.
     */
    public static final class Builder implements ShapeBuilder<CancelJobInput> {
        ...
        @Override
        public CancelJobInput build() {
            tracker.validate();
            return new CancelJobInput(this);
        }
        ...
        @Override
        public ShapeBuilder<CancelJobInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
