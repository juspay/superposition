 ...
 */
@SmithyGenerated
public final class GetJobOutput implements SerializableStruct {
    ...
    private GetJobOutput(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object other) {
        ...
        GetJobOutput that = (GetJobOutput) other;
     ...
     *
     * @return a builder for {@link GetJobOutput}.
     */
    ...
    /**
     * Builder for {@link GetJobOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetJobOutput> {
        ...
        @Override
        public GetJobOutput build() {
            tracker.validate();
            return new GetJobOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetJobOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
