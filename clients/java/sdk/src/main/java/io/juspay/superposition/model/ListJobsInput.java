...
@SmithyGenerated
public final class ListJobsInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListJobsInput");
    ...
    private ListJobsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListJobsInput that = (ListJobsInput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(count, page, all, workspaceId, orgId, status, jobType);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 6 -> (T) SchemaUtils.validateSameMember($SCHEMA_JOB_TYPE, member, jobType);
     ...
     *
     * @return a builder for {@link ListJobsInput}.
     */
    ...
    /**
     * Builder for {@link ListJobsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListJobsInput> {
        ...
        @Override
        public ListJobsInput build() {
            tracker.validate();
            return new ListJobsInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 5 -> status((BackgroundJobStatus) SchemaUtils.validateSameMember($SCHEMA_STATUS, member, value));
                case 6 -> jobType((BackgroundJobType) SchemaUtils.validateSameMember($SCHEMA_JOB_TYPE, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListJobsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 5 -> builder.status(BackgroundJobStatus.builder().deserializeMember(de, member).build());
                    case 6 -> builder.jobType(BackgroundJobType.builder().deserializeMember(de, member).build());
