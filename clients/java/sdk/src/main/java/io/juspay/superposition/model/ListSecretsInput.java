...
@SmithyGenerated
public final class ListSecretsInput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#ListSecretsInput");
    ...
    private ListSecretsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListSecretsInput that = (ListSecretsInput) other;
     ...
     *
     * @return a builder for {@link ListSecretsInput}.
     */
    ...
    /**
     * Builder for {@link ListSecretsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListSecretsInput> {
         ...
         * @return this builder.
         */
        public Builder sortOn(SecretSortOn sortOn) {
            this.sortOn = sortOn;
            return this;
        }
        ...
        public ListSecretsInput build() {
            tracker.validate();
            return new ListSecretsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListSecretsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
