...
@SmithyGenerated
public final class GetWebhookOutput implements SerializableStruct {
    ...
    private GetWebhookOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetWebhookOutput that = (GetWebhookOutput) other;
     ...
     *
     * @return a builder for {@link GetWebhookOutput}.
     */
    ...
    /**
     * Builder for {@link GetWebhookOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetWebhookOutput> {
        ...
        @Override
        public GetWebhookOutput build() {
            tracker.validate();
            return new GetWebhookOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetWebhookOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
