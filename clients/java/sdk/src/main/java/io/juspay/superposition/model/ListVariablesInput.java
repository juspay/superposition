...
public final class ListVariablesInput implements SerializableStruct {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(count, page, all, workspaceId, orgId, name, sortOn, sortBy);
    }
    ...
    public static final class Builder implements ShapeBuilder<ListVariablesInput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 6 -> sortOn((VariableSortOn) SchemaUtils.validateSameMember($SCHEMA_SORT_ON, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 6 -> builder.sortOn(VariableSortOn.builder().deserializeMember(de, member).build());
