 ...
 */
@SmithyGenerated
public final class UpdateSecretOutput implements SerializableStruct {
    public static final ShapeId $ID = ShapeId.from("io.superposition#SecretResponse");
    ...
    private UpdateSecretOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateSecretOutput that = (UpdateSecretOutput) other;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, changeReason, createdBy, createdAt, lastModifiedBy, lastModifiedAt);
    }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_CREATED_BY, member, createdBy);
            case 4 -> (T) SchemaUtils.validateSameMember($SCHEMA_CREATED_AT, member, createdAt);
            case 5 -> (T) SchemaUtils.validateSameMember($SCHEMA_LAST_MODIFIED_BY, member, lastModifiedBy);
     ...
     *
     * @return a builder for {@link UpdateSecretOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateSecretOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateSecretOutput> {
        ...
        @Override
        public UpdateSecretOutput build() {
            tracker.validate();
            return new UpdateSecretOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> createdBy((String) SchemaUtils.validateSameMember($SCHEMA_CREATED_BY, member, value));
                case 4 -> createdAt((Instant) SchemaUtils.validateSameMember($SCHEMA_CREATED_AT, member, value));
                case 5 -> lastModifiedBy((String) SchemaUtils.validateSameMember($SCHEMA_LAST_MODIFIED_BY, member, value));
        ...
        @Override
        public ShapeBuilder<UpdateSecretOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 3 -> builder.createdBy(de.readString(member));
                    case 4 -> builder.createdAt(de.readTimestamp(member));
                    case 5 -> builder.lastModifiedBy(de.readString(member));
