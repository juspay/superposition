...
import { AlertProvider, SuperpositionAdmin, SuperpositionProvider } from "../src/index";
import type {
    JsonValue,
        ...
        <>
            <div className="toolbar">
                ...
                <input
                    ...
                    onChange={(event) => handleFieldChange("colorPrimary", event.target.value)}
                />
                ...
                <input
                    ...
                    type="color"
                    value={draft.colorBg}
                    onChange={(event) => handleFieldChange("colorBg", event.target.value)}
                />

                <label htmlFor="color-panel">Panel:</label>
                <input
                    id="color-panel"
                    type="color"
                    value={draft.colorPanel}
                    onChange={(event) => handleFieldChange("colorPanel", event.target.value)}
                />
            ...
            <div className="demo-notes">
                ...
                <div>
                    <strong>Theme:</strong> these controls map directly to flat{" "}
                    <code>config.theme</code> values.
                </div>
                <div>
