...
COPY --from=builder /build/crates/service_utils/src/middlewares/auth_z/casbin/model.conf /app/crates/service_utils/src/middlewares/auth_z/casbin/model.conf
