...
import { TypeSafetyDemo, InvalidValuesDemo, BlastRadiusDemo } from '@site/src/components/animations';
...
Even if the type of a config value is correct, is the value appropriate? For example, how do you an ensure a URL whose type is string is actually valid? Superposition does this with [functions](./basic-concepts/safety/functions.mdx)

<AnimationSlide width={800} height={650} mode="auto" loop={true} loopDelay={5000}>
  <InvalidValuesDemo />
</AnimationSlide>
...
<AnimationSlide width={900} height={750} mode="auto" loop={true} loopDelay={20000}>
  <BlastRadiusDemo />
</AnimationSlide>
