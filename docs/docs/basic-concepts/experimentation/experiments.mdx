...
sidebar_position: 1
title: Experiments
description: Experiment with different config values in superposition
---

import AnimationSlide from '@site/src/components/AnimationSlide';
import { ExperimentationDemo } from '@site/src/components/animations';
...
<AnimationSlide width={800} height={700} mode="auto" loop={false} >
  <ExperimentationDemo />
</AnimationSlide>
