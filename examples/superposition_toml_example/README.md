...
Contexts define overrides that apply when specific dimension values are present. Multiple dimensions can be combined by adding them to the `_overrides_` table.
