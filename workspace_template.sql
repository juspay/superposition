...
CREATE INDEX IF NOT EXISTS variables_created_at_index ON {replaceme}.variables(created_at);
CREATE INDEX IF NOT EXISTS variables_last_modified_at_index ON {replaceme}.variables(last_modified_at);
